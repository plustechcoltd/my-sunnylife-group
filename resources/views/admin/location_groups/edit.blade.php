...
@section('title')
    {{ $location_group->name }} | {{ __('label.tables.location_groups') }}
@endsection

@section('page-header')
    @component('admin.components.breadcrumb')
        @slot('title'){{ $location_group->name }}@endslot
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-lg-12 col-xxl-10 offset-xxl-1 mt-3">
                        ...
                        <form action="{{ route('admin.location_groups.update', $location_group->id) }}" method="POST" id="form-update">
                            @csrf
                            @method('PUT')
