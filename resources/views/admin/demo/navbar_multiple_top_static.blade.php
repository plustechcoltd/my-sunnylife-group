    ...
    <div class="content-wrapper">
        ...
        <div class="content">
            ...
            <div class="alert alert-success alert-dismissible">
                ...
                If for some reason you need to use multiple main navbars, all you need to do is to add 2 components one
                after another. Make sure the first navbar has <code>.navbar-static</code> class, it adds correct z-index
                so that all dropdown menus don't get overlapped.
