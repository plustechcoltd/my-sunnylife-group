...
<head>
    ...
    <!-- Theme JS files -->
    <script src="{{URL::asset('assets/admin/js/vendor/ui/headroom.min.js')}}"></script>
    ...
    <script src="{{URL::asset('assets/admin/demo/pages/navbar_hideable.js')}}"></script>
                        ...
                        <div class="row">
                            <div class="col-md-4 mb-3 mb-md-0">
                                ...
                                <div class="mb-3 mb-md-0">
                                    ...
                                    <a href="layout_navbar_sticky" class="dropdown-item rounded active">Sticky
                                        navbar</a>
                            ...
                            <div class="col-md-4 mb-3 mb-md-0">
                                ...
                                <div class="mb-3 mb-md-0">
                                    <a href="layout_2_sidebars_1_side" class="dropdown-item rounded">2 sidebars on 1
                                        side</a>
                                    <a href="layout_2_sidebars_2_sides" class="dropdown-item rounded">2 sidebars on 2
                                        sides</a>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="#" class="text-body">
                                            <div class="fw-semibold">[#1183] Workaround for OS X selects printing bug
                                            </div>
                            ...
                            <table class="table text-nowrap">
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="#" class="d-inline-block me-3">
                                                <img src="{{URL::asset('assets/admin/images/demo/logos/1.svg')}}" alt=""
                                                     height="36">
                                            </a>
                                            <div>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="#" class="d-inline-block me-3">
                                                <img src="{{URL::asset('assets/admin/images/demo/logos/2.svg')}}" alt=""
                                                     height="36">
                                            </a>
                                            <div>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="#" class="d-inline-block me-3">
                                                <img src="{{URL::asset('assets/admin/images/demo/logos/3.svg')}}" alt=""
                                                     height="36">
                                            </a>
                                            <div>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="#" class="d-inline-block me-3">
                                                <img src="{{URL::asset('assets/admin/images/demo/logos/4.svg')}}" alt=""
                                                     height="36">
                                            </a>
                                            <div>
