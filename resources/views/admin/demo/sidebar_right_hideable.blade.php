    ...
    <div class="container-fluid">
        ...
        <ul class="nav flex-row justify-content-end order-1 order-lg-2">
            ...
            <li class="nav-item d-none d-lg-block ms-lg-2">
                <a href="#"
                   class="navbar-nav-link navbar-nav-link-icon rounded-pill sidebar-control sidebar-end-toggle">
    ...
    <div class="content-wrapper">
        ...
        <div class="content">
            ...
            <div class="alert alert-success alert-dismissible">
                ...
                added to the top navbar. You can have this button anywhere - content, card or navbar. The only condition
    ...
    <div class="sidebar sidebar-end sidebar-expand-lg align-self-start">
        ...
        <div class="sidebar-content">
            ...
            <div class="sidebar-section sidebar-section-body d-flex align-items-center d-lg-none pb-2">
                ...
                <div class="ms-auto">
                    <button type="button"
                            class="btn btn-light border-transparent btn-icon rounded-pill btn-sm sidebar-mobile-end-toggle">
                        <i class="ph-x"></i>
                    </button>
                </div>
            </div>
