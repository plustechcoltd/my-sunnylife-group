                ...
                <div class="dropdown w-100 w-sm-auto">
                    <a href="#" class="d-flex align-items-center text-body lh-1 dropdown-toggle py-sm-2"
                       data-bs-toggle="dropdown" data-bs-display="static">
                        <img src="{{URL::asset('assets/admin/images/brands/tesla.svg')}}" class="w-32px h-32px me-2"
                             alt="">
                    ...
                    <div class="dropdown-menu dropdown-menu-lg-end w-100 w-lg-auto wmin-300 wmin-sm-350 pt-0">
                        ...
                        <a href="#" class="dropdown-item py-2">
                            <img src="{{URL::asset('assets/admin/images/brands/debijenkorf.svg')}}"
                        ...
                        <a href="#" class="dropdown-item py-2">
                            <img src="{{URL::asset('assets/admin/images/brands/klm.svg')}}" class="w-32px h-32px me-2"
                                 alt="">
                            <div>
                        ...
                        <a href="#" class="dropdown-item py-2">
                            <img src="{{URL::asset('assets/admin/images/brands/shell.svg')}}" class="w-32px h-32px me-2"
                                 alt="">
                            <div>
                        ...
                        <a href="#" class="dropdown-item py-2">
                            <img src="{{URL::asset('assets/admin/images/brands/bp.svg')}}" class="w-32px h-32px me-2"
                                 alt="">
                            <div>
