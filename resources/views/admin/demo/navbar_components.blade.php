                                                ...
                                                <div class="p-3">
                                                    <div class="d-flex align-items-start mb-3">
                                                        <div class="status-indicator-container me-2">
                                                            <img src="{{URL::asset('assets/admin/images/demo/users/face1.jpg')}}" class="w-40px h-40px rounded-pill" alt="">
                                                    ...
                                                    <div class="d-flex align-items-start mb-3">
                                                        <div class="status-indicator-container me-2">
                                                            <img src="{{URL::asset('assets/admin/images/demo/users/face2.jpg')}}" class="w-40px h-40px rounded-pill" alt="">
                                                            <span class="status-indicator bg-success"></span>
                                                        </div>
                                                    ...
                                                    <div class="d-flex align-items-start">
                                                        <div class="status-indicator-container me-2">
                                                            <img src="{{URL::asset('assets/admin/images/demo/users/face5.jpg')}}" class="w-40px h-40px rounded-pill" alt="">
                                                            <span class="status-indicator bg-success"></span>
                                                        </div>
                                ...
                                <li class="nav-item dropdown ms-lg-2">
                                    <a href="#" class="navbar-nav-link align-items-center rounded p-1" data-bs-toggle="dropdown">
                                        <div class="status-indicator-container">
                                            <img src="{{URL::asset('assets/admin/images/demo/users/face11.jpg')}}" class="w-32px h-32px rounded-sm" alt="">
                                            <span class="status-indicator bg-success"></span>
                                        </div>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="navbar-collapse collapse" id="navbar-language">
                            <ul class="navbar-nav mt-2 mt-xl-0">
                                <li class="nav-item dropdown">
                                    <a href="#" class="navbar-nav-link rounded dropdown-toggle" data-bs-toggle="dropdown">
                                        <img src="{{URL::asset('assets/admin/images/lang/es.svg')}}" class="h-16px me-2" alt="">
                                        España
                                    </a>

                                    <div class="dropdown-menu">
                                        <a href="#" class="dropdown-item">
                                            <img src="{{URL::asset('assets/admin/images/lang/gb.svg')}}" class="h-16px me-2" alt="">
                                            English
                                        </a>
                                        <a href="#" class="dropdown-item">
                                            <img src="{{URL::asset('assets/admin/images/lang/ua.svg')}}" class="h-16px me-2" alt="">
                                            Українська
                                        </a>
                                        <a href="#" class="dropdown-item">
                                            <img src="{{URL::asset('assets/admin/images/lang/de.svg')}}" class="h-16px me-2" alt="">
                                            Deutsch
                                        </a>
                            ...
                            <ul class="navbar-nav ms-xl-auto">
                                ...
                                <li class="nav-item ms-xl-1">
                                    <a href="#" class="navbar-nav-link rounded">
                                        <img src="{{URL::asset('assets/admin/images/lang/it.svg')}}" class="h-16px me-2" alt="">
                                        IT
                                    </a>
                                </li>
                            </ul>
...
<script src="{{URL::asset('assets/admin/js/vendor/ui/moment/moment.min.js')}}"></script>
<script src="{{URL::asset('assets/admin/js/vendor/pickers/daterangepicker.js')}}"></script>
@endsection
@section('scripts')
<script src="{{URL::asset('assets/admin/demo/pages/navbar_components.js')}}"></script>
@endsection
