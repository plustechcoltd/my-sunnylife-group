...
<div class="navbar navbar-dark navbar-expand-lg navbar-static">
    <div class="container-fluid">
        ...
        <ul class="nav flex-row">
            <li class="nav-item">
                <a href="#"
                   class="navbar-nav-link navbar-nav-link-icon rounded-pill sidebar-control sidebar-main-toggle d-none d-lg-flex">
...
<div class="page-content pt-0">
    ...
    @include('admin.layouts.sidebar_detached')
    ...
    <div class="content-wrapper">
        ...
        <div class="content">
            ...
            <div class="alert alert-success alert-dismissible">
                ...
                This example demonstrates <code>hideable</code> state. Sidebar toggler is moved outside the sidebar and
                added to page header. You can have this button anywhere - content, card or navbar. The only condition
                here is proper class names.
