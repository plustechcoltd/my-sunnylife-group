...
<head>
    ...
    <script src="{{URL::asset('assets/admin/js/vendor/forms/selects/select2.min.js')}}"></script>
    <script src="{{URL::asset('assets/admin/js/vendor/forms/selects/bootstrap_multiselect.js')}}"></script>
    <script src="{{URL::asset('assets/admin/js/vendor/forms/inputs/dual_listbox.min.js')}}"></script>
    <script src="{{URL::asset('assets/admin/js/vendor/pickers/datepicker.min.js')}}"></script>
    <script src="{{URL::asset('assets/admin/js/vendor/ui/dragula.min.js')}}"></script>
    <script src="{{URL::asset('assets/admin/js/vendor/media/glightbox.min.js')}}"></script>
    <script src="{{URL::asset('assets/admin/js/vendor/trees/fancytree_all.min.js')}}"></script>
    <script src="{{URL::asset('assets/admin/js/vendor/sliders/nouislider.min.js')}}"></script>
    <script src="{{URL::asset('assets/admin/js/vendor/ui/prism.min.js')}}"></script>
    <script src="{{URL::asset('assets/admin/js/vendor/pickers/color/spectrum.js')}}"></script>

    <script src="{{URL::asset('assets/admin/js/app.js')}}"></script>
    <script src="{{URL::asset('assets/admin/js/sidebar_components.js')}}"></script>
    <!-- /theme JS files -->
    ...
    <div class="sidebar sidebar-secondary sidebar-expand-lg align-self-start">
        ...
        <div class="sidebar-content tab-content">
                    ...
                    <div class="collapse show" id="sidebar-dark-buttons-tile">
                        <div class="sidebar-section-body">
                            <div class="row row-tile g-0">
                                <div class="col">
                                    <button type="button"
                                            class="btn btn-dark w-100 flex-column border-white border-opacity-10 rounded-0 rounded-top-start py-2">
                                        <i class="ph-app-store-logo text-primary ph-2x mb-1"></i>
                                        App store
                                    </button>

                                    <button type="button"
                                            class="btn btn-dark w-100 flex-column border-white border-opacity-10 rounded-0 rounded-bottom-start py-2">
                                        <i class="ph-twitter-logo text-info ph-2x mb-1"></i>
                                        Twitter
                                    </button>
                                </div>
                                ...
                                <div class="col">
                                    <button type="button"
                                            class="btn btn-dark w-100 flex-column border-white border-opacity-10 rounded-0 rounded-top-end py-2">
                                        <i class="ph-dribbble-logo text-pink ph-2x mb-1"></i>
                                        Dribbble
                                    </button>

                                    <button type="button"
                                            class="btn btn-dark w-100 flex-column border-white border-opacity-10 rounded-0 rounded-bottom-end py-2">
                                        <i class="ph-spotify-logo text-success ph-2x mb-1"></i>
                                        Spotify
                                    </button>
                                </div>
                        ...
                        <div class="sidebar-section-body">
                            <div class="mb-2">
                                <div class="card-img-actions">
                                    <a href="{{URL::asset('assets/admin/images/demo/images/1.png')}}" class="text-white"
                                       data-bs-popup="lightbox">
                                        <img class="img-thumbnail rounded img-fluid"
                                             src="{{URL::asset('assets/admin/images/demo/images/1.png')}}" alt="">
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="mb-2">
                                        <div class="card-img-actions">
                                            <a href="{{URL::asset('assets/admin/images/demo/images/2.png')}}"
                                               class="text-white" data-bs-popup="lightbox">
                                                <img class="img-fluid rounded"
                                                     src="{{URL::asset('assets/admin/images/demo/images/2.png')}}"
                                                     alt="">
                                                <span class="card-img-actions-overlay rounded">
                                                        <i class="ph-plus"></i>
                                                    </span>
                                    ...
                                    <div class="mb-2">
                                        <div class="card-img-actions">
                                            <a href="{{URL::asset('assets/admin/images/demo/images/3.png')}}"
                                               class="text-white" data-bs-popup="lightbox">
                                                <img class="img-fluid rounded"
                                                     src="{{URL::asset('assets/admin/images/demo/images/3.png')}}"
                                                     alt="">
                                                <span class="card-img-actions-overlay rounded">
                                                        <i class="ph-plus"></i>
                                                    </span>
                                ...
                                <div class="col">
                                    <div class="mb-2">
                                        <div class="card-img-actions">
                                            <a href="{{URL::asset('assets/admin/images/demo/images/4.png')}}"
                                               class="text-white" data-bs-popup="lightbox">
                                                <img class="img-fluid rounded"
                                                     src="{{URL::asset('assets/admin/images/demo/images/4.png')}}"
                                                     alt="">
                                                <span class="card-img-actions-overlay rounded">
                                                        <i class="ph-plus"></i>
                                                    </span>
                                    ...
                                    <div class="mb-2">
                                        <div class="card-img-actions">
                                            <a href="{{URL::asset('assets/admin/images/demo/images/5.png')}}"
                                               class="text-white" data-bs-popup="lightbox">
                                                <img class="img-fluid rounded"
                                                     src="{{URL::asset('assets/admin/images/demo/images/5.png')}}"
                                                     alt="">
                                                <span class="card-img-actions-overlay rounded">
                                                        <i class="ph-plus"></i>
                                                    </span>
                    ...
                    <div class="collapse show" id="sidebar-thumbnail-tiles">
                        <div class="sidebar-section-body">
                            <div class="row g-0 mb-3">
                                <div class="col">
                                    <div class="card-img-actions">
                                        <a href="{{URL::asset('assets/admin/images/demo/images/1.png')}}"
                                           class="text-white" data-bs-popup="lightbox">
                                        ...
                                        <a href="{{URL::asset('assets/admin/images/demo/images/3.png')}}"
                                           class="text-white" data-bs-popup="lightbox">
                                            <img class="img-fluid rounded-bottom-start"
                                                 src="{{URL::asset('assets/admin/images/demo/images/3.png')}}" alt="">
                                ...
                                <div class="col">
                                        ...
                                        <a href="{{URL::asset('assets/admin/images/demo/images/4.png')}}"
                                           class="text-white" data-bs-popup="lightbox">
                                            <img class="img-fluid rounded-top-end"
                                                 src="{{URL::asset('assets/admin/images/demo/images/4.png')}}" alt="">
                                    ...
                                    <div class="card-img-actions">
                                        <a href="{{URL::asset('assets/admin/images/demo/images/6.png')}}"
                                           class="text-white" data-bs-popup="lightbox">
                                            <img class="img-fluid rounded-bottom-end"
                                                 src="{{URL::asset('assets/admin/images/demo/images/6.png')}}" alt="">
                            ...
                            <div class="row g-0">
                                <div class="col">
                                    ...
                                    <div class="card-img-actions">
                                        <a href="{{URL::asset('assets/admin/images/demo/images/2.png')}}"
                                           class="text-white" data-bs-popup="lightbox">
                                            <img class="img-fluid"
                                                 src="{{URL::asset('assets/admin/images/demo/images/2.png')}}" alt="">
                                ...
                                <div class="col">
                                    ...
                                    <div class="card-img-actions">
                                        <a href="{{URL::asset('assets/admin/images/demo/images/5.png')}}"
                                           class="text-white" data-bs-popup="lightbox">
                                            <img class="img-fluid"
                                                 src="{{URL::asset('assets/admin/images/demo/images/5.png')}}" alt="">
                                            <span class="card-img-actions-overlay">
                                                    <i class="ph-plus"></i>
                                                </span>
                                        </a>
                                ...
                                <div class="col">
                                    <div class="card-img-actions">
                                        <a href="{{URL::asset('assets/admin/images/demo/images/7.png')}}"
                                           class="text-white" data-bs-popup="lightbox">
                                            <img class="img-fluid rounded-top-end"
                                                 src="{{URL::asset('assets/admin/images/demo/images/7.png')}}" alt="">
                                            <span class="card-img-actions-overlay rounded-top-end">
                                                    <i class="ph-plus"></i>
                                                </span>
                                        </a>
                                    ...
                                    <div class="card-img-actions">
                                        <a href="{{URL::asset('assets/admin/images/demo/images/8.png')}}"
                                           class="text-white" data-bs-popup="lightbox">
                                            <img class="img-fluid"
                                                 src="{{URL::asset('assets/admin/images/demo/images/8.png')}}" alt="">
                                            <span class="card-img-actions-overlay">
                                                    <i class="ph-plus"></i>
                                                </span>
                                        </a>
                                    ...
                                    <div class="card-img-actions">
                                        <a href="{{URL::asset('assets/admin/images/demo/images/9.png')}}"
                                           class="text-white" data-bs-popup="lightbox">
                                            <img class="img-fluid rounded-bottom-end"
                                                 src="{{URL::asset('assets/admin/images/demo/images/9.png')}}" alt="">
                                            <span class="card-img-actions-overlay rounded-bottom-end">
                                                    <i class="ph-plus"></i>
                                                </span>
                                        </a>
                        ...
                        <div class="sidebar-section-body">
                            <form action="#">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control colorpicker-flat-full"
                                           data-preferred-format="hex" value="#45818e">
                                </div>
                        ...
                        <div class="mb-3">
                            <div>
                                <div class="sidebar-section-header bg-light border-bottom">
                                    <a class="text-body fw-semibold d-flex align-items-center flex-grow-1"
                                       data-bs-toggle="collapse" href="#collapsible-item-group1">
                                        Collapsible Item #1
                            ...
                            <div>
                                <div class="sidebar-section-header bg-light border-bottom">
                                    <a class="collapsed text-body fw-semibold d-flex align-items-center flex-grow-1"
                                       data-bs-toggle="collapse" href="#collapsible-item-group2">
                                        Collapsible Item #2
                                        <i class="ph-caret-down collapsible-indicator ms-auto"></i>
                                    </a>
                                </div>
                            ...
                            <div>
                                <div class="sidebar-section-header bg-light border-bottom">
                                    <a class="collapsed text-body fw-semibold d-flex align-items-center flex-grow-1"
                                       data-bs-toggle="collapse" href="#collapsible-item-group3">
                                        Collapsible Item #3
                                        <i class="ph-caret-down collapsible-indicator ms-auto"></i>
                                    </a>
                                </div>
                ...
                <div class="sidebar-section">
                    ...
                    <div class="collapse show" id="sidebar-buttons">
                        <div class="sidebar-section-body text-center">
                            ...
                            <div class="mb-2">
                                <div class="btn-group">
                                    <button type="button" class="btn btn-success dropdown-toggle"
                                            data-bs-toggle="dropdown">Button dropdown
                                    </button>
                            ...
                            <div class="row">
                                <div class="col">
                                    <button type="button" class="btn btn-teal w-100">Grid</button>
                                </div>
                                <div class="col">
                                    <button type="button" class="btn btn-purple w-100">Buttons</button>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header bg-light">
                                    <button class="accordion-button fw-semibold" type="button" data-bs-toggle="collapse"
                                            data-bs-target="#expanded_item1" aria-expanded="true">
                                        Accordion Item #1
                                    </button>
                                </h2>
                                <div id="expanded_item1" class="accordion-collapse collapse show"
                                     data-bs-parent="#accordion_expanded" style="">
            ...
            <div class="tab-pane fade" id="other-tab">
                ...
                <!-- Combined controls -->
                <div class="sidebar-section sidebar-section-sortable collapse show"
                     id="sidebar-section-controls-combined">
                    <div class="sidebar-section-header border-bottom">
                        ...
                        <div class="d-inline-flex ms-auto">
                            ...
                            <a href="#sidebar-section-controls-combined" class="text-reset ms-2"
                ...
                <div class="sidebar-section">
                    ...
                    <div class="collapse show" id="sidebar-progress-list">
                        <div class="sidebar-section-body">
                            <div class="mb-3">
                                <div class="d-flex align-items-center mb-1">CPU usage <span class="opacity-50 ms-auto">50%</span>
                                </div>
                                <div class="progress" style="height: 0.125rem;">
                                    <div class="progress-bar progress-bar-striped progress-bar-animated bg-info"
                            ...
                            <div class="mb-3">
                                <div class="d-flex align-items-center mb-1">RAM usage <span class="opacity-50 ms-auto">70%</span>
                                </div>
                                <div class="progress" style="height: 0.125rem;">
                                    <div class="progress-bar progress-bar-striped progress-bar-animated bg-danger"
                            ...
                            <div class="mb-3">
                                <div class="d-flex align-items-center mb-1">Disc space <span class="opacity-50 ms-auto">80%</span>
                                </div>
                                <div class="progress" style="height: 0.125rem;">
                                    <div class="progress-bar progress-bar-striped progress-bar-animated bg-success"
                            ...
                            <div>
                                <div class="d-flex align-items-center mb-1">Bandwidth <span class="opacity-50 ms-auto">60%</span>
                                </div>
                                <div class="progress" style="height: 0.125rem;">
                                    <div class="progress-bar progress-bar-striped progress-bar-animated"
                                         style="width: 60%" aria-valuenow="60" aria-valuemin="0"
                        ...
                        <div class="sidebar-section-body">
                            <form action="#">
                                ...
                                <div>
                                    ...
                                    <div class="noui-slider-info has-pips noui-pips-height-helper"
                                         id="noui-slider-pips-range"></div>
                                </div>
                            </form>
                        </div>
                    </div>
                ...
                <div class="sidebar-section">
                    ...
                    <div class="collapse show" id="sidebar-sliders-vertical">
                        <div class="sidebar-section-body text-center">
                            <div class="noui-slider-primary has-pips noui-vertical-height-helper"
                                 id="noui-slider-bottom1"></div>
                            <div class="noui-slider-primary has-pips noui-vertical-height-helper"
                                 id="noui-slider-bottom2"></div>
                        </div>
                    </div>
                </div>
                <!-- /vertical sliders -->
                    ...
                    <div class="collapse show" id="sidebar-user">
                        <div class="sidebar-section-body">
                            <div class="d-flex justify-content-center">
                                <a href="#">
                                    <img src="{{URL::asset('assets/admin/images/demo/users/face11.jpg')}}" width="40"
                                         height="40" class="rounded-pill" alt="">
                                </a>
                    ...
                    <div class="collapse show" id="sidebar-list-media">
                        <div class="sidebar-section-body">
                            <div class="d-flex mb-3">
                                <a href="#" class="me-3">
                                    <img src="{{URL::asset('assets/admin/images/demo/users/face1.jpg')}}" width="40"
                            ...
                            <div class="d-flex mb-3">
                                <a href="#" class="me-3">
                                    <img src="{{URL::asset('assets/admin/images/demo/users/face2.jpg')}}" width="40"
                                         height="40" class="rounded-circle" alt="">
                                </a>
                                <div class="flex-fill">
                            ...
                            <div class="d-flex mb-3">
                                <a href="#" class="me-3">
                                    <img src="{{URL::asset('assets/admin/images/demo/users/face3.jpg')}}" width="40"
                                         height="40" class="rounded-circle" alt="">
                                </a>
                                <div class="flex-fill">
                            ...
                            <div class="d-flex mb-3">
                                <a href="#" class="me-3">
                                    <img src="{{URL::asset('assets/admin/images/demo/users/face4.jpg')}}" width="40"
                                         height="40" class="rounded-circle" alt="">
                                </a>
                                <div class="flex-fill">
                            ...
                            <div class="d-flex">
                                <a href="#" class="me-3">
                                    <img src="{{URL::asset('assets/admin/images/demo/users/face5.jpg')}}" width="40"
                                         height="40" class="rounded-circle" alt="">
                                </a>
                                <div class="flex-fill">
                    ...
                    <div class="collapse show" id="sidebar-list-media-linked">
                        <div class="list-group list-group-borderless py-1">
                            <a href="#" class="list-group-item list-group-item-action d-flex">
                                <div class="me-3">
                                    <img src="{{URL::asset('assets/admin/images/demo/users/face14.jpg')}}" width="40"
                                         height="40" class="rounded-circle" alt="">
                                </div>
                                <div class="flex-fill">
                            ...
                            <a href="#" class="list-group-item list-group-item-action d-flex">
                                <div class="me-3">
                                    <img src="{{URL::asset('assets/admin/images/demo/users/face7.jpg')}}" width="40"
                                         height="40" class="rounded-circle" alt="">
                                </div>
                                <div class="flex-fill">
                            ...
                            <a href="#" class="list-group-item list-group-item-action d-flex">
                                <div class="me-3">
                                    <img src="{{URL::asset('assets/admin/images/demo/users/face8.jpg')}}" width="40"
                                         height="40" class="rounded-circle" alt="">
                                </div>
                                <div class="flex-fill">
                            ...
                            <a href="#" class="list-group-item list-group-item-action d-flex">
                                <div class="me-3">
                                    <img src="{{URL::asset('assets/admin/images/demo/users/face9.jpg')}}" width="40"
                                         height="40" class="rounded-circle" alt="">
                                </div>
                                <div class="flex-fill">
                            ...
                            <a href="#" class="list-group-item list-group-item-action d-flex">
                                <div class="me-3">
                                    <img src="{{URL::asset('assets/admin/images/demo/users/face10.jpg')}}" width="40"
                                         height="40" class="rounded-circle" alt="">
                                </div>
                                <div class="flex-fill">
                ...
                <div class="sidebar-section mb-2">
                    ...
                    <div class="collapse show" id="sidebar-list-media-linked-multiline">
                        <div class="list-group list-group-borderless py-1">
                            <a href="#" class="list-group-item list-group-item-action d-flex">
                                <div class="me-3">
                                    <img src="{{URL::asset('assets/admin/images/demo/users/face25.jpg')}}" width="40"
                                         height="40" class="rounded-circle" alt="">
                                </div>
                                <div class="flex-fill">
                            ...
                            <a href="#" class="list-group-item list-group-item-action d-flex">
                                <div class="me-3">
                                    <img src="{{URL::asset('assets/admin/images/demo/users/face12.jpg')}}" width="40"
                                         height="40" class="rounded-circle" alt="">
                                </div>
                                <div class="flex-fill">
                            ...
                            <a href="#" class="list-group-item list-group-item-action d-flex">
                                <div class="me-3">
                                    <img src="{{URL::asset('assets/admin/images/demo/users/face15.jpg')}}" width="40"
                                         height="40" class="rounded-circle" alt="">
                                </div>
                                <div class="flex-fill">
                ...
                <div class="sidebar-section">
                    ...
                    <div class="collapse show" id="sidebar-list-actions">
                        <div class="sidebar-section-body">
                            ...
                            <div class="d-flex align-items-center mb-3">
                                <a href="#" class="me-3">
                                    <img src="{{URL::asset('assets/admin/images/demo/users/face6.jpg')}}" width="40"
                                         height="40" class="rounded-circle" alt="">
                                </a>
                ...
                <div class="sidebar-section">
                    ...
                    <div class="collapse show" id="sidebar-list-action-menu">
                        <div class="sidebar-section-body">
                            ...
                            <div class="d-flex align-items-center mb-3">
                                <a href="#" class="me-3 position-relative">
                                    <img src="{{URL::asset('assets/admin/images/demo/users/face24.jpg')}}" width="40"
                                         height="40" class="rounded-circle" alt="">
                            ...
                            <div class="d-flex align-items-center">
                                <a href="#" class="me-3">
                                    <img src="{{URL::asset('assets/admin/images/demo/users/face20.jpg')}}" width="40"
                                         height="40" class="rounded-circle" alt="">
                                </a>
    ...
    <div class="content-wrapper">
        ...
        <div class="content">
            ...
            <div class="alert alert-success alert-dismissible">
                ...
                This page contains a major part of components, adapted for usage in the sidebar: form components,
                navigation, UI components, plugins and custom widgets.
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <p class="mb-3">Sidebar - vertical area that displays onscreen and presents widget components and
                        website navigation menu in a text-based hierarchical form. All sidebars are css-driven - just
                        add one of css classes to the <code>.sidebar</code> container, and sidebar will change its width
                        and color. No js, css only. Although sidebar type is based on css, buttons do their job with JS
                        - they switch necessary classes in <code>.sidebar</code> container. Below you'll find summarized
                        tables with all available <code>button</code> and <code>sidebar</code> container classes. By
                        default, the template includes 6 different sidebar types and combinations:</p>

                    <div class="mb-3">
                        <h6>1. Default sidebar</h6>
                        <p>Default template sidebar has <code>300px</code> (~18.75rem) width, aligned to the left (to
                            the right in RTL version) and has dark blue background color. All navigation levels are
                            based on accordion <strong>or</strong> collapsible functionality, open on click. Supports 2
                            versions: fixed (default) and static (in static layout only). Both versions use default
                            browser scrollbars, but support custom scrollbars such as <code>perfect scrollbar</code>
                            component.</p>
                    </div>

                    <div class="mb-3">
                        <h6>2. Mini sidebar</h6>
                        <p>Mini sidebar has <code>56px</code> width, which is calculated dynamically (icon size + double
                            padding). No text in parent level of menu items, aligned to the left (to the right in RTL
                            version) and has dark blue background color. Sidebar changes the width on hover, no
                            additional changes. It is <strong>required</strong> to add
                            <code>.sidebar-main-resized</code> class to the <code>.sidebar</code> container if you want
                            to have it collapsed by default. This class is responsible for sidebar width and main
                            navigation. By default all components except main navigation are hidden in mini sidebar. Can
                            be used with main sidebar only.</p>
                    </div>

                    <div class="mb-3">
                        <h6>3. Secondary sidebar</h6>
                        <p>Main sidebar has <code>300px</code> width or <code>56px</code> (if <code>.sidebar-main-resized</code>
                            class added). Secondary sidebar has the same fixed width of <code>300px</code>, which is
                            similar to default and right sidebars, so different sidebar components can be placed to all
                            sidebar types. Main and secondary sidebars can contain any content - menu, navigation,
                            buttons, lists, tabs etc. Secondary sidebar can be either collapsed or hidden.</p>
                    </div>

                    <div class="mb-3">
                        <h6>4. Right sidebar</h6>
                        <p>Right sidebar layout includes additional sidebar displayed on the right (left in RTL
                            direction) side. It is displayed as an additional component with 100% height, similar to
                            other sidebars. Right sidebar is visible by default, but can be collapsed or hidden.</p>
                    </div>

                    <div class="mb-3">
                        <h6>5. Right/Secondary sidebars</h6>
                        <p>Secondary and Right sidebars can be used together, so basically it is a 4 column layout. The
                            width of any sidebar doesn't affect other layout columns, they all have independent width
                            controls. Refer to the table below for more information.</p>
                    </div>

                    <div class="mb-3">
                        <h6>6. Content (component) sidebar</h6>
                        <p>Usually sidebar is not a part of content and mainly used for navigation. Limitless allows you
                            to use sidebar outside and inside content area. Content sidebar isn't based on grid and has
                            the same width as other sidebars, this means all sidebar components can be placed inside
                            content sidebar. Supports left and right positioning and can be either stretched to fill all
                            available height or height that depends on sidebar content height.</p>
                    </div>
                </div>
            </div>
            <!-- /sidebars overview -->
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <h6>Overview</h6>
                    <p class="mb-3">This table displays all optional <code>button</code> classes, responsible for the
                        sidebar appearance. Depending on the sidebar type, add one of these classes to any button or
                        link and this element will handle sidebar control. Multiple controls are also available - add as
                        many sidebar controls as you wish. Please note: these classes don't change sidebar markup, only
                        CSS rules.</p>
                    <div class="table-responsive border rounded mb-4">
                        <table class="table">
                            ...
                            <tr>
                                ...
                                <td>Resizable sidebar. Changes main sidebar width from default to mini. This button is
                                    added to all pages by default.
                                </td>
                            </tr>
                            <tr>
                                <td><code>.sidebar-main-toggle</code></td>
                                <td>Collapses/expands and/or hides/shows <code>main</code> sidebar. Used mostly in dual
                                    sidebar type to hide main sidebar.
                                </td>
                            </tr>
                            <tr>
                                <td><code>.sidebar-end-toggle</code></td>
                                <td>Toggles right sidebar - if right sidebar is shown, main sidebar width remains the
                                    same, whether it's in default or mini mode.
                                </td>
                            </tr>
                            <tr>
                                <td><code>.sidebar-secondary-toggle</code></td>
                                <td>Hides/shows or collapses/expands <code>secondary</code> sidebar. Secondary sidebar
                                    supports only toggle functionality and always has fixed width of <code>300px</code>.
                                </td>
                            </tr>
                            <tr>
                                <td><code>.sidebar-component-toggle</code></td>
                                <td>Hides/shows <code>content</code> sidebars. Content sidebars aren't connected with
                                    other sidebars, so this is the only button that controls their visibility.
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>Toggles <code>content</code> sidebar on mobile - has full width by default, has no
                                    animation.
                                </td>
                            </tr>
                            </tbody>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <h6>Overview</h6>
                    <p class="mb-3">This table demonstrates all classes for <code>sidebar</code> container, responsible
                        for the sidebar width and color. Almost all of these classes are mandatory, some of them are
                        responsible for proper styling or have a specific code attached to this class (like <code>.sidebar-main</code>
                        class, which has collapsible functionality). All classes can be combined depending on the type
                        of sidebar:</p>
                    <div class="table-responsive border rounded mb-4">
                        <table class="table">
                            <thead class="table-light">
                            ...
                            <tr>
                                ...
                                <td>Defines <strong>main</strong> sidebar. Mini sidebar
                                    (<code>.sidebar-main-resized</code> class) takes effect only if sidebar has <code>.sidebar-main</code>
                                    class. By default, all components except main navigation are hidden in mini sidebar.
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>Defines <strong>secondary</strong> sidebar. Has fixed <code>270px</code> width and
                                    usually comes after main sidebar.
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>Defines <strong>right</strong> sidebar. Has fixed <code>270px</code> width and
                                    appears on the right side from the main sidebar.
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>This class is required in <strong>content</strong> (or component) sidebar. Also
                                    requires <code>.sidebar-component-left</code> or
                                    <code>.sidebar-component-right</code> classes for proper spacing.
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>Defines <strong>dark</strong> sidebar. This class can be applied to all sidebar
                                    types and positions. This class is also required for custom colors (see below).
                                </td>
                            </tr>
                            <tr>
                                <td><code>.sidebar-dark.bg-*</code></td>
                                <td>Defines sidebar background color. According to the custom color system, sidebar
                                    background color can be changed to one of the available colors by adding a proper
                                    class to the main sidebar container.
                                </td>
                            </tr>
                            <tr>
                                <td><code>.sidebar-expand-[breakpoint]</code></td>
                                <td>This class specifies when sidebar needs to be collapsed, basically when sidebar
                                    switches to mobile mode. Breakpoint should always be similar to
                                    <strong>navbar</strong> breakpoint for proper matching. Available breakpoints are:
                                    xl, lg, md and sm. This class is required.
                                </td>
                            </tr>
                            <tr>
                                <td><code>.sidebar-main-unfold</code></td>
                                <td>This class gets added when user hovers on mini sidebar. It controls resizable
                                    behaviour when main sidebar is collapsed. Has no effect on mobile since all sidebars
                                    on mobile have same width.
                                </td>
                            </tr>
                            </tbody>
                        </table>
