    ...
    <div class="content-wrapper">
        ...
        <div class="content">
            ...
            <div class="alert alert-success alert-dismissible">
                ...
                You can have maximum of 2 <strong>bottom</strong> <code>fixed</code> navbars - since the element is
                removed from the normal document flow and no space is created for the element in the page layout, <code>&lt;body&gt;</code>
                requires additional classes in order to set correct bottom padding. That's why both navbars need to be
                wrapped in <code>.fixed-bottom</code> container and <code>&lt;body&gt;</code> container needs to have
                <code>.navbar-[size]-[size]-bottom</code> class. See the table below for classes explanation.
