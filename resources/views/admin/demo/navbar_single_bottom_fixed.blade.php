    ...
    <div class="content-wrapper">
        ...
        <div class="content">
            ...
            <div class="alert alert-success alert-dismissible">
                ...
                Bottom <code>fixed</code> navbar is positioned relatively to the screen's viewport and doesn't move when
                scrolled. To use, add <code>.fixed-bottom</code> class to the <code>.navbar</code> container and <code>.navbar-bottom</code>
