                                ...
                                <table class="table text-nowrap">
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <a href="#" class="d-block me-3">
                                                    <img src="{{URL::asset('assets/admin/images/brands/facebook.svg')}}"
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <a href="#" class="d-block me-3">
                                                    <img src="{{URL::asset('assets/admin/images/brands/youtube.svg')}}"
                                                         class="rounded-circle" width="36" height="36" alt="">
                                                </a>
                                                <div>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <a href="#" class="d-block me-3">
                                                    <img src="{{URL::asset('assets/admin/images/brands/spotify.svg')}}"
                                                         class="rounded-circle" width="36" height="36" alt="">
                                                </a>
                                                <div>
                                        ...
                                        <td><span class="text-danger"><i class="ph-trend-down me-2"></i> 8.02%</span>
                                        </td>
                                        <td>
                                            <h6 class="mb-0">$1,268</h6>
                                        </td>
                                        <td><span class="badge bg-secondary bg-opacity-10 text-secondary">On hold</span>
                                        </td>
                                        <td class="text-center">
                                            <div class="dropdown">
                                                <a href="#" class="text-body" data-bs-toggle="dropdown">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <a href="#" class="d-block me-3">
                                                    <img src="{{URL::asset('assets/admin/images/brands/twitter.svg')}}"
                                                         class="rounded-circle" width="36" height="36" alt="">
                                                </a>
                                                <div>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <a href="#" class="d-block me-3">
                                                    <img src="{{URL::asset('assets/admin/images/brands/bing.svg')}}"
                                                         class="rounded-circle" width="36" height="36" alt="">
                                                </a>
                                                <div>
                                        ...
                                        <td><span class="text-danger"><i class="ph-trend-down me-2"></i> 5.78%</span>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <a href="#" class="d-block me-3">
                                                    <img src="{{URL::asset('assets/admin/images/brands/amazon.svg')}}"
                                                         class="rounded-circle" width="36" height="36" alt="">
                                                </a>
                                                <div>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <a href="#" class="d-block me-3">
                                                    <img src="{{URL::asset('assets/admin/images/brands/dribbble.svg')}}"
                                                         class="rounded-circle" width="36" height="36" alt="">
                                                </a>
                                                <div>
                                        ...
                                        <td><span class="text-danger"><i class="ph-trend-down me-2"></i> 9.83%</span>
                                        </td>
                                        <td>
                                ...
                                <table class="table text-nowrap">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="#" class="text-body">
                                                <div class="fw-semibold">[#1183] Workaround for OS X selects printing
                                                    bug
                                                </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <a href="#" class="d-inline-block me-3">
                                                    <img src="{{URL::asset('assets/admin/images/demo/users/face8.jpg')}}"
                                                         class="rounded-circle" width="40" height="40" alt="">
                                                </a>
                                                <div>
                            ...
                            <div class="card-body pb-0">
                                <div class="row">
                                    <div class="col-xl-6">
                                        <div class="d-sm-flex align-items-sm-start mb-3">
                                            <a href="#" class="d-inline-block position-relative me-sm-3 mb-3 mb-sm-0">
                                                <img src="{{URL::asset('assets/admin/images/demo/flat/1.png')}}"
                                        ...
                                        <div class="d-sm-flex align-items-sm-start mb-3">
                                            <a href="#" class="d-inline-block position-relative me-sm-3 mb-3 mb-sm-0">
                                                <img src="{{URL::asset('assets/admin/images/demo/flat/21.png')}}"
                                                     class="flex-shrink-0 rounded" height="100" alt="">
                                                <div class="d-inline-flex bg-dark bg-opacity-50 text-white position-absolute start-50 top-50 translate-middle rounded-pill p-2">
                                                    <i class="ph-play"></i>
                                                </div>
                                    ...
                                    <div class="col-xl-6">
                                        <div class="d-sm-flex align-items-sm-start mb-3">
                                            <a href="#" class="d-inline-block position-relative me-sm-3 mb-3 mb-sm-0">
                                                <img src="{{URL::asset('assets/admin/images/demo/flat/12.png')}}"
                                                     class="flex-shrink-0 rounded" height="100" alt="">
                                                <div class="d-inline-flex bg-dark bg-opacity-50 text-white position-absolute start-50 top-50 translate-middle rounded-pill p-2">
                                                    <i class="ph-play"></i>
                                                </div>
                                        ...
                                        <div class="d-sm-flex align-items-sm-start mb-3">
                                            <a href="#" class="d-inline-block position-relative me-sm-3 mb-3 mb-sm-0">
                                                <img src="{{URL::asset('assets/admin/images/demo/flat/18.png')}}"
                                                     class="flex-shrink-0 rounded" height="100" alt="">
                                                <div class="d-inline-flex bg-dark bg-opacity-50 text-white position-absolute start-50 top-50 translate-middle rounded-pill p-2">
                                                    <i class="ph-play"></i>
                                                </div>
                        ...
                        <div class="card">
                            ...
                            <div class="tab-content card-body">
                                ...
                                <div class="tab-pane fade" id="messages-mon">
                                    ...
                                    <div class="d-flex align-items-start mb-3">
                                        <div class="status-indicator-container me-3">
                                            <img src="{{URL::asset('assets/admin/images/demo/users/face7.jpg')}}"
                                                 class="rounded-circle" width="40" jeight="40" alt="">
                                    ...
                                    <div class="d-flex align-items-start mb-3">
                                        <div class="status-indicator-container me-3">
                                            <img src="{{URL::asset('assets/admin/images/demo/users/face14.jpg')}}"
                                                 class="rounded-circle" width="40" jeight="40" alt="">
                                            <span class="status-indicator bg-success"></span>
                                        </div>
                                ...
                                <div class="tab-pane fade" id="messages-fri">
                                    ...
                                    <div class="d-flex align-items-start mb-3">
                                        <div class="status-indicator-container me-3">
                                            <img src="{{URL::asset('assets/admin/images/demo/users/face22.jpg')}}"
                                                 class="rounded-circle" width="40" jeight="40" alt="">
                                            <span class="status-indicator bg-danger"></span>
                                        </div>
                                    ...
                                    <div class="d-flex align-items-start">
                                        <div class="status-indicator-container me-3">
                                            <img src="{{URL::asset('assets/admin/images/demo/users/face17.jpg')}}"
                                                 class="rounded-circle" width="40" jeight="40" alt="">
                                            <span class="status-indicator bg-secondary"></span>
                                        </div>
