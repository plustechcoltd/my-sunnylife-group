                ...
                <ul class="nav nav-sidebar" id="navbar-nav" data-nav-type="accordion">
                    ...
                    <li class="nav-item nav-item-submenu">
                        ...
                        <ul class="nav-group-sub collapse" data-submenu-title="Themes">
                            ...
                            <li class="nav-item"><a href="javascrip:void(0)" class="nav-link disabled">Material <span
                                            class="badge align-self-center ms-auto">Coming soon</span></a></li>
                            <li class="nav-item"><a href="javascrip:void(0)" class="nav-link disabled">Clean <span
                                            class="badge align-self-center ms-auto">Coming soon</span></a></li>
                        </ul>
                    </li>
                        ...
                        <ul class="nav-group-sub collapse" data-submenu-title="Sidebars">
                            ...
                            <li class="nav-item nav-item-submenu">
                                ...
                                <ul class="nav-group-sub collapse">
                                    ...
                                    <li class="nav-item"><a href="sidebar_secondary_color_dark" class="nav-link">Dark
                                            color</a></li>
                                </ul>
                            </li>
                            <li class="nav-item nav-item-submenu">
    ...
    <div class="sidebar sidebar-secondary sidebar-expand-lg align-self-start">
        ...
        <div class="sidebar-content">
            ...
            <div class="sidebar-section sidebar-section-body d-flex align-items-center d-lg-none pb-2">
                ...
                <div class="ms-auto">
                    <button type="button"
                            class="btn btn-light border-transparent btn-icon rounded-pill btn-sm sidebar-mobile-secondary-toggle">
                        <i class="ph-x"></i>
                    </button>
                </div>
            </div>
    ...
    <div class="content-wrapper">
        ...
        <div class="content">
            ...
            <div class="alert alert-success alert-dismissible">
                ...
                By default, all sidebars take 100% of content height. To give them 100% of document height, remove
                <code>.align-self-start</code> class from sidebar container
