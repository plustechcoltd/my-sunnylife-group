<div class="notification-template">
    <div @click.prevent="markAsRead(notification.id, notification.redirect_url)"
         class="bg-light list-group-item d-flex align-items-start cursor-pointer"
         :class="{'bg-light': notification.read_yn == 'y'}"
         x-data="user_register(notification)">
        <div class="me-3">
