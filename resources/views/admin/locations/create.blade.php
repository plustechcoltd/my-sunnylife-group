...
@section('title')
    {{ __('label.labels.create') }} | {{ __('label.tables.locations') }}
@endsection
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-lg-12 col-xxl-10 offset-xxl-1 mt-3">
                        ...
                        <form class="mo-tab_content location-form" id="form-create-location" method="POST"
    ...
    <script>
      $(function() {
        $('#submit-form').on('click', function(e) {
          ...
          let form_location = $('form#form-create-location');
