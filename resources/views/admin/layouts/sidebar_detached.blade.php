            ...
            <ul class="nav nav-sidebar" id="navbar-nav" data-nav-type="accordion">
                ...
                <li class="nav-item nav-item-submenu">
                    ...
                    <ul class="nav-group-sub collapse" data-submenu-title="Themes">
                        ...
                        <li class="nav-item"><a href="javacsript:void(0)" class="nav-link disabled">Material <span class="badge align-self-center ms-auto">Coming soon</span></a></li>
                        <li class="nav-item"><a href="javacsript:void(0)" class="nav-link disabled">Clean <span class="badge align-self-center ms-auto">Coming soon</span></a></li>
                    </ul>
                </li>

                <li class="nav-item">
                    <a href="javacsript:void(0)" class="nav-link">
                ...
                <li class="nav-item nav-item-submenu nav-item-expanded nav-item-open">
                    ...
                    <ul class="nav-group-sub collapse show" data-submenu-title="Page layouts">
                        ...
                        <li class="nav-item-divider"></li>
                        <li class="nav-item"><a href="layout_2_sidebars_1_side" class="nav-link active">2 sidebars on 1 side</a></li>
