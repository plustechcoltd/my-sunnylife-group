    ...
    <div class="container-fluid">
        ...
        <div class="d-flex justify-content-end align-items-center ms-auto">
            <ul class="nav flex-row justify-content-end order-1 order-lg-2">
                <li class="nav-item">
                    <a href="{{ route('web.contacts.index') }}" class="navbar-nav-link navbar-nav-link-icon rounded ms-1">
                ...
                <li class="nav-item">
                    <a href="{{ route('web.register') }}" class="navbar-nav-link navbar-nav-link-icon rounded ms-1">
                        <div class="d-flex align-items-center mx-md-1">
                ...
                <li class="nav-item">
                    <a href="{{ route('web.login') }}" class="navbar-nav-link navbar-nav-link-icon rounded ms-1">
                        <div class="d-flex align-items-center mx-md-1">
