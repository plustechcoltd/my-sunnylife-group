            ...
            <div class="sidebar-section bg-black bg-opacity-10 border-bottom border-bottom-white border-opacity-10">
                <div class="sidebar-logo d-flex justify-content-center align-items-center">
                    <a href="index" class="d-inline-flex align-items-center py-2">
                        <img src="{{URL::asset('assets/demo/layout_2/images/logo_icon.svg')}}" class="sidebar-logo-icon" alt="">
                        <img src="{{URL::asset('assets/demo/layout_2/images/logo_text_light.svg')}}" class="sidebar-resize-hide ms-3" height="14" alt="">
                    </a>
                ...
                <div class="sidebar-section sidebar-resize-hide dropdown mx-2">
                    <a href="#" class="btn btn-link text-body text-start lh-1 dropdown-toggle p-2 my-1 w-100" data-bs-toggle="dropdown" data-color-theme="dark">
                        <div class="hstack gap-2 flex-grow-1 my-1">
                            <img src="{{URL::asset('assets/demo/layout_2/images/brands/shell.svg')}}" class="w-32px h-32px" alt="">
                            <div class="me-auto">
                    ...
                    <div class="dropdown-menu w-100">
                        <a href="#" class="dropdown-item hstack gap-2 py-2">
                            <img src="{{URL::asset('assets/demo/layout_2/images/brands/tesla.svg')}}" class="w-32px h-32px" alt="">
                            <div>
                        ...
                        <a href="#" class="dropdown-item hstack gap-2 py-2">
                            <img src="{{URL::asset('assets/demo/layout_2/images/brands/debijenkorf.svg')}}" class="w-32px h-32px" alt="">
                            <div>
                        ...
                        <a href="#" class="dropdown-item hstack gap-2 py-2">
                            <img src="{{URL::asset('assets/demo/layout_2/images/brands/klm.svg')}}" class="w-32px h-32px" alt="">
                            <div>
                        ...
                        <a href="#" class="dropdown-item hstack gap-2 py-2">
                            <img src="{{URL::asset('assets/demo/layout_2/images/brands/bp.svg')}}" class="w-32px h-32px" alt="">
                            <div>
