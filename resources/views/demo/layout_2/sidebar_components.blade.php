                            ...
                            <div class="sidebar-section-body">
                                <div class="mb-2">
                                    <div class="card-img-actions">
                                        <a href="{{URL::asset('assets/demo/layout_2/images/demo/images/1.png')}}" class="text-white" data-bs-popup="lightbox">
                                            <img class="img-thumbnail rounded img-fluid" src="{{URL::asset('assets/demo/layout_2/images/demo/images/1.png')}}" alt="">
                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="mb-2">
                                            <div class="card-img-actions">
                                                <a href="{{URL::asset('assets/demo/layout_2/images/demo/images/2.png')}}" class="text-white" data-bs-popup="lightbox">
                                                    <img class="img-fluid rounded" src="{{URL::asset('assets/demo/layout_2/images/demo/images/2.png')}}" alt="">
                                                    <span class="card-img-actions-overlay rounded">
                                                        <i class="ph-plus"></i>
                                                    </span>
                                                </a>
                                        ...
                                        <div class="mb-2">
                                            <div class="card-img-actions">
                                                <a href="{{URL::asset('assets/demo/layout_2/images/demo/images/3.png')}}" class="text-white" data-bs-popup="lightbox">
                                                    <img class="img-fluid rounded" src="{{URL::asset('assets/demo/layout_2/images/demo/images/3.png')}}" alt="">
                                                    <span class="card-img-actions-overlay rounded">
                                                        <i class="ph-plus"></i>
                                                    </span>
                                                </a>
                                    ...
                                    <div class="col">
                                        <div class="mb-2">
                                            <div class="card-img-actions">
                                                <a href="{{URL::asset('assets/demo/layout_2/images/demo/images/4.png')}}" class="text-white" data-bs-popup="lightbox">
                                                    <img class="img-fluid rounded" src="{{URL::asset('assets/demo/layout_2/images/demo/images/4.png')}}" alt="">
                                                    <span class="card-img-actions-overlay rounded">
                                                        <i class="ph-plus"></i>
                                                    </span>
                                                </a>
                                        ...
                                        <div class="mb-2">
                                            <div class="card-img-actions">
                                                <a href="{{URL::asset('assets/demo/layout_2/images/demo/images/5.png')}}" class="text-white" data-bs-popup="lightbox">
                                                    <img class="img-fluid rounded" src="{{URL::asset('assets/demo/layout_2/images/demo/images/5.png')}}" alt="">
                                                    <span class="card-img-actions-overlay rounded">
                                                        <i class="ph-plus"></i>
                                                    </span>
                                                </a>
                            ...
                            <div class="sidebar-section-body">
                                <div class="row g-0 mb-3">
                                    <div class="col">
                                        <div class="card-img-actions">
                                            <a href="{{URL::asset('assets/demo/layout_2/images/demo/images/1.png')}}" class="text-white" data-bs-popup="lightbox">
                                                <img class="img-fluid rounded-top-start" src="{{URL::asset('assets/demo/layout_2/images/demo/images/1.png')}}" alt="">
                                        ...
                                        <div class="card-img-actions">
                                            <a href="{{URL::asset('assets/demo/layout_2/images/demo/images/3.png')}}" class="text-white" data-bs-popup="lightbox">
                                                <img class="img-fluid rounded-bottom-start" src="{{URL::asset('assets/demo/layout_2/images/demo/images/3.png')}}" alt="">
                                    ...
                                    <div class="col">
                                        <div class="card-img-actions">
                                            <a href="{{URL::asset('assets/demo/layout_2/images/demo/images/4.png')}}" class="text-white" data-bs-popup="lightbox">
                                                <img class="img-fluid rounded-top-end" src="{{URL::asset('assets/demo/layout_2/images/demo/images/4.png')}}" alt="">
                                        ...
                                        <div class="card-img-actions">
                                            <a href="{{URL::asset('assets/demo/layout_2/images/demo/images/6.png')}}" class="text-white" data-bs-popup="lightbox">
                                                <img class="img-fluid rounded-bottom-end" src="{{URL::asset('assets/demo/layout_2/images/demo/images/6.png')}}" alt="">
                                ...
                                <div class="row g-0">
                                    <div class="col">
                                        ...
                                        <div class="card-img-actions">
                                            <a href="{{URL::asset('assets/demo/layout_2/images/demo/images/2.png')}}" class="text-white" data-bs-popup="lightbox">
                                                <img class="img-fluid" src="{{URL::asset('assets/demo/layout_2/images/demo/images/2.png')}}" alt="">
                                    ...
                                    <div class="col">
                                        <div class="card-img-actions">
                                            <a href="{{URL::asset('assets/demo/layout_2/images/demo/images/4.png')}}" class="text-white" data-bs-popup="lightbox">
                                                <img class="img-fluid" src="{{URL::asset('assets/demo/layout_2/images/demo/images/4.png')}}" alt="">
                                                <span class="card-img-actions-overlay">
                                                    <i class="ph-plus"></i>
                                                </span>
                                            </a>
                                        ...
                                        <div class="card-img-actions">
                                            <a href="{{URL::asset('assets/demo/layout_2/images/demo/images/5.png')}}" class="text-white" data-bs-popup="lightbox">
                                                <img class="img-fluid" src="{{URL::asset('assets/demo/layout_2/images/demo/images/5.png')}}" alt="">
                                                <span class="card-img-actions-overlay">
                                                    <i class="ph-plus"></i>
                                                </span>
                                            </a>
                                        ...
                                        <div class="card-img-actions">
                                            <a href="{{URL::asset('assets/demo/layout_2/images/demo/images/6.png')}}" class="text-white" data-bs-popup="lightbox">
                                                <img class="img-fluid" src="{{URL::asset('assets/demo/layout_2/images/demo/images/6.png')}}" alt="">
                                                <span class="card-img-actions-overlay">
                                                    <i class="ph-plus"></i>
                                                </span>
                                            </a>
                                    ...
                                    <div class="col">
                                        <div class="card-img-actions">
                                            <a href="{{URL::asset('assets/demo/layout_2/images/demo/images/7.png')}}" class="text-white" data-bs-popup="lightbox">
                                                <img class="img-fluid rounded-top-end" src="{{URL::asset('assets/demo/layout_2/images/demo/images/7.png')}}" alt="">
                                                <span class="card-img-actions-overlay rounded-top-end">
                                                    <i class="ph-plus"></i>
                                                </span>
                                            </a>
                                        ...
                                        <div class="card-img-actions">
                                            <a href="{{URL::asset('assets/demo/layout_2/images/demo/images/8.png')}}" class="text-white" data-bs-popup="lightbox">
                                                <img class="img-fluid" src="{{URL::asset('assets/demo/layout_2/images/demo/images/8.png')}}" alt="">
                                                <span class="card-img-actions-overlay">
                                                    <i class="ph-plus"></i>
                                                </span>
                                            </a>
                                        ...
                                        <div class="card-img-actions">
                                            <a href="{{URL::asset('assets/demo/layout_2/images/demo/images/9.png')}}" class="text-white" data-bs-popup="lightbox">
                                                <img class="img-fluid rounded-bottom-end" src="{{URL::asset('assets/demo/layout_2/images/demo/images/9.png')}}" alt="">
                                                <span class="card-img-actions-overlay rounded-bottom-end">
                                                    <i class="ph-plus"></i>
                                                </span>
                                            </a>
                        ...
                        <div class="collapse show" id="sidebar-user">
                            <div class="sidebar-section-body">
                                <div class="d-flex justify-content-center">
                                    <a href="#">
                                        <img src="{{URL::asset('assets/demo/layout_2/images/demo/users/face11.jpg')}}" width="40" height="40" class="rounded-pill" alt="">
                                    </a>
                        ...
                        <div class="collapse show" id="sidebar-list-media">
                            <div class="sidebar-section-body">
                                <div class="d-flex mb-3">
                                    <a href="#" class="me-3">
                                        <img src="{{URL::asset('assets/demo/layout_2/images/demo/users/face1.jpg')}}" width="40" height="40" class="rounded-circle" alt="">
                                    </a>
                                    <div class="flex-fill">
                                ...
                                <div class="d-flex mb-3">
                                    <a href="#" class="me-3">
                                        <img src="{{URL::asset('assets/demo/layout_2/images/demo/users/face2.jpg')}}" width="40" height="40" class="rounded-circle" alt="">
                                    </a>
                                    <div class="flex-fill">
                                ...
                                <div class="d-flex mb-3">
                                    <a href="#" class="me-3">
                                        <img src="{{URL::asset('assets/demo/layout_2/images/demo/users/face3.jpg')}}" width="40" height="40" class="rounded-circle" alt="">
                                    </a>
                                    <div class="flex-fill">
                                ...
                                <div class="d-flex mb-3">
                                    <a href="#" class="me-3">
                                        <img src="{{URL::asset('assets/demo/layout_2/images/demo/users/face4.jpg')}}" width="40" height="40" class="rounded-circle" alt="">
                                    </a>
                                    <div class="flex-fill">
                                ...
                                <div class="d-flex">
                                    <a href="#" class="me-3">
                                        <img src="{{URL::asset('assets/demo/layout_2/images/demo/users/face5.jpg')}}" width="40" height="40" class="rounded-circle" alt="">
                                    </a>
                                    <div class="flex-fill">
                        ...
                        <div class="collapse show" id="sidebar-list-media-linked">
                            <div class="list-group list-group-borderless py-1">
                                <a href="#" class="list-group-item list-group-item-action d-flex">
                                    <div class="me-3">
                                        <img src="{{URL::asset('assets/demo/layout_2/images/demo/users/face14.jpg')}}" width="40" height="40" class="rounded-circle" alt="">
                                    </div>
                                    <div class="flex-fill">
                                ...
                                <a href="#" class="list-group-item list-group-item-action d-flex">
                                    <div class="me-3">
                                        <img src="{{URL::asset('assets/demo/layout_2/images/demo/users/face7.jpg')}}" width="40" height="40" class="rounded-circle" alt="">
                                    </div>
                                    <div class="flex-fill">
                                ...
                                <a href="#" class="list-group-item list-group-item-action d-flex">
                                    <div class="me-3">
                                        <img src="{{URL::asset('assets/demo/layout_2/images/demo/users/face8.jpg')}}" width="40" height="40" class="rounded-circle" alt="">
                                    </div>
                                    <div class="flex-fill">
                                ...
                                <a href="#" class="list-group-item list-group-item-action d-flex">
                                    <div class="me-3">
                                        <img src="{{URL::asset('assets/demo/layout_2/images/demo/users/face9.jpg')}}" width="40" height="40" class="rounded-circle" alt="">
                                    </div>
                                    <div class="flex-fill">
                                ...
                                <a href="#" class="list-group-item list-group-item-action d-flex">
                                    <div class="me-3">
                                        <img src="{{URL::asset('assets/demo/layout_2/images/demo/users/face10.jpg')}}" width="40" height="40" class="rounded-circle" alt="">
                                    </div>
                                    <div class="flex-fill">
                    ...
                    <div class="sidebar-section mb-2">
                        ...
                        <div class="collapse show" id="sidebar-list-media-linked-multiline">
                            <div class="list-group list-group-borderless py-1">
                                <a href="#" class="list-group-item list-group-item-action d-flex">
                                    <div class="me-3">
                                        <img src="{{URL::asset('assets/demo/layout_2/images/demo/users/face25.jpg')}}" width="40" height="40" class="rounded-circle" alt="">
                                    </div>
                                    <div class="flex-fill">
                                ...
                                <a href="#" class="list-group-item list-group-item-action d-flex">
                                    <div class="me-3">
                                        <img src="{{URL::asset('assets/demo/layout_2/images/demo/users/face11.jpg')}}" width="40" height="40" class="rounded-circle" alt="">
                                    </div>
                                    <div class="flex-fill">
                                ...
                                <a href="#" class="list-group-item list-group-item-action d-flex">
                                    <div class="me-3">
                                        <img src="{{URL::asset('assets/demo/layout_2/images/demo/users/face12.jpg')}}" width="40" height="40" class="rounded-circle" alt="">
                                    </div>
                                    <div class="flex-fill">
                                ...
                                <a href="#" class="list-group-item list-group-item-action d-flex">
                                    <div class="me-3">
                                        <img src="{{URL::asset('assets/demo/layout_2/images/demo/users/face15.jpg')}}" width="40" height="40" class="rounded-circle" alt="">
                                    </div>
                                    <div class="flex-fill">
                    ...
                    <div class="sidebar-section">
                        ...
                        <div class="collapse show" id="sidebar-list-actions">
                            <div class="sidebar-section-body">
                                ...
                                <div class="d-flex align-items-center mb-3">
                                    <a href="#" class="me-3">
                                        <img src="{{URL::asset('assets/demo/layout_2/images/demo/users/face6.jpg')}}" width="40" height="40" class="rounded-circle" alt="">
                                    </a>
                    ...
                    <div class="sidebar-section">
                        ...
                        <div class="collapse show" id="sidebar-list-action-menu">
                            <div class="sidebar-section-body">
                                ...
                                <div class="d-flex align-items-center mb-3">
                                    <a href="#" class="me-3 position-relative">
                                        <img src="{{URL::asset('assets/demo/layout_2/images/demo/users/face24.jpg')}}" width="40" height="40" class="rounded-circle" alt="">
                                ...
                                <div class="d-flex align-items-center">
                                    <a href="#" class="me-3">
                                        <img src="{{URL::asset('assets/demo/layout_2/images/demo/users/face20.jpg')}}" width="40" height="40" class="rounded-circle" alt="">
                                    </a>
