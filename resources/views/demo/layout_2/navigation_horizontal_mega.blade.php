                                ...
                                <div class="container-fluid">
                                    <div class="navbar-brand">
                                        <a href="index" class="d-inline-flex align-items-center">
                                            ...
                                            <img src="{{URL::asset('assets/demo/layout_2/images/logo_text_light.svg')}}" class="h-16px ms-3" alt="">
                                        </a>
                                    </div>
                                                ...
                                                <div class="dropdown-menu wmin-xl-300 p-0">
                                                    ...
                                                    <div class="p-3">
                                                        <div class="d-flex mb-3">
                                                            <div class="me-3">
                                                                <img src="{{URL::asset('assets/demo/layout_2/images/demo/users/face2.jpg')}}" width="40" height="40" class="rounded-pill" alt="">
                                                            </div>
                                                            <div class="flex-fill">
                                                        ...
                                                        <div class="d-flex mb-3">
                                                            <div class="me-3">
                                                                <img src="{{URL::asset('assets/demo/layout_2/images/demo/users/face3.jpg')}}" width="40" height="40" class="rounded-pill" alt="">
                                                            </div>
                                                            <div class="flex-fill">
                                                        ...
                                                        <div class="d-flex mb-3">
                                                            <div class="me-3">
                                                                <img src="{{URL::asset('assets/demo/layout_2/images/demo/users/face4.jpg')}}" width="40" height="40" class="rounded-pill" alt="">
                                                            </div>
                                                            <div class="flex-fill">
                                                    ...
                                                    <div class="dropdown-menu-scrollable py-2">
                                                        <a href="#" class="dropdown-item align-items-start text-wrap py-2">
                                                            <div class="status-indicator-container me-3">
                                                                <img src="{{URL::asset('assets/demo/layout_2/images/demo/users/face10.jpg')}}" class="w-40px h-40px rounded-pill" alt="">
                                                        ...
                                                        <a href="#" class="dropdown-item align-items-start text-wrap py-2">
                                                            <div class="status-indicator-container me-3">
                                                                <img src="{{URL::asset('assets/demo/layout_2/images/demo/users/face3.jpg')}}" class="w-40px h-40px rounded-pill" alt="">
                                                        ...
                                                        <a href="#" class="dropdown-item align-items-start text-wrap py-2">
                                                            <div class="status-indicator-container me-3">
                                                                <img src="{{URL::asset('assets/demo/layout_2/images/demo/users/face24.jpg')}}" class="w-40px h-40px rounded-pill" alt="">
                                                                <span class="status-indicator bg-success"></span>
                                                            </div>
                                                            <div class="flex-1">
                                                        ...
                                                        <a href="#" class="dropdown-item align-items-start text-wrap py-2">
                                                            <div class="status-indicator-container me-3">
                                                                <img src="{{URL::asset('assets/demo/layout_2/images/demo/users/face4.jpg')}}" class="w-40px h-40px rounded-pill" alt="">
                                                        ...
                                                        <a href="#" class="dropdown-item align-items-start text-wrap py-2">
                                                            <div class="status-indicator-container me-3">
                                                                <img src="{{URL::asset('assets/demo/layout_2/images/demo/users/face25.jpg')}}" class="w-40px h-40px rounded-pill" alt="">
                                        ...
                                        <ul class="navbar-nav ms-xl-auto">
                                            <li class="nav-item dropdown ms-xl-1">
                                                <a href="#" class="navbar-nav-link dropdown-toggle rounded" data-bs-toggle="dropdown">
                                                    <img src="{{URL::asset('assets/demo/layout_2/images/lang/es.svg')}}" class="h-16px me-2" alt="">
                                                    Languages
                                                </a>

                                                <div class="dropdown-menu dropdown-menu-end">
                                                    <a href="#" class="dropdown-item english">
                                                        <img src="{{URL::asset('assets/demo/layout_2/images/lang/gb.svg')}}" class="h-16px me-2" alt="">
                                                        English
                                                    </a>
                                                    <a href="#" class="dropdown-item ukrainian">
                                                        <img src="{{URL::asset('assets/demo/layout_2/images/lang/ua.svg')}}" class="h-16px me-2" alt="">
                                                        Українська
                                                    </a>
                                                    <a href="#" class="dropdown-item deutsch">
                                                        <img src="{{URL::asset('assets/demo/layout_2/images/lang/de.svg')}}" class="h-16px me-2" alt="">
                                                        Deutsch
                                                    </a>
                                                        ...
                                                        <table class="table table-sm">
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <a href="#">
                                                                            <img src="{{URL::asset('assets/demo/layout_2/images/demo/users/face1.jpg')}}" class="rounded-pill" width="32" height="32" alt="">
                                                                        </a>
                                                                    </td>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <a href="#">
                                                                            <img src="{{URL::asset('assets/demo/layout_2/images/demo/users/face4.jpg')}}" class="rounded-pill" width="32" height="32" alt="">
                                                                        </a>
                                                                        <a href="#">
                                                                            <img src="{{URL::asset('assets/demo/layout_2/images/demo/users/face18.jpg')}}" class="rounded-pill" width="32" height="32" alt="">
                                                                        </a>
                                                                    </td>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <a href="#">
                                                                            <img src="{{URL::asset('assets/demo/layout_2/images/demo/users/face15.jpg')}}" class="rounded-pill" width="32" height="32" alt="">
                                                                        </a>
                                                                    </td>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <a href="#">
                                                                            <img src="{{URL::asset('assets/demo/layout_2/images/demo/users/face6.jpg')}}" class="rounded-pill" width="32" height="32" alt="">
                                                                        </a>
                                                                        <a href="#">
                                                                            <img src="{{URL::asset('assets/demo/layout_2/images/demo/users/face12.jpg')}}" class="rounded-pill" width="32" height="32" alt="">
                                                                        </a>
                                                                        <a href="#">
                                                                            <img src="{{URL::asset('assets/demo/layout_2/images/demo/users/face9.jpg')}}" class="rounded-pill" width="32" height="32" alt="">
                                                                        </a>
                                                                    </td>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <a href="#">
                                                                            <img src="{{URL::asset('assets/demo/layout_2/images/demo/users/face2.jpg')}}" class="rounded-pill" width="32" height="32" alt="">
                                                                        </a>
                                                                    </td>
                                                                    <td class="text-center"><span class="badge bg-success rounded-pill">100%</span></td>
                                                                </tr>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-sm-6 col-lg-4 col-xl-2">
                                                                <div class="card-img-actions mb-3">
                                                                    <a href="{{URL::asset('assets/demo/layout_2/images/demo/flat/1.png')}}" class="text-white">
                                                                        <img class="img-fluid img-thumbnail" src="{{URL::asset('assets/demo/layout_2/images/demo/flat/1.png')}}" alt="">
                                                            ...
                                                            <div class="col-sm-6 col-lg-4 col-xl-2">
                                                                <div class="card-img-actions mb-3">
                                                                    <a href="{{URL::asset('assets/demo/layout_2/images/demo/flat/2.png')}}" class="text-white">
                                                                        <img class="img-fluid img-thumbnail" src="{{URL::asset('assets/demo/layout_2/images/demo/flat/2.png')}}" alt="">
                                                                        <span class="card-img-actions-overlay rounded">
                                                                            <i class="ph-plus"></i>
                                                                        </span>
                                                                    </a>
                                                            ...
                                                            <div class="col-sm-6 col-lg-4 col-xl-2">
                                                                <div class="card-img-actions mb-3">
                                                                    <a href="{{URL::asset('assets/demo/layout_2/images/demo/flat/3.png')}}" class="text-white">
                                                                        <img class="img-fluid img-thumbnail" src="{{URL::asset('assets/demo/layout_2/images/demo/flat/3.png')}}" alt="">
                                                                        <span class="card-img-actions-overlay rounded">
                                                                            <i class="ph-plus"></i>
                                                                        </span>
                                                                    </a>
                                                            ...
                                                            <div class="col-sm-6 col-lg-4 col-xl-2">
                                                                <div class="card-img-actions mb-3">
                                                                    <a href="{{URL::asset('assets/demo/layout_2/images/demo/flat/4.png')}}" class="text-white">
                                                                        <img class="img-fluid img-thumbnail" src="{{URL::asset('assets/demo/layout_2/images/demo/flat/4.png')}}" alt="">
                                                                        <span class="card-img-actions-overlay rounded">
                                                                            <i class="ph-plus"></i>
                                                                        </span>
                                                                    </a>
                                                            ...
                                                            <div class="col-sm-6 col-lg-4 col-xl-2">
                                                                <div class="card-img-actions mb-3">
                                                                    <a href="{{URL::asset('assets/demo/layout_2/images/demo/flat/5.png')}}" class="text-white">
                                                                        <img class="img-fluid img-thumbnail" src="{{URL::asset('assets/demo/layout_2/images/demo/flat/5.png')}}" alt="">
                                                                        <span class="card-img-actions-overlay rounded">
                                                                            <i class="ph-plus"></i>
                                                                        </span>
                                                                    </a>
                                                            ...
                                                            <div class="col-sm-6 col-lg-4 col-xl-2">
                                                                <div class="card-img-actions mb-3">
                                                                    <a href="{{URL::asset('assets/demo/layout_2/images/demo/flat/6.png')}}" class="text-white">
                                                                        <img class="img-fluid img-thumbnail" src="{{URL::asset('assets/demo/layout_2/images/demo/flat/6.png')}}" alt="">
                                                                        <span class="card-img-actions-overlay rounded">
                                                                            <i class="ph-plus"></i>
                                                                        </span>
                                                                    </a>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-xl-4">
                                                                <div class="card card-body">
                                                                    ...
                                                                    <div class="d-flex flex-wrap align-items-center pt-1">
                                                                        <a href="#" class="me-1">
                                                                            <img src="{{URL::asset('assets/demo/layout_2/images/demo/users/face1.jpg')}}" class="rounded-pill" width="34" height="34" alt="">
                                                                        </a>
                                                                        <a href="#" class="me-1">
                                                                            <img src="{{URL::asset('assets/demo/layout_2/images/demo/users/face24.jpg')}}" class="rounded-pill" width="34" height="34" alt="">
                                                                        </a>
                                                                        <a href="#" class="me-1">
                                                                            <img src="{{URL::asset('assets/demo/layout_2/images/demo/users/face11.jpg')}}" class="rounded-pill" width="34" height="34" alt="">
                                                                        </a>
                                                            ...
                                                            <div class="col-xl-4">
                                                                <div class="card card-body">
                                                                    ...
                                                                    <div class="d-flex flex-wrap align-items-center pt-1">
                                                                        <a href="#" class="me-1">
                                                                            <img src="{{URL::asset('assets/demo/layout_2/images/demo/users/face2.jpg')}}" class="rounded-pill" width="34" height="34" alt="">
                                                                        </a>
                                                                        <a href="#" class="me-1">
                                                                            <img src="{{URL::asset('assets/demo/layout_2/images/demo/users/face12.jpg')}}" class="rounded-pill" width="34" height="34" alt="">
                                                                        </a>
                                                                        <a href="#" class="me-1">
                                                                            <img src="{{URL::asset('assets/demo/layout_2/images/demo/users/face3.jpg')}}" class="rounded-pill" width="34" height="34" alt="">
                                                                        </a>
                                                                        <a href="#" class="btn btn-light btn-sm btn-icon rounded-pill">
                                                                            <i class="ph-plus"></i>
                                                                        </a>
                                                            ...
                                                            <div class="col-xl-4">
                                                                <div class="card card-body">
                                                                    ...
                                                                    <div class="d-flex flex-wrap align-items-center pt-1">
                                                                        <a href="#" class="me-1">
                                                                            <img src="{{URL::asset('assets/demo/layout_2/images/demo/users/face5.jpg')}}" class="rounded-pill" width="34" height="34" alt="">
                                                                        </a>
                                                                        <a href="#" class="me-1">
                                                                            <img src="{{URL::asset('assets/demo/layout_2/images/demo/users/face3.jpg')}}" class="rounded-pill" width="34" height="34" alt="">
                                                                        </a>
                                                                        <a href="#" class="me-1">
                                                                            <img src="{{URL::asset('assets/demo/layout_2/images/demo/users/face10.jpg')}}" class="rounded-pill" width="34" height="34" alt="">
                                                                        </a>
                                                                        <a href="#" class="btn btn-light btn-sm btn-icon rounded-pill">
                                                                            <i class="ph-plus"></i>
                                                                        </a>
