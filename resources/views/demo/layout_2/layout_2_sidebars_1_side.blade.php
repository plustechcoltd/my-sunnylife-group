...
<head>
    ...
    <!-- Theme JS files -->
    <script src="{{URL::asset('assets/demo/layout_2/js/vendor/visualization/d3/d3.min.js')}}"></script>
    <script src="{{URL::asset('assets/demo/layout_2/js/vendor/visualization/d3/d3_tooltip.js')}}"></script>

    <script src="{{URL::asset('assets/demo/layout_2/js/app.js')}}"></script>
    <script src="{{URL::asset('assets/demo/layout_2/demo/pages/dashboard.js')}}"></script>
    <script src="{{URL::asset('assets/demo/layout_2/demo/charts/pages/dashboard/streamgraph.js')}}"></script>
    <script src="{{URL::asset('assets/demo/layout_2/demo/charts/pages/dashboard/sparklines.js')}}"></script>
    <script src="{{URL::asset('assets/demo/layout_2/demo/charts/pages/dashboard/lines.js')}}"></script>
    <script src="{{URL::asset('assets/demo/layout_2/demo/charts/pages/dashboard/areas.js')}}"></script>
    <script src="{{URL::asset('assets/demo/layout_2/demo/charts/pages/dashboard/donuts.js')}}"></script>
    <script src="{{URL::asset('assets/demo/layout_2/demo/charts/pages/dashboard/bars.js')}}"></script>
    <script src="{{URL::asset('assets/demo/layout_2/demo/charts/pages/dashboard/progress.js')}}"></script>
    <script src="{{URL::asset('assets/demo/layout_2/demo/charts/pages/dashboard/heatmaps.js')}}"></script>
    <script src="{{URL::asset('assets/demo/layout_2/demo/charts/pages/dashboard/pies.js')}}"></script>
    <script src="{{URL::asset('assets/demo/layout_2/demo/charts/pages/dashboard/bullets.js')}}"></script>
    <!-- /theme JS files -->
...
<body>
    ...
    <div class="page-content">
       ...
       @include('demo.layout_2.layouts.sidebar-detached')
                    ...
                    <div class="collapse show" id="sidebar-users">
                        <div class="sidebar-section-body">
                            <div class="d-flex mb-3">
                                <a href="#" class="me-3">
                                    <img src="{{URL::asset('assets/demo/layout_2/images/demo/users/face1.jpg')}}" width="36" height="36" class="rounded-pill" alt="">
                                </a>
                                <div class="flex-fill">
                            ...
                            <div class="d-flex mb-3">
                                <a href="#" class="me-3">
                                    <img src="{{URL::asset('assets/demo/layout_2/images/demo/users/face2.jpg')}}" width="36" height="36" class="rounded-pill" alt="">
                                </a>
                                <div class="flex-fill">
                            ...
                            <div class="d-flex mb-3">
                                <a href="#" class="me-3">
                                    <img src="{{URL::asset('assets/demo/layout_2/images/demo/users/face3.jpg')}}" width="36" height="36" class="rounded-pill" alt="">
                                </a>
                                <div class="flex-fill">
                            ...
                            <div class="d-flex mb-3">
                                <a href="#" class="me-3">
                                    <img src="{{URL::asset('assets/demo/layout_2/images/demo/users/face4.jpg')}}" width="36" height="36" class="rounded-pill" alt="">
                                </a>
                                <div class="flex-fill">
                            ...
                            <div class="d-flex">
                                <a href="#" class="me-3">
                                    <img src="{{URL::asset('assets/demo/layout_2/images/demo/users/face5.jpg')}}" width="36" height="36" class="rounded-pill" alt="">
                                </a>
                                <div class="flex-fill">
        ...
        <div class="content-wrapper">
           ...
           @include('demo.layout_2.layouts.navbar')
            ...
            <div class="content-inner">
                ...
                @component('demo.layout_2.components.breadcrumb')
                                        ...
                                        <tbody>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <a href="#" class="d-block me-3">
                                                            <img src="{{URL::asset('assets/demo/layout_2/images/brands/facebook.svg')}}" class="rounded-circle" width="36" height="36" alt="">
                                                        </a>
                                                        <div>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <a href="#" class="d-block me-3">
                                                            <img src="{{URL::asset('assets/demo/layout_2/images/brands/youtube.svg')}}" class="rounded-circle" width="36" height="36" alt="">
                                                        </a>
                                                        <div>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <a href="#" class="d-block me-3">
                                                            <img src="{{URL::asset('assets/demo/layout_2/images/brands/spotify.svg')}}" class="rounded-circle" width="36" height="36" alt="">
                                                        </a>
                                                        <div>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <a href="#" class="d-block me-3">
                                                            <img src="{{URL::asset('assets/demo/layout_2/images/brands/twitter.svg')}}" class="rounded-circle" width="36" height="36" alt="">
                                                        </a>
                                                        <div>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <a href="#" class="d-block me-3">
                                                            <img src="{{URL::asset('assets/demo/layout_2/images/brands/bing.svg')}}" class="rounded-circle" width="36" height="36" alt="">
                                                        </a>
                                                        <div>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <a href="#" class="d-block me-3">
                                                            <img src="{{URL::asset('assets/demo/layout_2/images/brands/amazon.svg')}}" class="rounded-circle" width="36" height="36" alt="">
                                                        </a>
                                                        <div>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <a href="#" class="d-block me-3">
                                                            <img src="{{URL::asset('assets/demo/layout_2/images/brands/dribbble.svg')}}" class="rounded-circle" width="36" height="36" alt="">
                                                        </a>
                                                        <div>
                                        ...
                                        <tbody>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <a href="#" class="d-inline-block me-3">
                                                            <img src="{{URL::asset('assets/demo/layout_2/images/demo/users/face15.jpg')}}" class="rounded-circle" width="40" height="40" alt="">
                                                        </a>
                                                        <div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <a href="#" class="d-inline-block me-3">
                                                            <img src="{{URL::asset('assets/demo/layout_2/images/demo/users/face3.jpg')}}" class="rounded-circle" width="40" height="40" alt="">
                                                        </a>
                                                        <div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <a href="#" class="d-inline-block me-3">
                                                            <img src="{{URL::asset('assets/demo/layout_2/images/demo/users/face8.jpg')}}" class="rounded-circle" width="40" height="40" alt="">
                                                        </a>
                                                        <div>
                                ...
                                <div class="card-body pb-0">
                                    <div class="row">
                                        <div class="col-xl-6">
                                            <div class="d-sm-flex align-items-sm-start mb-3">
                                                <a href="#" class="d-inline-block position-relative me-sm-3 mb-3 mb-sm-0">
                                                    <img src="{{URL::asset('assets/demo/layout_2/images/demo/flat/1.png')}}" class="flex-shrink-0 rounded" height="100" alt="">
                                            ...
                                            <div class="d-sm-flex align-items-sm-start mb-3">
                                                <a href="#" class="d-inline-block position-relative me-sm-3 mb-3 mb-sm-0">
                                                    <img src="{{URL::asset('assets/demo/layout_2/images/demo/flat/21.png')}}" class="flex-shrink-0 rounded" height="100" alt="">
                                                    <div class="d-inline-flex bg-dark bg-opacity-50 text-white position-absolute start-50 top-50 translate-middle rounded-pill p-2">
                                                        <i class="ph-play"></i>
                                                    </div>
                                        ...
                                        <div class="col-xl-6">
                                            <div class="d-sm-flex align-items-sm-start mb-3">
                                                <a href="#" class="d-inline-block position-relative me-sm-3 mb-3 mb-sm-0">
                                                    <img src="{{URL::asset('assets/demo/layout_2/images/demo/flat/12.png')}}" class="flex-shrink-0 rounded" height="100" alt="">
                                                    <div class="d-inline-flex bg-dark bg-opacity-50 text-white position-absolute start-50 top-50 translate-middle rounded-pill p-2">
                                                        <i class="ph-play"></i>
                                                    </div>
                                            ...
                                            <div class="d-sm-flex align-items-sm-start mb-3">
                                                <a href="#" class="d-inline-block position-relative me-sm-3 mb-3 mb-sm-0">
                                                    <img src="{{URL::asset('assets/demo/layout_2/images/demo/flat/18.png')}}" class="flex-shrink-0 rounded" height="100" alt="">
                                                    <div class="d-inline-flex bg-dark bg-opacity-50 text-white position-absolute start-50 top-50 translate-middle rounded-pill p-2">
                                                        <i class="ph-play"></i>
                                                    </div>
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <a href="#" class="d-inline-block me-3">
                                                            <img src="{{URL::asset('assets/demo/layout_2/images/demo/logos/1.svg')}}" alt="" height="36">
                                                        </a>
                                                        <div>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <a href="#" class="d-inline-block me-3">
                                                            <img src="{{URL::asset('assets/demo/layout_2/images/demo/logos/2.svg')}}" alt="" height="36">
                                                        </a>
                                                        <div>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <a href="#" class="d-inline-block me-3">
                                                            <img src="{{URL::asset('assets/demo/layout_2/images/demo/logos/3.svg')}}" alt="" height="36">
                                                        </a>
                                                        <div>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <a href="#" class="d-inline-block me-3">
                                                            <img src="{{URL::asset('assets/demo/layout_2/images/demo/logos/4.svg')}}" alt="" height="36">
                                                        </a>
                                                        <div>
                            ...
                            <div class="card">
                                ...
                                <div class="tab-content card-body">
                                    <div class="tab-pane active fade show" id="messages-tue">
                                        <div class="d-flex align-items-start mb-3">
                                            <div class="status-indicator-container me-3">
                                                <img src="{{URL::asset('assets/demo/layout_2/images/demo/users/face10.jpg')}}" class="rounded-circle" width="40" jeight="40" alt="">
                                        ...
                                        <div class="d-flex align-items-start mb-3">
                                            <div class="status-indicator-container me-3">
                                                <img src="{{URL::asset('assets/demo/layout_2/images/demo/users/face3.jpg')}}" class="rounded-circle" width="40" jeight="40" alt="">
                                        ...
                                        <div class="d-flex align-items-start mb-3">
                                            <div class="status-indicator-container me-3">
                                                <img src="{{URL::asset('assets/demo/layout_2/images/demo/users/face24.jpg')}}" class="rounded-circle" width="40" jeight="40" alt="">
                                                <span class="status-indicator bg-danger"></span>
                                            </div>
                                        ...
                                        <div class="d-flex align-items-start mb-3">
                                            <div class="status-indicator-container me-3">
                                                <img src="{{URL::asset('assets/demo/layout_2/images/demo/users/face4.jpg')}}" class="rounded-circle" width="40" jeight="40" alt="">
                                                <span class="status-indicator bg-danger"></span>
                                            </div>
                                        ...
                                        <div class="d-flex align-items-start">
                                            <div class="status-indicator-container me-3">
                                                <img src="{{URL::asset('assets/demo/layout_2/images/demo/users/face25.jpg')}}" class="rounded-circle" width="40" jeight="40" alt="">
                                                <span class="status-indicator bg-success"></span>
                                            </div>
                                    ...
                                    <div class="tab-pane fade" id="messages-mon">
                                        <div class="d-flex align-items-start mb-3">
                                            <div class="status-indicator-container me-3">
                                                <img src="{{URL::asset('assets/demo/layout_2/images/demo/users/face2.jpg')}}" class="rounded-circle" width="40" jeight="40" alt="">
                                                <span class="status-indicator bg-success"></span>
                                            </div>
                                        ...
                                        <div class="d-flex align-items-start mb-3">
                                            <div class="status-indicator-container me-3">
                                                <img src="{{URL::asset('assets/demo/layout_2/images/demo/users/face7.jpg')}}" class="rounded-circle" width="40" jeight="40" alt="">
                                        ...
                                        <div class="d-flex align-items-start mb-3">
                                            <div class="status-indicator-container me-3">
                                                <img src="{{URL::asset('assets/demo/layout_2/images/demo/users/face18.jpg')}}" class="rounded-circle" width="40" jeight="40" alt="">
                                                <span class="status-indicator bg-warning"></span>
                                            </div>
                                        ...
                                        <div class="d-flex align-items-start mb-3">
                                            <div class="status-indicator-container me-3">
                                                <img src="{{URL::asset('assets/demo/layout_2/images/demo/users/face14.jpg')}}" class="rounded-circle" width="40" jeight="40" alt="">
                                                <span class="status-indicator bg-success"></span>
                                            </div>
                                        ...
                                        <div class="d-flex align-items-start">
                                            <div class="status-indicator-container me-3">
                                                <img src="{{URL::asset('assets/demo/layout_2/images/demo/users/face8.jpg')}}" class="rounded-circle" width="40" jeight="40" alt="">
                                                <span class="status-indicator bg-success"></span>
                                            </div>
                                    ...
                                    <div class="tab-pane fade" id="messages-fri">
                                        <div class="d-flex align-items-start mb-3">
                                            <div class="status-indicator-container me-3">
                                                <img src="{{URL::asset('assets/demo/layout_2/images/demo/users/face15.jpg')}}" class="rounded-circle" width="40" jeight="40" alt="">
                                                <span class="status-indicator bg-danger"></span>
                                            </div>
                                        ...
                                        <div class="d-flex align-items-start mb-3">
                                            <div class="status-indicator-container me-3">
                                                <img src="{{URL::asset('assets/demo/layout_2/images/demo/users/face12.jpg')}}" class="rounded-circle" width="40" jeight="40" alt="">
                                                <span class="status-indicator bg-warning"></span>
                                            </div>
                                        ...
                                        <div class="d-flex align-items-start mb-3">
                                            <div class="status-indicator-container me-3">
                                                <img src="{{URL::asset('assets/demo/layout_2/images/demo/users/face22.jpg')}}" class="rounded-circle" width="40" jeight="40" alt="">
                                                <span class="status-indicator bg-danger"></span>
                                            </div>
                                        ...
                                        <div class="d-flex align-items-start">
                                            <div class="status-indicator-container me-3">
                                                <img src="{{URL::asset('assets/demo/layout_2/images/demo/users/face17.jpg')}}" class="rounded-circle" width="40" jeight="40" alt="">
                                                <span class="status-indicator bg-secondary"></span>
                                            </div>
