                ...
                <li class="nav-item nav-item-submenu">
                    ...
                    <ul class="nav-group-sub collapse">
                        <li class="nav-item nav-item-submenu">
                            ...
                            <ul class="nav-group-sub collapse">
                                <li class="nav-item"><a href="navbar_single_top_static" class="dropdown-item rounded">Top static</a></li>
                                <li class="nav-item"><a href="navbar_single_top_fixed" class="dropdown-item rounded">Top fixed</a></li>
                                <li class="nav-item"><a href="navbar_single_bottom_static" class="dropdown-item rounded">Bottom static</a></li>
                                <li class="nav-item"><a href="navbar_single_bottom_fixed" class="dropdown-item rounded">Bottom fixed</a></li>
                            </ul>
                        </li>
                        <li class="nav-item nav-item-submenu">
