...
@endsection
@section('scripts')
<script src="{{URL::asset('assets/demo/layout_1/demo/charts/d3/lines/lines_basic.js')}}"></script>
<script src="{{URL::asset('assets/demo/layout_1/demo/charts/d3/lines/lines_basic_bivariate.js')}}"></script>
<script src="{{URL::asset('assets/demo/layout_1/demo/charts/d3/lines/lines_basic_area.js')}}"></script>
<script src="{{URL::asset('assets/demo/layout_1/demo/charts/d3/lines/lines_basic_multi_series.js')}}"></script>
<script src="{{URL::asset('assets/demo/layout_1/demo/charts/d3/lines/lines_basic_stacked.js')}}"></script>
<script src="{{URL::asset('assets/demo/layout_1/demo/charts/d3/lines/lines_basic_stacked_nest.js')}}"></script>
<script src="{{URL::asset('assets/demo/layout_1/demo/charts/d3/lines/lines_basic_gradient.js')}}"></script>
@endsection
