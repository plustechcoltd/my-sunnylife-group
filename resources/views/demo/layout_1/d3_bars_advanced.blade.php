...
@section('scripts')
<script src="{{URL::asset('assets/demo/layout_1/demo/charts/d3/bars/bars_advanced_simple_interaction.js')}}"></script>
<script src="{{URL::asset('assets/demo/layout_1/demo/charts/d3/bars/bars_advanced_sortable_horizontal.js')}}"></script>
<script src="{{URL::asset('assets/demo/layout_1/demo/charts/d3/bars/bars_advanced_sortable_vertical.js')}}"></script>
<script src="{{URL::asset('assets/demo/layout_1/demo/charts/d3/bars/bars_advanced_stacked_multiple.js')}}"></script>
<script src="{{URL::asset('assets/demo/layout_1/demo/charts/d3/bars/bars_advanced_histogram.js')}}"></script>
<script src="{{URL::asset('assets/demo/layout_1/demo/charts/d3/bars/bars_advanced_hierarchical.js')}}"></script>
@endsection
