        ...
        <div class="col-12 col-lg-4">
            <div class="card card-body">
                ...
                <div class="pt-3 mb-3 border-top">
                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            <div class="mt-3"><a href="#"><img src="{{URL::asset('assets/demo/layout_1/images/demo/flat/1.png')}}" class="img-fluid rounded" alt=""></a></div>
                            <div class="mt-3"><a href="#"><img src="{{URL::asset('assets/demo/layout_1/images/demo/flat/2.png')}}" class="img-fluid rounded" alt=""></a></div>
                        </div>

                        <div class="col-sm-4">
                            <div class="mt-3"><a href="#"><img src="{{URL::asset('assets/demo/layout_1/images/demo/flat/3.png')}}" class="img-fluid rounded" alt=""></a></div>
                            <div class="mt-3"><a href="#"><img src="{{URL::asset('assets/demo/layout_1/images/demo/flat/4.png')}}" class="img-fluid rounded" alt=""></a></div>
                        </div>

                        <div class="col-sm-4">
                            <div class="mt-3"><a href="#"><img src="{{URL::asset('assets/demo/layout_1/images/demo/flat/5.png')}}" class="img-fluid rounded" alt=""></a></div>
                            <div class="mt-3"><a href="#"><img src="{{URL::asset('assets/demo/layout_1/images/demo/flat/6.png')}}" class="img-fluid rounded" alt=""></a></div>
                        </div>
                    </div>
                </div>
