        ...
        <div class="d-sm-flex align-items-lg-start text-center text-lg-start">
            <div class="me-lg-3 mb-3 mb-lg-0">
                <a href="{{URL::asset('assets/demo/layout_1/images/demo/products/1.jpeg')}}" data-bs-popup="lightbox">
                    <img src="{{URL::asset('assets/demo/layout_1/images/demo/products/1.jpeg')}}" width="100" alt="">
                </a>
            </div>
        ...
        <div class="d-sm-flex align-items-lg-start text-center text-lg-start">
            <div class="me-lg-3 mb-3 mb-lg-0">
                <a href="{{URL::asset('assets/demo/layout_1/images/demo/products/2.jpeg')}}" data-bs-popup="lightbox">
                    <img src="{{URL::asset('assets/demo/layout_1/images/demo/products/2.jpeg')}}" width="100" alt="">
                </a>
            </div>
        ...
        <div class="d-sm-flex align-items-lg-start text-center text-lg-start">
            <div class="me-lg-3 mb-3 mb-lg-0">
                <a href="{{URL::asset('assets/demo/layout_1/images/demo/products/3.jpeg')}}" data-bs-popup="lightbox">
                    <img src="{{URL::asset('assets/demo/layout_1/images/demo/products/3.jpeg')}}" width="100" alt="">
                </a>
            </div>
        ...
        <div class="d-sm-flex align-items-lg-start text-center text-lg-start">
            <div class="me-lg-3 mb-3 mb-lg-0">
                <a href="{{URL::asset('assets/demo/layout_1/images/demo/products/4.jpeg')}}" data-bs-popup="lightbox">
                    <img src="{{URL::asset('assets/demo/layout_1/images/demo/products/4.jpeg')}}" width="100" alt="">
                </a>
            </div>
        ...
        <div class="d-sm-flex align-items-lg-start text-center text-lg-start">
            <div class="me-lg-3 mb-3 mb-lg-0">
                <a href="{{URL::asset('assets/demo/layout_1/images/demo/products/5.jpeg')}}" data-bs-popup="lightbox">
                    <img src="{{URL::asset('assets/demo/layout_1/images/demo/products/5.jpeg')}}" width="100" alt="">
                </a>
            </div>
        ...
        <div class="d-sm-flex align-items-lg-start text-center text-lg-start">
            <div class="me-lg-3 mb-3 mb-lg-0">
                <a href="{{URL::asset('assets/demo/layout_1/images/demo/products/6.jpeg')}}" data-bs-popup="lightbox">
                    <img src="{{URL::asset('assets/demo/layout_1/images/demo/products/6.jpeg')}}" width="100" alt="">
                </a>
            </div>
        ...
        <div class="d-sm-flex align-items-lg-start text-center text-lg-start">
            <div class="me-lg-3 mb-3 mb-lg-0">
                <a href="{{URL::asset('assets/demo/layout_1/images/demo/products/7.jpeg')}}" data-bs-popup="lightbox">
                    <img src="{{URL::asset('assets/demo/layout_1/images/demo/products/7.jpeg')}}" width="100" alt="">
                </a>
            </div>
        ...
        <div class="d-sm-flex align-items-lg-start text-center text-lg-start">
            <div class="me-lg-3 mb-3 mb-lg-0">
                <a href="{{URL::asset('assets/demo/layout_1/images/demo/products/8.jpeg')}}" data-bs-popup="lightbox">
                    <img src="{{URL::asset('assets/demo/layout_1/images/demo/products/8.jpeg')}}" width="100" alt="">
                </a>
            </div>
        ...
        <div class="d-sm-flex align-items-lg-start text-center text-lg-start">
            <div class="me-lg-3 mb-3 mb-lg-0">
                <a href="{{URL::asset('assets/demo/layout_1/images/demo/products/9.jpeg')}}" data-bs-popup="lightbox">
                    <img src="{{URL::asset('assets/demo/layout_1/images/demo/products/9.jpeg')}}" width="100" alt="">
                </a>
            </div>
        ...
        <div class="d-sm-flex align-items-lg-start text-center text-lg-start">
            <div class="me-lg-3 mb-3 mb-lg-0">
                <a href="{{URL::asset('assets/demo/layout_1/images/demo/products/10.jpeg')}}" data-bs-popup="lightbox">
                    <img src="{{URL::asset('assets/demo/layout_1/images/demo/products/10.jpeg')}}" width="100" alt="">
                </a>
            </div>
        ...
        <div class="d-sm-flex align-items-lg-start text-center text-lg-start">
            <div class="me-lg-3 mb-3 mb-lg-0">
                <a href="{{URL::asset('assets/demo/layout_1/images/demo/products/11.jpeg')}}" data-bs-popup="lightbox">
                    <img src="{{URL::asset('assets/demo/layout_1/images/demo/products/11.jpeg')}}" width="100" alt="">
                </a>
            </div>
        ...
        <div class="d-sm-flex align-items-lg-start text-center text-lg-start">
            <div class="me-lg-3 mb-3 mb-lg-0">
                <a href="{{URL::asset('assets/demo/layout_1/images/demo/products/12.jpeg')}}" data-bs-popup="lightbox">
                    <img src="{{URL::asset('assets/demo/layout_1/images/demo/products/12.jpeg')}}" width="100" alt="">
                </a>
            </div>
        ...
        <div class="d-sm-flex align-items-lg-start text-center text-lg-start">
            <div class="me-lg-3 mb-3 mb-lg-0">
                <a href="{{URL::asset('assets/demo/layout_1/images/demo/products/13.jpeg')}}" data-bs-popup="lightbox">
                    <img src="{{URL::asset('assets/demo/layout_1/images/demo/products/13.jpeg')}}" width="100" alt="">
                </a>
            </div>
        ...
        <div class="d-sm-flex align-items-lg-start text-center text-lg-start">
            <div class="me-lg-3 mb-3 mb-lg-0">
                <a href="{{URL::asset('assets/demo/layout_1/images/demo/products/14.jpeg')}}" data-bs-popup="lightbox">
                    <img src="{{URL::asset('assets/demo/layout_1/images/demo/products/14.jpeg')}}" width="100" alt="">
                </a>
            </div>
