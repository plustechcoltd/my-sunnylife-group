...
<script src="{{URL::asset('assets/demo/layout_1/js/vendor/forms/inputs/imask.min.js')}}"></script>
<script src="{{URL::asset('assets/demo/layout_1/js/vendor/forms/inputs/autosize.min.js')}}"></script>
<script src="{{URL::asset('assets/demo/layout_1/js/vendor/forms/inputs/passy.js')}}"></script>
<script src="{{URL::asset('assets/demo/layout_1/js/vendor/forms/inputs/maxlength.min.js')}}"></script>
@endsection
@section('scripts')
<script src="{{URL::asset('assets/demo/layout_1/demo/pages/form_controls_extended.js')}}"></script>
@endsection
