...
@endsection
@section('scripts')
<script src="{{URL::asset('assets/demo/layout_1/demo/charts/d3/lines/lines_advanced_difference.js')}}"></script>
<script src="{{URL::asset('assets/demo/layout_1/demo/charts/d3/lines/lines_advanced_missing.js')}}"></script>
<script src="{{URL::asset('assets/demo/layout_1/demo/charts/d3/lines/lines_advanced_small_multiples.js')}}"></script>
<script src="{{URL::asset('assets/demo/layout_1/demo/charts/d3/lines/lines_advanced_transitions.js')}}"></script>
<script src="{{URL::asset('assets/demo/layout_1/demo/charts/d3/lines/lines_advanced_zoom.js')}}"></script>
<script src="{{URL::asset('assets/demo/layout_1/demo/charts/d3/lines/lines_advanced_spline_transition.js')}}"></script>
@endsection
