                ...
                <ul class="nav nav-tabs nav-tabs-highlight">
                    <li class="nav-item">
                        <a href="#" class="nav-link d-flex align-items-center active">
                            <img src="{{URL::asset('assets/demo/layout_1/images/demo/users/face1.jpg')}}" width="22" height="22" class="rounded-pill me-2" alt="">
                            Active
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="#" class="nav-link d-flex align-items-center">
                            Inactive
                            <img src="{{URL::asset('assets/demo/layout_1/images/demo/users/face2.jpg')}}" width="22" height="22" class="rounded-pill ms-2" alt="">
                        </a>
                    </li>
                    <li class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle d-flex align-items-center" data-bs-toggle="dropdown">
                            <img src="{{URL::asset('assets/demo/layout_1/images/demo/users/face3.jpg')}}" width="22" height="22" class="rounded-pill" alt="">
                        </a>
                        <div class="dropdown-menu dropdown-menu-end">
                            <a href="#" class="dropdown-item">Dropdown pill</a>
                            <a href="#" class="dropdown-item">Another pill</a>
