...
<script src="{{URL::asset('assets/demo/layout_1/js/vendor/sliders/ion_rangeslider.min.js')}}"></script>
<script src="{{URL::asset('assets/demo/layout_1/js/vendor/ui/moment/moment_locales.min.js')}}"></script>

@endsection
@section('scripts')
<script src="{{URL::asset('assets/demo/layout_1/demo/pages/extra_sliders_ion.js')}}"></script>
@endsection
