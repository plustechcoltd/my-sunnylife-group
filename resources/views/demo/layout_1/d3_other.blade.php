...
@endsection
@section('scripts')
<script src="{{URL::asset('assets/demo/layout_1/demo/charts/d3/other/treemap.js')}}"></script>
<script src="{{URL::asset('assets/demo/layout_1/demo/charts/d3/other/bubbles.js')}}"></script>
<script src="{{URL::asset('assets/demo/layout_1/demo/charts/d3/other/streamgraph.js')}}"></script>
<script src="{{URL::asset('assets/demo/layout_1/demo/charts/d3/other/waterfall.js')}}"></script>
@endsection
