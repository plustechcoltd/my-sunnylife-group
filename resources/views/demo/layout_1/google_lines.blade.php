...
@endsection
@section('scripts')
<script src="{{URL::asset('assets/demo/layout_1/demo/charts/google/lines/lines.js')}}"></script>
<script src="{{URL::asset('assets/demo/layout_1/demo/charts/google/lines/area.js')}}"></script>
<script src="{{URL::asset('assets/demo/layout_1/demo/charts/google/lines/area_stacked.js')}}"></script>
<script src="{{URL::asset('assets/demo/layout_1/demo/charts/google/lines/line_intervals.js')}}"></script>
<script src="{{URL::asset('assets/demo/layout_1/demo/charts/google/lines/area_intervals.js')}}"></script>
<script src="{{URL::asset('assets/demo/layout_1/demo/charts/google/lines/area_stepped.js')}}"></script>
@endsection
