            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="image-cropper-container mb-3">
                        <img src="{{URL::asset('assets/demo/layout_1/images/demo/images/for_crop.png')}}" alt="" class="cropper" id="demo-cropper-image">
                    </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="image-cropper-container">
                        <img src="{{URL::asset('assets/demo/layout_1/images/demo/images/1.png')}}" alt="" class="crop-basic">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-6">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="image-cropper-container">
                        <img src="{{URL::asset('assets/demo/layout_1/images/demo/images/2.png')}}" alt="" class="crop-modal">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-6">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="image-cropper-container">
                        <img src="{{URL::asset('assets/demo/layout_1/images/demo/images/3.png')}}" alt="" class="crop-not-movable">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-6">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="image-cropper-container">
                        <img src="{{URL::asset('assets/demo/layout_1/images/demo/images/4.png')}}" alt="" class="crop-not-resizable">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-6">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="image-cropper-container">
                        <img src="{{URL::asset('assets/demo/layout_1/images/demo/images/5.png')}}" alt="" class="crop-auto">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-6">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="image-cropper-container">
                        <img src="{{URL::asset('assets/demo/layout_1/images/demo/images/6.png')}}" alt="" class="crop-drag">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-6">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="image-cropper-container">
                        <img src="{{URL::asset('assets/demo/layout_1/images/demo/images/7.png')}}" alt="" class="crop-16-9">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-6">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="image-cropper-container">
                        <img src="{{URL::asset('assets/demo/layout_1/images/demo/images/8.png')}}" alt="" class="crop-4-3">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-6">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="image-cropper-container">
                        <img src="{{URL::asset('assets/demo/layout_1/images/demo/images/9.png')}}" alt="" class="crop-min">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-6">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="image-cropper-container">
                        <img src="{{URL::asset('assets/demo/layout_1/images/demo/images/10.png')}}" alt="" class="crop-zoomable">
                    </div>
                </div>
            </div>
        </div>
...
<script src="{{URL::asset('assets/demo/layout_1/js/vendor/media/cropper.min.js')}}"></script>
@endsection
@section('scripts')
<script src="{{URL::asset('assets/demo/layout_1/demo/pages/extension_image_cropper.js')}}"></script>
@endsection
