...
@endsection
@section('scripts')
<script src="{{URL::asset('assets/demo/layout_1/demo/charts/d3/pies/pie_basic.js')}}"></script>
<script src="{{URL::asset('assets/demo/layout_1/demo/charts/d3/pies/pie_entry_animation.js')}}"></script>
<script src="{{URL::asset('assets/demo/layout_1/demo/charts/d3/pies/pie_multiple.js')}}"></script>
<script src="{{URL::asset('assets/demo/layout_1/demo/charts/d3/pies/pie_multiple_nesting.js')}}"></script>
<script src="{{URL::asset('assets/demo/layout_1/demo/charts/d3/pies/pie_update.js')}}"></script>
<script src="{{URL::asset('assets/demo/layout_1/demo/charts/d3/pies/pie_arc_tween.js')}}"></script>
<script src="{{URL::asset('assets/demo/layout_1/demo/charts/d3/pies/donut_basic.js')}}"></script>
<script src="{{URL::asset('assets/demo/layout_1/demo/charts/d3/pies/donut_entry_animation.js')}}"></script>
<script src="{{URL::asset('assets/demo/layout_1/demo/charts/d3/pies/donut_multiple.js')}}"></script>
<script src="{{URL::asset('assets/demo/layout_1/demo/charts/d3/pies/donut_multiple_nesting.js')}}"></script>
<script src="{{URL::asset('assets/demo/layout_1/demo/charts/d3/pies/donut_update.js')}}"></script>
<script src="{{URL::asset('assets/demo/layout_1/demo/charts/d3/pies/donut_arc_tween.js')}}"></script>
@endsection
