                        ...
                        <li class="nav-item nav-item-dropdown-lg dropdown language-switch">
                            ...
                            <div class="dropdown-menu dropdown-menu-end">
                                ...
                                <a href="?lng=es" class="dropdown-item es">
                                    <img src="{{URL::asset('assets/demo/layout_1/images/lang/es.svg')}}" height="22" alt="">
                                    <span class="ms-2">Spanish</span>
                                </a>
                                <a href="?lng=it" class="dropdown-item it">
                                    <img src="{{URL::asset('assets/demo/layout_1/images/lang/it.svg')}}" height="22" alt="">
...
@endsection
@section('scripts')
<script src="{{URL::asset('assets/demo/layout_1/demo/pages/internationalization_fallback.js')}}"></script>
@endsection
