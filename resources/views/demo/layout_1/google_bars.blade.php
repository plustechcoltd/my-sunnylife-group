...
@endsection
@section('scripts')
<script src="{{URL::asset('assets/demo/layout_1/demo/charts/google/bars/column.js')}}"></script>
<script src="{{URL::asset('assets/demo/layout_1/demo/charts/google/bars/column_stacked.js')}}"></script>
<script src="{{URL::asset('assets/demo/layout_1/demo/charts/google/bars/bar.js')}}"></script>
<script src="{{URL::asset('assets/demo/layout_1/demo/charts/google/bars/bar_stacked.js')}}"></script>
<script src="{{URL::asset('assets/demo/layout_1/demo/charts/google/bars/histogram.js')}}"></script>
<script src="{{URL::asset('assets/demo/layout_1/demo/charts/google/bars/combo.js')}}"></script>
@endsection
