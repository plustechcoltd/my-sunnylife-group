...
<div class="content">
    ...
    <div class="card card-body">
        <div class="d-sm-flex align-items-sm-start">
            <a href="#" class="d-block me-sm-3 mb-3 mb-sm-0">
                <img src="{{URL::asset('assets/demo/layout_1/images/demo/brands/dell.png')}}" class="rounded" width="44" height="44" alt="">
            </a>
    ...
    <div class="card card-body">
        <div class="d-sm-flex align-items-sm-start">
            <a href="#" class="d-block me-sm-3 mb-3 mb-sm-0">
                <img src="{{URL::asset('assets/demo/layout_1/images/demo/brands/northface.png')}}" class="rounded" width="44" height="44" alt="">
            </a>
    ...
    <div class="card card-body">
        <div class="d-sm-flex align-items-sm-start">
            <a href="#" class="d-block me-sm-3 mb-3 mb-sm-0">
                <img src="{{URL::asset('assets/demo/layout_1/images/demo/brands/ibm.png')}}" class="rounded" width="44" height="44" alt="">
            </a>
    ...
    <div class="card card-body">
        <div class="d-sm-flex align-items-sm-start">
            <a href="#" class="d-block me-sm-3 mb-3 mb-sm-0">
                <img src="{{URL::asset('assets/demo/layout_1/images/demo/brands/cnn.png')}}" class="rounded" width="44" height="44" alt="">
            </a>
    ...
    <div class="card card-body">
        <div class="d-sm-flex align-items-sm-start">
            <a href="#" class="d-block me-sm-3 mb-3 mb-sm-0">
                <img src="{{URL::asset('assets/demo/layout_1/images/demo/brands/transferwise.png')}}" class="rounded" width="44" height="44" alt="">
            </a>
    ...
    <div class="card card-body">
        <div class="d-sm-flex align-items-sm-start">
            <a href="#" class="d-block me-sm-3 mb-3 mb-sm-0">
                <img src="{{URL::asset('assets/demo/layout_1/images/demo/brands/uber.png')}}" class="rounded" width="44" height="44" alt="">
            </a>
    ...
    <div class="card card-body">
        <div class="d-sm-flex align-items-sm-start">
            <a href="#" class="d-block me-sm-3 mb-3 mb-sm-0">
                <img src="{{URL::asset('assets/demo/layout_1/images/demo/brands/ing.png')}}" class="rounded" width="44" height="44" alt="">
            </a>
    ...
    <div class="card card-body">
        <div class="d-sm-flex align-items-sm-start">
            <a href="#" class="d-block me-sm-3 mb-3 mb-sm-0">
                <img src="{{URL::asset('assets/demo/layout_1/images/demo/brands/amazon.png')}}" class="rounded" width="44" height="44" alt="">
            </a>
    ...
    <div class="card card-body">
        <div class="d-sm-flex align-items-sm-start">
            <a href="#" class="d-block me-sm-3 mb-3 mb-sm-0">
                <img src="{{URL::asset('assets/demo/layout_1/images/demo/brands/facebook.png')}}" class="rounded" width="44" height="44" alt="">
            </a>
    ...
    <div class="card card-body">
        <div class="d-sm-flex align-items-sm-start">
            <a href="#" class="d-block me-sm-3 mb-3 mb-sm-0">
                <img src="{{URL::asset('assets/demo/layout_1/images/demo/brands/microsoft.png')}}" class="rounded" width="44" height="44" alt="">
            </a>
