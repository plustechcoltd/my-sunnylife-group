...
<script src="{{URL::asset('assets/demo/layout_1/js/vendor/tables/datatables/datatables.min.js')}}"></script>@endsection
@section('scripts')
<script src="{{URL::asset('assets/demo/layout_1/demo/pages/invoice_archive.js')}}"></script>
@endsection
