...
@endsection
@section('scripts')
<script src="{{URL::asset('assets/demo/layout_1/demo/charts/google/bubbles/bubble.js')}}"></script>
<script src="{{URL::asset('assets/demo/layout_1/demo/charts/google/bubbles/bubble_gradient.js')}}"></script>
<script src="{{URL::asset('assets/demo/layout_1/demo/charts/google/scatter/scatter.js')}}"></script>
<script src="{{URL::asset('assets/demo/layout_1/demo/charts/google/scatter/scatter_diff.js')}}"></script>
@endsection
