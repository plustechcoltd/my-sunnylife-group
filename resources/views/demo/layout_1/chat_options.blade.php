            ...
            <ul class="nav nav-tabs nav-tabs-underline flex-nowrap text-nowrap mb-0">
                ...
                <li class="nav-item">
                    <a href="#jared" class="nav-link" data-bs-toggle="tab">
                        <div class="status-indicator-container me-2">
                            <img src="{{URL::asset('assets/demo/layout_1/images/demo/users/face10.jpg')}}" class="w-32px h-32px rounded-pill" alt="">
                            <span class="status-indicator bg-success"></span>
                        </div>
                ...
                <li class="nav-item">
                    <a href="#mark" class="nav-link" data-bs-toggle="tab">
                        <div class="status-indicator-container me-2">
                            <img src="{{URL::asset('assets/demo/layout_1/images/demo/users/face25.jpg')}}" class="w-32px h-32px rounded-pill" alt="">
