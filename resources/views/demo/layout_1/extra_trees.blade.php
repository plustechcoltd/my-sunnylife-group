...
<script src="{{URL::asset('assets/demo/layout_1/js/vendor/trees/fancytree_childcounter.js')}}"></script>
<script src="{{URL::asset('assets/demo/layout_1/js/vendor/trees/fancytree.dnd5.js')}}"></script>
@endsection
@section('scripts')
<script src="{{URL::asset('assets/demo/layout_1/demo/pages/extra_trees.js')}}"></script>
@endsection
