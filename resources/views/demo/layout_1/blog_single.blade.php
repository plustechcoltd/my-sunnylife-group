                    ...
                    <div class="mb-4">
                        <div class="mb-3 text-center">
                            <a href="#" class="d-inline-block">
                                <img src="{{URL::asset('assets/demo/layout_1/images/demo/cover3.jpg')}}" class="img-fluid rounded" alt="">
                            </a>
                        </div>
                        ...
                        <div class="bg-light border-start border-start-width-3 border-start-primary rounded-end p-3">
                            <blockquote class="blockquote d-flex mb-0">
                                <div class="me-3">
                                    <img class="rounded-circle" src="{{URL::asset('assets/demo/layout_1/images/demo/users/face1.jpg')}}" width="46" height="46" alt="">
                                </div>
                        ...
                        <div class="row g-0">
                            <div class="col">
                                <div class="card-img-actions">
                                    <a href="{{URL::asset('assets/demo/layout_1/images/demo/flat/8.png')}}" class="text-white" data-bs-popup="lightbox">
                                        <img class="img-fluid rounded-top-start" src="{{URL::asset('assets/demo/layout_1/images/demo/flat/8.png')}}" alt="">
                                ...
                                <div class="card-img-actions">
                                    <a href="{{URL::asset('assets/demo/layout_1/images/demo/flat/4.png')}}" class="text-white" data-bs-popup="lightbox">
                                        <img class="img-fluid" src="{{URL::asset('assets/demo/layout_1/images/demo/flat/4.png')}}" alt="">
                                ...
                                <div class="card-img-actions">
                                    <a href="{{URL::asset('assets/demo/layout_1/images/demo/flat/5.png')}}" class="text-white" data-bs-popup="lightbox">
                                        <img class="img-fluid rounded-bottom-start" src="{{URL::asset('assets/demo/layout_1/images/demo/flat/5.png')}}" alt="">
                            ...
                            <div class="col">
                                <div class="card-img-actions">
                                    <a href="{{URL::asset('assets/demo/layout_1/images/demo/flat/6.png')}}" class="text-white" data-bs-popup="lightbox">
                                        <img class="img-fluid rounded-top-end" src="{{URL::asset('assets/demo/layout_1/images/demo/flat/6.png')}}" alt="">
                                ...
                                <div class="card-img-actions">
                                    <a href="{{URL::asset('assets/demo/layout_1/images/demo/flat/7.png')}}" class="text-white" data-bs-popup="lightbox">
                                        <img class="img-fluid" src="{{URL::asset('assets/demo/layout_1/images/demo/flat/7.png')}}" alt="">
                                        <span class="card-img-actions-overlay">
                                            <i class="ph-plus"></i>
                                        </span>
                                    </a>
                                ...
                                <div class="card-img-actions">
                                    <a href="{{URL::asset('assets/demo/layout_1/images/demo/flat/8.png')}}" class="text-white" data-bs-popup="lightbox">
                                        <img class="img-fluid rounded-bottom-end" src="{{URL::asset('assets/demo/layout_1/images/demo/flat/8.png')}}" alt="">
...
@endsection
@section('scripts')
<script src="{{URL::asset('assets/demo/layout_1/demo/pages/blog_single.js')}}"></script>
@endsection
