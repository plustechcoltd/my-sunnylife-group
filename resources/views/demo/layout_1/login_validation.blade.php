...
<head>
    ...
    <script src="{{URL::asset('assets/demo/layout_1/demo/pages/form_validation_styles.js')}}"></script>

</head>

<body>

    @include('demo.layout_1.layouts.auth-navbar')
                            ...
                            <div class="card-body">
                                <div class="text-center mb-3">
                                    <div class="d-inline-flex align-items-center justify-content-center mb-4 mt-2">
                                        <img src="{{URL::asset('assets/demo/layout_1/images/logo_icon.svg')}}" class="h-48px" alt="">
                                    </div>
