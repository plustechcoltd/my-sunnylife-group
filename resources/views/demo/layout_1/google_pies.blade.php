...
@endsection
@section('scripts')
<script src="{{URL::asset('assets/demo/layout_1/demo/charts/google/pies/pie.js')}}"></script>
<script src="{{URL::asset('assets/demo/layout_1/demo/charts/google/pies/pie_exploded.js')}}"></script>
<script src="{{URL::asset('assets/demo/layout_1/demo/charts/google/pies/pie_rotate.js')}}"></script>
<script src="{{URL::asset('assets/demo/layout_1/demo/charts/google/pies/donut.js')}}"></script>
<script src="{{URL::asset('assets/demo/layout_1/demo/charts/google/pies/donut_rotate.js')}}"></script>
<script src="{{URL::asset('assets/demo/layout_1/demo/charts/google/pies/donut_exploded.js')}}"></script>
<script src="{{URL::asset('assets/demo/layout_1/demo/charts/google/pies/pie_3d.js')}}"></script>
<script src="{{URL::asset('assets/demo/layout_1/demo/charts/google/pies/3d_exploded.js')}}"></script>
<script src="{{URL::asset('assets/demo/layout_1/demo/charts/google/pies/pie_diff_radius.js')}}"></script>
<script src="{{URL::asset('assets/demo/layout_1/demo/charts/google/pies/pie_diff_border.js')}}"></script>
<script src="{{URL::asset('assets/demo/layout_1/demo/charts/google/pies/pie_diff_opacity.js')}}"></script>
<script src="{{URL::asset('assets/demo/layout_1/demo/charts/google/pies/pie_diff_invert.js')}}"></script>
@endsection
