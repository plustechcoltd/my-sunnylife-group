...
<div class="content">
    ...
    <div class="row">
        <div class="col-lg-6 col-xl-3">
            ...
            <div class="card">
                <div class="card-body bg-primary text-white text-center card-img-top" style="background-image: url(assets/demo/layout_1/images/backgrounds/panel_bg.png); background-size: contain;">
                    <div class="card-img-actions d-inline-block mb-3">
                        <img class="img-fluid rounded-circle" src="{{URL::asset('assets/demo/layout_1/images/demo/users/face6.jpg')}}" width="170" height="170" alt="">
                    ...
                    <div class="tab-pane fade show active" id="today">
                        <div class="d-flex align-items-start mb-3">
                            <div class="status-indicator-container me-3">
                                <img src="{{URL::asset('assets/demo/layout_1/images/demo/users/face1.jpg')}}" class="rounded-circle" width="40" jeight="40" alt="">
            ...
            <div class="card">
                <div class="card-img-actions mx-1 mt-1">
                    <a href="#course_preview" class="d-inline-block position-relative" data-bs-toggle="modal">
                        <img src="{{URL::asset('assets/demo/layout_1/images/demo/flat/1.png')}}" class="img-fluid card-img" alt="">
            ...
            <div class="card">
                <div class="card-img-actions mx-1 mt-1">
                    <img class="card-img img-fluid" src="{{URL::asset('assets/demo/layout_1/images/demo/flat/17.png')}}" alt="">
            ...
            <div class="card">
                <div class="card-img-actions mx-1 mt-1">
                    <a href="#course_preview" class="d-inline-block position-relative" data-bs-toggle="modal">
                        <img src="{{URL::asset('assets/demo/layout_1/images/demo/flat/10.png')}}" class="img-fluid card-img" alt="">
                        <div class="d-inline-flex bg-dark bg-opacity-50 text-white position-absolute start-50 top-50 translate-middle rounded-pill p-2">
                            <i class="ph-play"></i>
                        </div>
        ...
        <div class="col-lg-6 col-xl-3">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="d-flex flex-wrap align-items-center">
                        <a href="#" class="me-1">
                            <img src="{{URL::asset('assets/demo/layout_1/images/demo/users/face1.jpg')}}" class="rounded-pill" width="36" height="36" alt="">
                        </a>
                        <a href="#" class="me-1">
                            <img src="{{URL::asset('assets/demo/layout_1/images/demo/users/face24.jpg')}}" class="rounded-pill" width="36" height="36" alt="">
                        </a>
                        <a href="#" class="me-1">
                            <img src="{{URL::asset('assets/demo/layout_1/images/demo/users/face11.jpg')}}" class="rounded-pill" width="36" height="36" alt="">
                        </a>
            ...
            <div class="card">
                <div class="card-img-actions">
                    <img class="card-img-top img-fluid" src="{{URL::asset('assets/demo/layout_1/images/demo/users/face3.jpg')}}" alt="">
            ...
            <div class="card">
                <a href="#" class="d-block mx-1 mt-1">
                    <img src="{{URL::asset('assets/demo/layout_1/images/demo/flat/19.png')}}" class="img-fluid card-img" alt="">
                </a>
        ...
        <div class="col-lg-6 col-xl-3">
            ...
            <div class="card">
                <a href="#" class="d-block mx-1 mt-1">
                    <img src="{{URL::asset('assets/demo/layout_1/images/demo/flat/18.png')}}" class="img-fluid card-img" alt="">
                </a>
            ...
            <!-- Testimonials -->
            <div class="card bg-pink text-white text-center p-3" style="background-image: url(assets/demo/layout_1/images/backgrounds/panel_bg.png); background-size: contain;">
                <div>
            ...
            <div class="card card-body">
                <div class="d-sm-flex align-items-sm-start">
                    <a href="#" class="d-inline-block position-relative me-sm-3 mb-3 mb-sm-0">
                        <img src="{{URL::asset('assets/demo/layout_1/images/demo/flat/1.png')}}" class="flex-shrink-0 rounded" height="80" alt="">
                        <div class="d-inline-flex bg-dark bg-opacity-50 text-white position-absolute start-50 top-50 translate-middle rounded-pill p-2">
                            <i class="ph-play"></i>
                        </div>
                    </a>
            ...
            <div class="card">
                <div class="card-body text-center">
                    <div class="card-img-actions d-inline-block mb-3">
                        <img class="img-fluid rounded-circle" src="{{URL::asset('assets/demo/layout_1/images/demo/users/face2.jpg')}}" width="170" height="170" alt="">
                        <div class="card-img-actions-overlay card-img rounded-circle">
                            <a href="#" class="btn btn-outline-white btn-icon rounded-pill">
                                <i class="ph-plus"></i>
                            </a>
        ...
        <div class="col-lg-6 col-xl-3">
            ...
            <!-- Colored info widget -->
            <div class="card card-body bg-pink text-white" style="background-image: url(assets/demo/layout_1/images/backgrounds/panel_bg.png);">
                <div class="d-flex">
            ...
            <div class="card card-body">
                <div class="text-center mb-3">
                    <a href="#" class="d-inline-block mt-1 mb-3">
                        <img src="{{URL::asset('assets/demo/layout_1/images/demo/users/face11.jpg')}}" class="rounded-circle img-fluid" width="120" height="120" alt="">
                    </a>
...
<script src="{{URL::asset('assets/demo/layout_1/js/vendor/uploaders/dropzone.min.js')}}"></script>
<script src="{{URL::asset('assets/demo/layout_1/js/vendor/pickers/datepicker.min.js')}}"></script>
@endsection
@section('scripts')
<script src="{{URL::asset('assets/demo/layout_1/demo/charts/pages/widgets_content.js')}}"></script>
@endsection
