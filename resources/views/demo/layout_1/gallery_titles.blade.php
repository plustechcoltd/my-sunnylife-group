...
<div class="content">
    ...
    <div class="row">
        <div class="col-sm-6 col-xl-3">
            <div class="card">
                <div class="card-img-actions mx-1 mt-1">
                    <img class="card-img img-fluid" src="{{URL::asset('assets/demo/layout_1/images/demo/flat/1.png')}}" alt="">
                    <div class="card-img-actions-overlay card-img">
                        <a href="{{URL::asset('assets/demo/layout_1/images/demo/flat/1.png')}}" class="btn btn-outline-white btn-icon rounded-pill" data-bs-popup="lightbox" data-gallery="gallery1">
                            <i class="ph-plus"></i>
                        </a>
        ...
        <div class="col-sm-6 col-xl-3">
            <div class="card">
                <div class="card-img-actions mx-1 mt-1">
                    <img class="card-img img-fluid" src="{{URL::asset('assets/demo/layout_1/images/demo/flat/3.png')}}" alt="">
                    <div class="card-img-actions-overlay card-img">
                        <a href="{{URL::asset('assets/demo/layout_1/images/demo/flat/3.png')}}" class="btn btn-outline-white btn-icon rounded-pill" data-bs-popup="lightbox" data-gallery="gallery1">
                            <i class="ph-plus"></i>
                        </a>
                        <a href="#" class="btn btn-outline-white btn-icon rounded-pill ms-2">
                            <i class="ph-link"></i>
        ...
        <div class="col-sm-6 col-xl-3">
            <div class="card">
                <div class="card-img-actions mx-1 mt-1">
                    <img class="card-img img-fluid" src="{{URL::asset('assets/demo/layout_1/images/demo/flat/2.png')}}" alt="">
                    <div class="card-img-actions-overlay card-img">
                        <a href="{{URL::asset('assets/demo/layout_1/images/demo/flat/2.png')}}" class="btn btn-outline-white btn-icon rounded-pill" data-bs-popup="lightbox" data-gallery="gallery1">
                            <i class="ph-plus"></i>
                        </a>
                        <a href="#" class="btn btn-outline-white btn-icon rounded-pill ms-2">
                            <i class="ph-link"></i>
        ...
        <div class="col-sm-6 col-xl-3">
            <div class="card">
                <div class="card-img-actions mx-1 mt-1">
                    <img class="card-img img-fluid" src="{{URL::asset('assets/demo/layout_1/images/demo/flat/4.png')}}" alt="">
                    <div class="card-img-actions-overlay card-img">
                        <a href="{{URL::asset('assets/demo/layout_1/images/demo/flat/4.png')}}" class="btn btn-outline-white btn-icon rounded-pill" data-bs-popup="lightbox" data-gallery="gallery1">
                            <i class="ph-plus"></i>
                        </a>
                        <a href="#" class="btn btn-outline-white btn-icon rounded-pill ms-2">
                            <i class="ph-link"></i>
    ...
    <div class="row">
        <div class="col-sm-6 col-xl-3">
            <div class="card">
                <div class="card-img-actions mx-1 mt-1">
                    <img class="card-img img-fluid" src="{{URL::asset('assets/demo/layout_1/images/demo/flat/5.png')}}" alt="">
                    <div class="card-img-actions-overlay card-img">
                        <a href="{{URL::asset('assets/demo/layout_1/images/demo/flat/5.png')}}" class="btn btn-outline-white btn-icon rounded-pill" data-bs-popup="lightbox" data-gallery="gallery1">
                            <i class="ph-plus"></i>
                        </a>
                        <a href="#" class="btn btn-outline-white btn-icon rounded-pill ms-2">
                            <i class="ph-link"></i>
        ...
        <div class="col-sm-6 col-xl-3">
            <div class="card">
                <div class="card-img-actions mx-1 mt-1">
                    <img class="card-img img-fluid" src="{{URL::asset('assets/demo/layout_1/images/demo/flat/6.png')}}" alt="">
                    <div class="card-img-actions-overlay card-img">
                        <a href="{{URL::asset('assets/demo/layout_1/images/demo/flat/6.png')}}" class="btn btn-outline-white btn-icon rounded-pill" data-bs-popup="lightbox" data-gallery="gallery1">
                            <i class="ph-plus"></i>
                        </a>
                        <a href="#" class="btn btn-outline-white btn-icon rounded-pill ms-2">
                            <i class="ph-link"></i>
        ...
        <div class="col-sm-6 col-xl-3">
            <div class="card">
                <div class="card-img-actions mx-1 mt-1">
                    <img class="card-img img-fluid" src="{{URL::asset('assets/demo/layout_1/images/demo/flat/7.png')}}" alt="">
                    <div class="card-img-actions-overlay card-img">
                        <a href="{{URL::asset('assets/demo/layout_1/images/demo/flat/7.png')}}" class="btn btn-outline-white btn-icon rounded-pill" data-bs-popup="lightbox" data-gallery="gallery1">
                            <i class="ph-plus"></i>
                        </a>
                        <a href="#" class="btn btn-outline-white btn-icon rounded-pill ms-2">
                            <i class="ph-link"></i>
        ...
        <div class="col-sm-6 col-xl-3">
            <div class="card">
                <div class="card-img-actions mx-1 mt-1">
                    <img class="card-img img-fluid" src="{{URL::asset('assets/demo/layout_1/images/demo/flat/8.png')}}" alt="">
                    <div class="card-img-actions-overlay card-img">
                        <a href="{{URL::asset('assets/demo/layout_1/images/demo/flat/8.png')}}" class="btn btn-outline-white btn-icon rounded-pill" data-bs-popup="lightbox" data-gallery="gallery1">
                            <i class="ph-plus"></i>
                        </a>
                        <a href="#" class="btn btn-outline-white btn-icon rounded-pill ms-2">
                            <i class="ph-link"></i>
    ...
    <div class="row">
        <div class="col-sm-6 col-xl-3">
            <div class="card">
                <div class="card-img-actions mx-1 mt-1">
                    <img class="card-img img-fluid" src="{{URL::asset('assets/demo/layout_1/images/demo/flat/9.png')}}" alt="">
                    <div class="card-img-actions-overlay card-img">
                        <a href="{{URL::asset('assets/demo/layout_1/images/demo/flat/9.png')}}" class="btn btn-outline-white btn-icon rounded-pill" data-bs-popup="lightbox" data-gallery="gallery1">
                            <i class="ph-plus"></i>
                        </a>
                        <a href="#" class="btn btn-outline-white btn-icon rounded-pill ms-2">
                            <i class="ph-link"></i>
        ...
        <div class="col-sm-6 col-xl-3">
            <div class="card">
                <div class="card-img-actions mx-1 mt-1">
                    <img class="card-img img-fluid" src="{{URL::asset('assets/demo/layout_1/images/demo/flat/10.png')}}" alt="">
                    <div class="card-img-actions-overlay card-img">
                        <a href="{{URL::asset('assets/demo/layout_1/images/demo/flat/10.png')}}" class="btn btn-outline-white btn-icon rounded-pill" data-bs-popup="lightbox" data-gallery="gallery1">
                            <i class="ph-plus"></i>
                        </a>
                        <a href="#" class="btn btn-outline-white btn-icon rounded-pill ms-2">
                            <i class="ph-link"></i>
        ...
        <div class="col-sm-6 col-xl-3">
            <div class="card">
                <div class="card-img-actions mx-1 mt-1">
                    <img class="card-img img-fluid" src="{{URL::asset('assets/demo/layout_1/images/demo/flat/11.png')}}" alt="">
                    <div class="card-img-actions-overlay card-img">
                        <a href="{{URL::asset('assets/demo/layout_1/images/demo/flat/11.png')}}" class="btn btn-outline-white btn-icon rounded-pill" data-bs-popup="lightbox" data-gallery="gallery1">
                            <i class="ph-plus"></i>
                        </a>
                        <a href="#" class="btn btn-outline-white btn-icon rounded-pill ms-2">
                            <i class="ph-link"></i>
        ...
        <div class="col-sm-6 col-xl-3">
            <div class="card">
                <div class="card-img-actions mx-1 mt-1">
                    <img class="card-img img-fluid" src="{{URL::asset('assets/demo/layout_1/images/demo/flat/12.png')}}" alt="">
                    <div class="card-img-actions-overlay card-img">
                        <a href="{{URL::asset('assets/demo/layout_1/images/demo/flat/12.png')}}" class="btn btn-outline-white btn-icon rounded-pill" data-bs-popup="lightbox" data-gallery="gallery1">
                            <i class="ph-plus"></i>
                        </a>
                        <a href="#" class="btn btn-outline-white btn-icon rounded-pill ms-2">
                            <i class="ph-link"></i>
    ...
    <div class="row">
        <div class="col-sm-6 col-xl-3">
            <div class="card">
                <div class="card-img-actions mx-1 mt-1">
                    <img class="card-img img-fluid" src="{{URL::asset('assets/demo/layout_1/images/demo/flat/13.png')}}" alt="">
                    <div class="card-img-actions-overlay card-img">
                        <a href="{{URL::asset('assets/demo/layout_1/images/demo/flat/13.png')}}" class="btn btn-outline-white btn-icon rounded-pill" data-bs-popup="lightbox" data-gallery="gallery1">
                            <i class="ph-plus"></i>
                        </a>
                        <a href="#" class="btn btn-outline-white btn-icon rounded-pill ms-2">
                            <i class="ph-link"></i>
        ...
        <div class="col-sm-6 col-xl-3">
            <div class="card">
                <div class="card-img-actions mx-1 mt-1">
                    <img class="card-img img-fluid" src="{{URL::asset('assets/demo/layout_1/images/demo/flat/14.png')}}" alt="">
                    <div class="card-img-actions-overlay card-img">
                        <a href="{{URL::asset('assets/demo/layout_1/images/demo/flat/14.png')}}" class="btn btn-outline-white btn-icon rounded-pill" data-bs-popup="lightbox" data-gallery="gallery1">
                            <i class="ph-plus"></i>
                        </a>
                        <a href="#" class="btn btn-outline-white btn-icon rounded-pill ms-2">
                            <i class="ph-link"></i>
        ...
        <div class="col-sm-6 col-xl-3">
            <div class="card">
                <div class="card-img-actions mx-1 mt-1">
                    <img class="card-img img-fluid" src="{{URL::asset('assets/demo/layout_1/images/demo/flat/15.png')}}" alt="">
                    <div class="card-img-actions-overlay card-img">
                        <a href="{{URL::asset('assets/demo/layout_1/images/demo/flat/15.png')}}" class="btn btn-outline-white btn-icon rounded-pill" data-bs-popup="lightbox" data-gallery="gallery1">
                            <i class="ph-plus"></i>
                        </a>
                        <a href="#" class="btn btn-outline-white btn-icon rounded-pill ms-2">
                            <i class="ph-link"></i>
        ...
        <div class="col-sm-6 col-xl-3">
            <div class="card">
                <div class="card-img-actions mx-1 mt-1">
                    <img class="card-img img-fluid" src="{{URL::asset('assets/demo/layout_1/images/demo/flat/16.png')}}" alt="">
                    <div class="card-img-actions-overlay card-img">
                        <a href="{{URL::asset('assets/demo/layout_1/images/demo/flat/16.png')}}" class="btn btn-outline-white btn-icon rounded-pill" data-bs-popup="lightbox" data-gallery="gallery1">
                            <i class="ph-plus"></i>
                        </a>
                        <a href="#" class="btn btn-outline-white btn-icon rounded-pill ms-2">
                            <i class="ph-link"></i>
