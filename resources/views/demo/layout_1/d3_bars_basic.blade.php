...
@section('scripts')
<script src="{{URL::asset('assets/demo/layout_1/demo/charts/d3/bars/bars_basic_vertical.js')}}"></script>
<script src="{{URL::asset('assets/demo/layout_1/demo/charts/d3/bars/bars_basic_horizontal.js')}}"></script>
<script src="{{URL::asset('assets/demo/layout_1/demo/charts/d3/bars/bars_basic_tooltip.js')}}"></script>
<script src="{{URL::asset('assets/demo/layout_1/demo/charts/d3/bars/bars_basic_grouped.js')}}"></script>
<script src="{{URL::asset('assets/demo/layout_1/demo/charts/d3/bars/bars_basic_stacked.js')}}"></script>
<script src="{{URL::asset('assets/demo/layout_1/demo/charts/d3/bars/bars_basic_stacked_normalized.js')}}"></script>
@endsection
