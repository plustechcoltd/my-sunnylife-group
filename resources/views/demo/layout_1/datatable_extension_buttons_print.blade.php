...
@slot('subtitle') Print Buttons @endslot
@endcomponent
...
<div class="content">
    ...
    <div class="card">
        <div class="card-header">
            <h5 class="mb-0">Disable auto print</h5>
        </div>
...
@endsection
@section('scripts')
<script src="{{URL::asset('assets/demo/layout_1/demo/pages/datatables_extension_buttons_print.js')}}"></script>
@endsection
