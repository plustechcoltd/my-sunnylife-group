            ...
            <tbody>
                ...
                <tr>
                    <td>
                        <div class="d-flex align-items-center">
                            <a href="user_pages_profile_tabbed" class="d-block me-3">
                                <img src="{{URL::asset('assets/demo/layout_1/images/demo/users/face13.jpg')}}" width="40" height="40" class="rounded-circle" alt="">
                            </a>
                ...
                <tr>
                    <td>
                        <div class="d-flex align-items-center">
                            <a href="user_pages_profile_tabbed" class="d-block me-3">
                                <img src="{{URL::asset('assets/demo/layout_1/images/demo/users/face16.jpg')}}" width="40" height="40" class="rounded-circle" alt="">
                            </a>
                ...
                <tr>
                    <td>
                        <div class="d-flex align-items-center">
                            <a href="user_pages_profile_tabbed" class="d-block me-3">
                                <img src="{{URL::asset('assets/demo/layout_1/images/demo/users/face17.jpg')}}" width="40" height="40" class="rounded-circle" alt="">
                            </a>
                ...
                <tr>
                    <td>
                        <div class="d-flex align-items-center">
                            <a href="user_pages_profile_tabbed" class="d-block me-3">
                                <img src="{{URL::asset('assets/demo/layout_1/images/demo/users/face18.jpg')}}" width="40" height="40" class="rounded-circle" alt="">
                            </a>
                ...
                <tr>
                    <td>
                        <div class="d-flex align-items-center">
                            <a href="user_pages_profile_tabbed" class="d-block me-3">
                                <img src="{{URL::asset('assets/demo/layout_1/images/demo/users/face19.jpg')}}" width="40" height="40" class="rounded-circle" alt="">
                            </a>
                ...
                <tr>
                    <td>
                        <div class="d-flex align-items-center">
                            <a href="user_pages_profile_tabbed" class="d-block me-3">
                                <img src="{{URL::asset('assets/demo/layout_1/images/demo/users/face21.jpg')}}" width="40" height="40" class="rounded-circle" alt="">
                            </a>
                ...
                <tr>
                    <td>
                        <div class="d-flex align-items-center">
                            <a href="user_pages_profile_tabbed" class="d-block me-3">
                                <img src="{{URL::asset('assets/demo/layout_1/images/demo/users/face22.jpg')}}" width="40" height="40" class="rounded-circle" alt="">
                            </a>
                ...
                <tr>
                    <td>
                        <div class="d-flex align-items-center">
                            <a href="user_pages_profile_tabbed" class="d-block me-3">
                                <img src="{{URL::asset('assets/demo/layout_1/images/demo/users/face23.jpg')}}" width="40" height="40" class="rounded-circle" alt="">
                            </a>
...
<script src="{{URL::asset('assets/demo/layout_1/js/vendor/visualization/echarts/echarts.min.js')}}"></script>
...
<script src="{{URL::asset('assets/demo/layout_1/js/vendor/tables/datatables/extensions/pdfmake/pdfmake.min.js')}}"></script>
<script src="{{URL::asset('assets/demo/layout_1/js/vendor/tables/datatables/extensions/pdfmake/vfs_fonts.min.js')}}"></script>
<script src="{{URL::asset('assets/demo/layout_1/js/vendor/tables/datatables/extensions/buttons.min.js')}}"></script>
<script src="{{URL::asset('assets/demo/layout_1/js/vendor/tables/datatables/extensions/responsive.min.js')}}"></script>
@endsection
@section('scripts')
<script src="{{URL::asset('assets/demo/layout_1/demo/pages/ecommerce_customers.js')}}"></script>
<script src="{{URL::asset('assets/demo/layout_1/demo/charts/pages/ecommerce/customers.js')}}"></script>
@endsection
