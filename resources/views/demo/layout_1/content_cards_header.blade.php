                ...
                <div class="card-header d-flex align-items-center py-0">
                    ...
                    <div class="ms-auto my-auto">
                        <div class="status-indicator-container">
                            <img src="{{URL::asset('assets/demo/layout_1/images/demo/users/face3.jpg')}}" width="32" height="32" class="rounded-pill" alt="">
...
@endsection
@section('scripts')
<script src="{{URL::asset('assets/demo/layout_1/demo/pages/content_cards_header.js')}}"></script>
@endsection
