...
<script src="{{URL::asset('assets/demo/layout_1/js/vendor/ui/fullcalendar/locales-all.min.js')}}"></script>
@endsection
@section('scripts')
<script src="{{URL::asset('assets/demo/layout_1/demo/pages/fullcalendar_formats.js')}}"></script>
@endsection
