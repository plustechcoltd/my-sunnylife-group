...
@slot('subtitle') Session Timeout @endslot
@endcomponent
...
<script src="{{URL::asset('assets/demo/layout_1/js/vendor/extensions/session_timeout.min.js')}}"></script>
<script src="{{URL::asset('assets/demo/layout_1/js/vendor/ui/prism.min.js')}}"></script>

@endsection
@section('scripts')
<script src="{{URL::asset('assets/demo/layout_1/demo/pages/extra_session_timeout.js')}}"></script>
@endsection
