...
<div class="content">
    ...
    <div class="row">
        <div class="col-lg-4">
            <div class="card">
                <img class="card-img-top img-fluid" src="{{URL::asset('assets/demo/layout_1/images/demo/flat/1.png')}}" alt="">
        ...
        <div class="col-lg-4">
            <div class="card">
                <img class="card-img-top img-fluid" src="{{URL::asset('assets/demo/layout_1/images/demo/flat/2.png')}}" alt="">
        ...
        <div class="col-lg-4">
            <div class="card">
                <img class="card-img-top img-fluid" src="{{URL::asset('assets/demo/layout_1/images/demo/flat/3.png')}}" alt="">
    ...
    <div class="card-group mb-sm-3">
        <div class="card">
            <img class="card-img-top img-fluid" src="{{URL::asset('assets/demo/layout_1/images/demo/flat/4.png')}}" alt="">
        ...
        <div class="card">
            <img class="card-img-top img-fluid" src="{{URL::asset('assets/demo/layout_1/images/demo/flat/5.png')}}" alt="">
        ...
        <div class="card">
            <img class="card-img-top img-fluid" src="{{URL::asset('assets/demo/layout_1/images/demo/flat/6.png')}}" alt="">
    ...
    <div class="card-group mb-sm-3">
        <div class="card border-end-0 shadow-none">
            <img class="card-img-top img-fluid" src="{{URL::asset('assets/demo/layout_1/images/demo/flat/7.png')}}" alt="">
        ...
        <div class="card border-end-0 shadow-none">
            <img class="card-img-top img-fluid" src="{{URL::asset('assets/demo/layout_1/images/demo/flat/8.png')}}" alt="">
        ...
        <div class="card shadow-none">
            <img class="card-img-top img-fluid" src="{{URL::asset('assets/demo/layout_1/images/demo/flat/9.png')}}" alt="">
    ...
    <div class="row row-cols-sm-3 mb-sm-3">
        <div class="col-sm">
            <div class="card h-sm-100 mb-sm-0">
                <img class="card-img-top img-fluid" src="{{URL::asset('assets/demo/layout_1/images/demo/flat/10.png')}}" alt="">
        ...
        <div class="col-sm">
            <div class="card h-sm-100 mb-sm-0">
                <img class="card-img-top img-fluid" src="{{URL::asset('assets/demo/layout_1/images/demo/flat/11.png')}}" alt="">
        ...
        <div class="col-sm">
            <div class="card h-sm-100 mb-sm-0">
                <img class="card-img-top img-fluid" src="{{URL::asset('assets/demo/layout_1/images/demo/flat/12.png')}}" alt="">
    ...
    <div class="row">
        <div class="col-lg-4">
            <div class="card card-body bg-primary text-white text-center" style="background-image: url(assets/demo/layout_1/images/backgrounds/panel_bg.png); background-size: contain;">
                <div class="mb-3">
                ...
                <a href="#" class="d-inline-block mb-3">
                    <img src="{{URL::asset('assets/demo/layout_1/images/demo/users/face6.jpg')}}" class="rounded-pill" width="110" height="110" alt="">
                </a>
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex flex-wrap align-items-center">
                        <a href="#" class="status-indicator-container me-1">
                            <img src="{{URL::asset('assets/demo/layout_1/images/demo/users/face1.jpg')}}" width="34" height="34" class="rounded-pill" alt="">
                            <span class="status-indicator bg-success"></span>
                        </a>
                        <a href="#" class="status-indicator-container me-1">
                            <img src="{{URL::asset('assets/demo/layout_1/images/demo/users/face24.jpg')}}" width="34" height="34" class="rounded-pill" alt="">
                            <span class="status-indicator bg-danger"></span>
                        </a>
                        <a href="#" class="status-indicator-container me-1">
                            <img src="{{URL::asset('assets/demo/layout_1/images/demo/users/face11.jpg')}}" width="34" height="34" class="rounded-pill" alt="">
            ...
            <div class="card">
                ...
                <img src="{{URL::asset('assets/demo/layout_1/images/demo/blog/3.jpg')}}" alt="Card image cap">
        ...
        <div class="col-lg-4">
            <div class="card">
                <img class="card-img" src="{{URL::asset('assets/demo/layout_1/images/demo/blog/2.jpg')}}" alt="Card image cap">
            </div>
        ...
        <div class="col-lg-4">
            ...
            <div class="card">
                <img class="card-img-top" src="{{URL::asset('assets/demo/layout_1/images/demo/blog/12.jpg')}}" alt="Card image cap">
