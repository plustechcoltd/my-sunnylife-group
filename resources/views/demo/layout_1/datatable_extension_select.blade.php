...
<div class="content">
    ...
    <div class="card">
        <div class="card-header">
            <h5 class="mb-0">Single item selection</h5>
        </div>
    ...
    <div class="card">
        <div class="card-header">
            <h5 class="mb-0">Multiple items selection</h5>
        </div>
    ...
    <div class="card">
        <div class="card-header">
            <h5 class="mb-0">Checkbox selection</h5>
        </div>
...
<script src="{{URL::asset('assets/demo/layout_1/js/vendor/tables/datatables/extensions/select.min.js')}}"></script>
<script src="{{URL::asset('assets/demo/layout_1/js/vendor/tables/datatables/extensions/buttons.min.js')}}"></script>
@endsection
@section('scripts')
<script src="{{URL::asset('assets/demo/layout_1/demo/pages/datatables_extension_select.js')}}"></script>
@endsection
