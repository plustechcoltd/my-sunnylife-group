...
@slot('subtitle') Callbacks @endslot
@endcomponent
...
<div class="content">
    ...
    <div class="card">
        <div class="card-header">
            <h5 class="mb-0">Translation callbacks</h5>
        </div>
...
@endsection
@section('scripts')
<script src="{{URL::asset('assets/demo/layout_1/demo/pages/internationalization_callbacks.js')}}"></script>
@endsection
