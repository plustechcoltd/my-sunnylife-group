...
@slot('subtitle') Rows Reorder @endslot
@endcomponent
...
<div class="content">
    ...
    <div class="card">
        <div class="card-header">
            <h5 class="mb-0">Full row selection</h5>
        </div>
    ...
    <div class="card">
        <div class="card-header">
            <h5 class="mb-0">Responsive integration</h5>
        </div>
    ...
    <div class="card">
        <div class="card-header">
            <h5 class="mb-0">Reorder events</h5>
        </div>
        ...
        <div class="card-body">
            ...
            <pre class="pre-scrollable border rounded p-3 mb-0" id="event-result">// Event result</pre>
        </div>
...
<script src="{{URL::asset('assets/demo/layout_1/js/vendor/tables/datatables/row_reorder.min.js')}}"></script>
<script src="{{URL::asset('assets/demo/layout_1/js/vendor/tables/datatables/extensions/responsive.min.js')}}"></script>
@endsection
@section('scripts')
<script src="{{URL::asset('assets/demo/layout_1/demo/pages/datatables_extension_row_reorder.js')}}"></script>
@endsection
