...
<script src="{{URL::asset('assets/demo/layout_1/js/vendor/editors/ace/ace.js')}}"></script>
@endsection
@section('scripts')
<script src="{{URL::asset('assets/demo/layout_1/demo/pages/ecommerce_customers.js')}}"></script>
<script src="{{URL::asset('assets/demo/layout_1/demo/charts/pages/editor_code.js')}}"></script>
@endsection
