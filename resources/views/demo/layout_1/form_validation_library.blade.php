...
<script src="{{URL::asset('assets/demo/layout_1/js/vendor/forms/validation/validate.min.js')}}"></script>
<script src="{{URL::asset('assets/demo/layout_1/js/vendor/forms/selects/select2.min.js')}}"></script>

@endsection
@section('scripts')
<script src="{{URL::asset('assets/demo/layout_1/demo/pages/form_validation_library.js')}}"></script>
@endsection
