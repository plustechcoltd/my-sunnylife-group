                        ...
                        <ul class="fab-menu-inner">
                            <li>
                                <a href="#" class="btn btn-light btn-icon rounded-pill p-0 border-0">
                                    <img src="{{URL::asset('assets/demo/layout_1/images/demo/users/face1.jpg')}}" class="w-48px h-48px rounded-pill" alt="">
                                </a>
                            </li>
                            <li>
                                <a href="#" class="btn btn-light btn-icon rounded-pill p-0 border-0">
                                    <img src="{{URL::asset('assets/demo/layout_1/images/demo/users/face2.jpg')}}" class="w-48px h-48px rounded-pill" alt="">
                                </a>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="fab-menu fab-menu-top" data-fab-toggle="click">
                        ...
                        <ul class="fab-menu-inner">
                            <li>
                                <a href="#" class="btn btn-light btn-icon rounded-pill p-0 border-0">
                                    <div class="status-indicator-container">
                                        <img src="{{URL::asset('assets/demo/layout_1/images/demo/users/face11.jpg')}}" class="w-48px h-48px rounded-pill" alt="">
                            ...
                            <li>
                                <a href="#" class="btn btn-light btn-icon rounded-pill p-0 border-0">
                                    <div class="status-indicator-container">
                                        <img src="{{URL::asset('assets/demo/layout_1/images/demo/users/face12.jpg')}}" class="w-48px h-48px rounded-pill" alt="">
...
<script src="{{URL::asset('assets/demo/layout_1/js/vendor/ui/fab.min.js')}}"></script>
<script src="{{URL::asset('assets/demo/layout_1/js/vendor/ui/prism.min.js')}}"></script>
@endsection
@section('scripts')
<script src="{{URL::asset('assets/demo/layout_1/demo/pages/extra_fab.js')}}"></script>
@endsection
