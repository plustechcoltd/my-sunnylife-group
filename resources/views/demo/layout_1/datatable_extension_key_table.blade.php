...
@slot('subtitle') Key Table @endslot
@endcomponent
...
<div class="content">
    ...
    <div class="card">
        <div class="card-header">
            <h5 class="mb-0">Scrolling table</h5>
        </div>
    ...
    <div class="card">
        <div class="card-header">
            <h5 class="mb-0">Focus cell custom styling</h5>
        </div>
    ...
    <div class="card">
        <div class="card-header">
            <h5 class="mb-0">Key table events</h5>
        </div>
        ...
        <div class="card-body border-top">
            <pre class="pre-scrollable border rounded p-3 mb-0" id="key-events"></pre>
        </div>
    </div>
    <!-- /key table events -->
...
<script src="{{URL::asset('assets/demo/layout_1/js/vendor/tables/datatables/extensions/key_table.min.js')}}"></script>
@endsection
@section('scripts')
<script src="{{URL::asset('assets/demo/layout_1/demo/pages/datatables_extension_key_table.js')}}"></script>
@endsection
