...
<script src="{{URL::asset('assets/demo/layout_1/js/vendor/uploaders/bs_custom_file_input.min.js')}}"></script>
@endsection
@section('scripts')
<script src="{{URL::asset('assets/demo/layout_1/demo/pages/extension_dnd.js')}}"></script>
@endsection
