...
<script src="{{URL::asset('assets/demo/layout_1/js/vendor/forms/wizards/steps.min.js')}}"></script>
<script src="{{URL::asset('assets/demo/layout_1/js/vendor/forms/validation/validate.min.js')}}"></script>
@endsection
@section('scripts')
<script src="{{URL::asset('assets/demo/layout_1/demo/pages/form_wizard.js')}}"></script>
@endsection
