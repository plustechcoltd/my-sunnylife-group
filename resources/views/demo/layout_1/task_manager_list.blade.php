        ...
        <table class="table tasks-list">
            ...
            <tbody>
                <tr>
                    ...
                    <td>
                        <a href="#"><img src="{{URL::asset('assets/demo/layout_1/images/demo/users/face12.jpg')}}" class="rounded-circle" width="32" height="32" alt=""></a>
                        <a href="#"><img src="{{URL::asset('assets/demo/layout_1/images/demo/users/face25.jpg')}}" class="rounded-circle" width="32" height="32" alt=""></a>
                    </td>
                ...
                <tr>
                    ...
                    <td>
                        <a href="#"><img src="{{URL::asset('assets/demo/layout_1/images/demo/users/face1.jpg')}}" class="rounded-circle" width="32" height="32" alt=""></a>
                        <a href="#"><img src="{{URL::asset('assets/demo/layout_1/images/demo/users/face2.jpg')}}" class="rounded-circle" width="32" height="32" alt=""></a>
                        <a href="#"><img src="{{URL::asset('assets/demo/layout_1/images/demo/users/face3.jpg')}}" class="rounded-circle" width="32" height="32" alt=""></a>
                    </td>
                    <td class="text-center">
                        <div class="dropdown">
                            <a href="#" class="text-body" data-bs-toggle="dropdown">
                ...
                <tr>
                    ...
                    <td>
                        <a href="#"><img src="{{URL::asset('assets/demo/layout_1/images/demo/users/face13.jpg')}}" class="rounded-circle" width="32" height="32" alt=""></a>
                        <a href="#"><img src="{{URL::asset('assets/demo/layout_1/images/demo/users/face2.jpg')}}" class="rounded-circle" width="32" height="32" alt=""></a>
                    </td>
                    <td class="text-center">
                        <div class="dropdown">
                ...
                <tr>
                    ...
                    <td>
                        <a href="#"><img src="{{URL::asset('assets/demo/layout_1/images/demo/users/face5.jpg')}}" class="rounded-circle" width="32" height="32" alt=""></a>
                        <a href="#"><img src="{{URL::asset('assets/demo/layout_1/images/demo/users/face2.jpg')}}" class="rounded-circle" width="32" height="32" alt=""></a>
                        <a href="#"><img src="{{URL::asset('assets/demo/layout_1/images/demo/users/face6.jpg')}}" class="rounded-circle" width="32" height="32" alt=""></a>
                    </td>
                    <td class="text-center">
                        <div class="dropdown">
                            <a href="#" class="text-body" data-bs-toggle="dropdown">
                ...
                <tr>
                    ...
                    <td>
                        <a href="#"><img src="{{URL::asset('assets/demo/layout_1/images/demo/users/face18.jpg')}}" class="rounded-circle" width="32" height="32" alt=""></a>
                        <a href="#"><img src="{{URL::asset('assets/demo/layout_1/images/demo/users/face20.jpg')}}" class="rounded-circle" width="32" height="32" alt=""></a>
                    </td>
                    <td class="text-center">
                        <div class="dropdown">
                            <a href="#" class="text-body" data-bs-toggle="dropdown">
                ...
                <tr>
                    ...
                    <td>
                        <a href="#"><img src="{{URL::asset('assets/demo/layout_1/images/demo/users/face12.jpg')}}" class="rounded-circle" width="32" height="32" alt=""></a>
                        <a href="#"><img src="{{URL::asset('assets/demo/layout_1/images/demo/users/face13.jpg')}}" class="rounded-circle" width="32" height="32" alt=""></a>
                        <a href="#"><img src="{{URL::asset('assets/demo/layout_1/images/demo/users/face23.jpg')}}" class="rounded-circle" width="32" height="32" alt=""></a>
                    </td>
                    <td class="text-center">
                        <div class="dropdown">
                            <a href="#" class="text-body" data-bs-toggle="dropdown">
                ...
                <tr>
                    ...
                    <td>
                        <a href="#"><img src="{{URL::asset('assets/demo/layout_1/images/demo/users/face24.jpg')}}" class="rounded-circle" width="32" height="32" alt=""></a>
                        <a href="#"><img src="{{URL::asset('assets/demo/layout_1/images/demo/users/face1.jpg')}}" class="rounded-circle" width="32" height="32" alt=""></a>
                    </td>
                    <td class="text-center">
                        <div class="dropdown">
                ...
                <tr>
                    ...
                    <td>
                        <a href="#"><img src="{{URL::asset('assets/demo/layout_1/images/demo/users/face19.jpg')}}" class="rounded-circle" width="32" height="32" alt=""></a>
                    </td>
                    <td class="text-center">
                        <div class="dropdown">
                            <a href="#" class="text-body" data-bs-toggle="dropdown">
                ...
                <tr>
                    ...
                    <td>
                        <a href="#"><img src="{{URL::asset('assets/demo/layout_1/images/demo/users/face18.jpg')}}" class="rounded-circle" width="32" height="32" alt=""></a>
                        <a href="#"><img src="{{URL::asset('assets/demo/layout_1/images/demo/users/face17.jpg')}}" class="rounded-circle" width="32" height="32" alt=""></a>
                        <a href="#"><img src="{{URL::asset('assets/demo/layout_1/images/demo/users/face11.jpg')}}" class="rounded-circle" width="32" height="32" alt=""></a>
                    </td>
                    <td class="text-center">
                        <div class="dropdown">
                            <a href="#" class="text-body" data-bs-toggle="dropdown">
                ...
                <tr>
                    ...
                    <td>
                        <a href="#"><img src="{{URL::asset('assets/demo/layout_1/images/demo/users/face21.jpg')}}" class="rounded-circle" width="32" height="32" alt=""></a>
                        <a href="#"><img src="{{URL::asset('assets/demo/layout_1/images/demo/users/face22.jpg')}}" class="rounded-circle" width="32" height="32" alt=""></a>
                        <a href="#"><img src="{{URL::asset('assets/demo/layout_1/images/demo/users/face18.jpg')}}" class="rounded-circle" width="32" height="32" alt=""></a>
                    </td>
                    <td class="text-center">
                        <div class="dropdown">
                ...
                <tr>
                    ...
                    <td>
                        <a href="#"><img src="{{URL::asset('assets/demo/layout_1/images/demo/users/face7.jpg')}}" class="rounded-circle" width="32" height="32" alt=""></a>
                    </td>
                    <td class="text-center">
                        <div class="dropdown">
                            <a href="#" class="text-body" data-bs-toggle="dropdown">
                ...
                <tr>
                    ...
                    <td>
                        <a href="#"><img src="{{URL::asset('assets/demo/layout_1/images/demo/users/face10.jpg')}}" class="rounded-circle" width="32" height="32" alt=""></a>
                        <a href="#"><img src="{{URL::asset('assets/demo/layout_1/images/demo/users/face20.jpg')}}" class="rounded-circle" width="32" height="32" alt=""></a>
                        <a href="#"><img src="{{URL::asset('assets/demo/layout_1/images/demo/users/face3.jpg')}}" class="rounded-circle" width="32" height="32" alt=""></a>
                    </td>
                    <td class="text-center">
...
<script src="{{URL::asset('assets/demo/layout_1/js/vendor/tables/datatables/extensions/natural_sort.js')}}"></script>
@endsection
@section('scripts')
<script src="{{URL::asset('assets/demo/layout_1/demo/pages/task_manager_list.js')}}"></script>
@endsection
