...
<script src="{{URL::asset('assets/demo/layout_1/js/vendor/uploaders/fileinput/plugins/sortable.min.js')}}"></script>
<script src="{{URL::asset('assets/demo/layout_1/js/vendor/uploaders/fileinput/fileinput.min.js')}}"></script>
@endsection
@section('scripts')
<script src="{{URL::asset('assets/demo/layout_1/demo/pages/table_elements.js')}}"></script>
@endsection
