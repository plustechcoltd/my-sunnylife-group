...
<script src="{{URL::asset('assets/demo/layout_1/js/vendor/visualization/d3/venn.js')}}"></script>
@endsection
@section('scripts')
<script src="{{URL::asset('assets/demo/layout_1/demo/charts/d3/venn/venn_basic.js')}}"></script>
<script src="{{URL::asset('assets/demo/layout_1/demo/charts/d3/venn/venn_colors.js')}}"></script>
<script src="{{URL::asset('assets/demo/layout_1/demo/charts/d3/venn/venn_rings.js')}}"></script>
<script src="{{URL::asset('assets/demo/layout_1/demo/charts/d3/venn/venn_weighted.js')}}"></script>
<script src="{{URL::asset('assets/demo/layout_1/demo/charts/d3/venn/venn_interactive.js')}}"></script>
<script src="{{URL::asset('assets/demo/layout_1/demo/charts/d3/venn/venn_tooltip.js')}}"></script>
<script src="{{URL::asset('assets/demo/layout_1/demo/charts/d3/chords/chord_basic.js')}}"></script>
<script src="{{URL::asset('assets/demo/layout_1/demo/charts/d3/chords/chord_chart.js')}}"></script>
<script src="{{URL::asset('assets/demo/layout_1/demo/charts/d3/chords/chord_tweens.js')}}"></script>
<script src="{{URL::asset('assets/demo/layout_1/demo/charts/d3/chords/chord_arcs.js')}}"></script>
<script src="{{URL::asset('assets/demo/layout_1/demo/charts/d3/sunburst/sunburst_basic.js')}}"></script>
<script src="{{URL::asset('assets/demo/layout_1/demo/charts/d3/sunburst/sunburst_distortion.js')}}"></script>
<script src="{{URL::asset('assets/demo/layout_1/demo/charts/d3/sunburst/sunburst_zoom.js')}}"></script>
<script src="{{URL::asset('assets/demo/layout_1/demo/charts/d3/sunburst/sunburst_combined.js')}}"></script>
@endsection
