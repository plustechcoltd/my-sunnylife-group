...
<script src="{{URL::asset('assets/demo/layout_1/js/vendor/maps/echarts/world.js')}}"></script>
@endsection
@section('scripts')
<script src="{{URL::asset('assets/demo/layout_1/demo/maps/echarts/map_world.js')}}"></script>
<script src="{{URL::asset('assets/demo/layout_1/demo/maps/echarts/map_world_scatter.js')}}"></script>
<script src="{{URL::asset('assets/demo/layout_1/demo/maps/echarts/map_europe.js')}}"></script>
<script src="{{URL::asset('assets/demo/layout_1/demo/maps/echarts/map_europe_scale.js')}}"></script>
<script src="{{URL::asset('assets/demo/layout_1/demo/maps/echarts/map_europe_move.js')}}"></script>
<script src="{{URL::asset('assets/demo/layout_1/demo/maps/echarts/map_europe_scale_move.js')}}"></script>
<script src="{{URL::asset('assets/demo/layout_1/demo/maps/echarts/map_europe_zoom_level.js')}}"></script>
<script src="{{URL::asset('assets/demo/layout_1/demo/maps/echarts/map_europe_effect.js')}}"></script>
@endsection
