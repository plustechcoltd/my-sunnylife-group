...
<script src="{{URL::asset('assets/demo/layout_1/js/vendor/notifications/sweet_alert.min.js')}}"></script>
...
@endsection
@section('scripts')
<script src="{{URL::asset('assets/demo/layout_1/demo/pages/extra_sweetalert.js')}}"></script>
@endsection
