...
<head>
    ...
    <script src="{{URL::asset('assets/demo/layout_1/demo/pages/mail_list_read.js')}}"></script>
    <!-- /theme JS files -->
                                ...
                                <table width="100%" border="0" cellpadding="0" cellspacing="0" align="center">
                                    <tr>
                                        <td>
                                            ...
                                            <table width="100%" border="0" cellpadding="0" cellspacing="0" align="center">
                                                <tr>
                                                    <td align="center" bgcolor="#f67b7c" style="background-image: url('../../../assets/demo/layout_1/images/backgrounds/panel_bg.png'); background-repeat: repeat;">
                                                                                ...
                                                                                <table width="280" border="0" cellpadding="0" cellspacing="0" align="left">
                                                                                    <tr>
                                                                                        <td height="60" valign="middle" width="100%" align="left">
                                                                                            <a href="#"><img width="125" src="../../../assets/demo/layout_1/images/logo_light.png" alt=""></a>
                                                                                        </td>
                                                                                    </tr>
                                                                                </table>
                                                                                <!-- /logo -->
                                                                            ...
                                                                            <td width="100%" align="center">
                                                                                <table width="600" border="0" cellpadding="0" cellspacing="0" align="left">
                                                                                    <tr>
                                                                                        <td width="100%">
                                                                                            <a href="#">
                                                                                                <img src="{{URL::asset('assets/demo/layout_1/images/demo/cover2.jpg')}}" alt="" border="0" width="600" height="auto" style="border-radius: 4px;">
                                                                                            </a>
                                                                                        </td>
                                                                                    </tr>
                                                                                    <tr>
                                            ...
                                            <table width="100%" border="0" cellpadding="0" cellspacing="0" align="center">
                                                <tr>
                                                    <td align="center" width="100%" valign="top" bgcolor="#4f97e2" style="background-image: url('../../../assets/demo/layout_1/images/backgrounds/panel_bg.png'); background-color: #4f97e2; background-repeat: repeat;">
                                                        <table width="640" border="0" cellpadding="0" cellspacing="0" align="center">
                                                            <tr>
                                                                <td width="100%" height="50"></td>
                                                            </tr>
                                                                            ...
                                                                            <td width="100%">
                                                                                ...
                                                                                <table width="275" border="0" cellpadding="0" cellspacing="0" align="left" style="border-radius: 4px;">
                                                                                    <tr>
                                                                                        <td width="100%" align="center">
                                                                                            <a href="#">
                                                                                                <img src="{{URL::asset('assets/demo/layout_1/images/demo/users/face1.jpg')}}" alt="" border="0" width="83" height="auto" style="border-radius: 100px;">
                                                                                            </a>
                                                                                        </td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                ...
                                                                                <table width="275" border="0" cellpadding="0" cellspacing="0" align="right" style="border-radius: 4px;">
                                                                                    <tr>
                                                                                        <td width="100%" align="center">
                                                                                            <a href="#">
                                                                                                <img src="{{URL::asset('assets/demo/layout_1/images/demo/users/face2.jpg')}}" alt="" border="0" width="83" height="auto" style="border-radius: 100px;">
                                                                                            </a>
                                                                                        </td>
                                                                                    </tr>
                                                                                    <tr>
