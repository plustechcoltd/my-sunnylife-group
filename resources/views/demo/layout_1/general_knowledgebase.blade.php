...
<div class="content">
    ...
    <div class="row">
        <div class="col-sm-6 col-lg-3">
            <div class="card">
                <div class="card-img-actions">
                    <img class="card-img-top img-fluid" src="../../../assets/demo/layout_1/images/demo/flat/4.png" alt="">
        ...
        <div class="col-sm-6 col-lg-3">
            <div class="card">
                <div class="card-img-actions">
                    <img class="card-img-top img-fluid" src="../../../assets/demo/layout_1/images/demo/flat/3.png" alt="">
                    <div class="card-img-actions-overlay card-img-top">
                        <a href="#" class="btn btn-outline-white btn-icon border-width-2">
                            <i class="ph-download-simple"></i>
                        </a>
        ...
        <div class="col-sm-6 col-lg-3">
            <div class="card">
                <div class="card-img-actions">
                    <img class="card-img-top img-fluid" src="../../../assets/demo/layout_1/images/demo/flat/2.png" alt="">
                    <div class="card-img-actions-overlay card-img-top">
                        <a href="#" class="btn btn-outline-white btn-icon border-width-2">
                            <i class="ph-download-simple"></i>
                        </a>
        ...
        <div class="col-sm-6 col-lg-3">
            <div class="card">
                <div class="card-img-actions">
                    <img class="card-img-top img-fluid" src="../../../assets/demo/layout_1/images/demo/flat/5.png" alt="">
                    <div class="card-img-actions-overlay card-img-top">
                        <a href="#" class="btn btn-outline-white btn-icon border-width-2">
                            <i class="ph-download-simple"></i>
                        </a>
