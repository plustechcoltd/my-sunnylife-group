                ...
                <div class="card-body">
                    ...
                    <div class="d-sm-flex align-items-sm-center flex-sm-wrap">
                        ...
                        <div class="d-inline-flex align-items-center mt-2 mt-sm-0 ms-sm-auto">
                            <a href="#" class="me-1">
                                <img src="{{URL::asset('assets/demo/layout_1/images/demo/users/face1.jpg')}}" class="rounded-circle" width="32" height="32" alt="">
                            </a>
                            <a href="#" class="me-1">
                                <img src="{{URL::asset('assets/demo/layout_1/images/demo/users/face2.jpg')}}" class="rounded-circle" width="32" height="32" alt="">
                            </a>
                            <a href="#" class="me-1">
                                <img src="{{URL::asset('assets/demo/layout_1/images/demo/users/face3.jpg')}}" class="rounded-circle" width="32" height="32" alt="">
                            </a>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="d-sm-flex align-items-sm-center flex-sm-wrap">
                        ...
                        <div class="d-inline-flex align-items-center mt-2 mt-sm-0 ms-sm-auto">
                            <a href="#" class="me-1">
                                <img src="{{URL::asset('assets/demo/layout_1/images/demo/users/face13.jpg')}}" class="rounded-circle" width="32" height="32" alt="">
                            </a>
                            <a href="#" class="me-1">
                                <img src="{{URL::asset('assets/demo/layout_1/images/demo/users/face2.jpg')}}" class="rounded-circle" width="32" height="32" alt="">
                            </a>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="d-sm-flex align-items-sm-center flex-sm-wrap">
                        ...
                        <div class="d-inline-flex align-items-center mt-2 mt-sm-0 ms-sm-auto">
                            <a href="#" class="me-1">
                                <img src="{{URL::asset('assets/demo/layout_1/images/demo/users/face5.jpg')}}" class="rounded-circle" width="32" height="32" alt="">
                            </a>
                            <a href="#" class="me-1">
                            ...
                            <a href="#" class="me-1">
                                <img src="{{URL::asset('assets/demo/layout_1/images/demo/users/face6.jpg')}}" class="rounded-circle" width="32" height="32" alt="">
                            </a>
                            <a href="#" class="text-body">&nbsp;<i class="ph-plus"></i></a>
                        </div>
                    </div>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="d-sm-flex align-items-sm-center flex-sm-wrap">
                        ...
                        <div class="d-inline-flex align-items-center mt-2 mt-sm-0 ms-sm-auto">
                            <a href="#" class="me-1">
                                <img src="{{URL::asset('assets/demo/layout_1/images/demo/users/face18.jpg')}}" class="rounded-circle" width="32" height="32" alt="">
                            </a>
                            <a href="#" class="me-1">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="d-sm-flex align-items-sm-center flex-sm-wrap">
                        ...
                        <div class="d-inline-flex align-items-center mt-2 mt-sm-0 ms-sm-auto">
                            <a href="#" class="me-1">
                                <img src="{{URL::asset('assets/demo/layout_1/images/demo/users/face25.jpg')}}" class="rounded-circle" width="32" height="32" alt="">
                            </a>
                            <a href="#" class="text-body">&nbsp;<i class="ph-plus"></i></a>
                        </div>
                    </div>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="d-sm-flex align-items-sm-center flex-sm-wrap">
                        ...
                        <div class="d-inline-flex align-items-center mt-2 mt-sm-0 ms-sm-auto">
                            <a href="#" class="me-1">
                                <img src="{{URL::asset('assets/demo/layout_1/images/demo/users/face12.jpg')}}" class="rounded-circle" width="32" height="32" alt="">
                            </a>
                            <a href="#" class="me-1">
                                <img src="{{URL::asset('assets/demo/layout_1/images/demo/users/face13.jpg')}}" class="rounded-circle" width="32" height="32" alt="">
                            </a>
                            <a href="#" class="me-1">
                                <img src="{{URL::asset('assets/demo/layout_1/images/demo/users/face23.jpg')}}" class="rounded-circle" width="32" height="32" alt="">
                            </a>
                            <a href="#" class="text-body">&nbsp;<i class="ph-plus"></i></a>
                        </div>
                    </div>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="d-sm-flex align-items-sm-center flex-sm-wrap">
                        ...
                        <div class="d-inline-flex align-items-center mt-2 mt-sm-0 ms-sm-auto">
                            <a href="#" class="me-1">
                                <img src="{{URL::asset('assets/demo/layout_1/images/demo/users/face24.jpg')}}" class="rounded-circle" width="32" height="32" alt="">
                            </a>
                            <a href="#" class="me-1">
                                <img src="{{URL::asset('assets/demo/layout_1/images/demo/users/face1.jpg')}}" class="rounded-circle" width="32" height="32" alt="">
                            </a>
                ...
                <div class="card-body">
                    ...
                    <div class="d-sm-flex align-items-sm-center flex-sm-wrap">
                        ...
                        <div class="d-inline-flex align-items-center mt-2 mt-sm-0 ms-sm-auto">
                            ...
                            <a href="#" class="me-1">
                                <img src="{{URL::asset('assets/demo/layout_1/images/demo/users/face17.jpg')}}" class="rounded-circle" width="32" height="32" alt="">
                            </a>
                            <a href="#" class="me-1">
                                <img src="{{URL::asset('assets/demo/layout_1/images/demo/users/face11.jpg')}}" class="rounded-circle" width="32" height="32" alt="">
                            </a>
                            <a href="#" class="text-body">&nbsp;<i class="ph-plus"></i></a>
                        </div>
                    </div>
                ...
                <div class="card-body">
                    ...
                    <div class="d-sm-flex align-items-sm-center flex-sm-wrap">
                        ...
                        <div class="d-inline-flex align-items-center mt-2 mt-sm-0 ms-sm-auto">
                            ...
                            <a href="#" class="me-1">
                                <img src="{{URL::asset('assets/demo/layout_1/images/demo/users/face22.jpg')}}" class="rounded-circle" width="32" height="32" alt="">
                            </a>
                            <a href="#" class="me-1">
                                <img src="{{URL::asset('assets/demo/layout_1/images/demo/users/face18.jpg')}}" class="rounded-circle" width="32" height="32" alt="">
                            </a>
                ...
                <div class="card-body">
                    ...
                    <div class="d-sm-flex align-items-sm-center flex-sm-wrap">
                        ...
                        <div class="d-inline-flex align-items-center mt-2 mt-sm-0 ms-sm-auto">
                            ...
                            <a href="#" class="me-1">
                                <img src="{{URL::asset('assets/demo/layout_1/images/demo/users/face16.jpg')}}" class="rounded-circle" width="32" height="32" alt="">
                            </a>
                            <a href="#" class="text-body">&nbsp;<i class="ph-plus"></i></a>
                        </div>
                    </div>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="d-sm-flex align-items-sm-center flex-sm-wrap">
                        ...
                        <div class="d-inline-flex align-items-center mt-2 mt-sm-0 ms-sm-auto">
                            <a href="#" class="me-1">
                                <img src="{{URL::asset('assets/demo/layout_1/images/demo/users/face10.jpg')}}" class="rounded-circle" width="32" height="32" alt="">
                            </a>
                            <a href="#" class="me-1">
                                <img src="{{URL::asset('assets/demo/layout_1/images/demo/users/face20.jpg')}}" class="rounded-circle" width="32" height="32" alt="">
                            </a>
