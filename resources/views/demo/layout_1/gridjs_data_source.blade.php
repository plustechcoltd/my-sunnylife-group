...
<script src="{{URL::asset('assets/demo/layout_1/js/vendor/tables/gridjs/gridjs.min.js')}}"></script>
@endsection
@section('scripts')
<script src="{{URL::asset('assets/demo/layout_1/demo/pages/gridjs_data_source.js')}}"></script>
@endsection
