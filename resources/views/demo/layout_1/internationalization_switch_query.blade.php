...
@slot('subtitle') Query String @endslot
@endcomponent
                    ...
                    <ul class="nav flex-row justify-content-end order-1 order-lg-2 ms-auto">
                        <li class="nav-item nav-item-dropdown-lg dropdown language-switch">
                            ...
                            <div class="dropdown-menu dropdown-menu-end">
                                ...
                                <a href="?lng=ua" class="dropdown-item ua">
...
@endsection
@section('scripts')
<script src="{{URL::asset('assets/demo/layout_1/demo/pages/internationalization_switch_query.js')}}"></script>
@endsection
