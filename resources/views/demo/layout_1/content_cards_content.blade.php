...
<div class="content">
    ...
    <div class="row">
            ...
            <div class="card">
                <div class="card-img-actions">
                    ...
                    <div class="card-img-actions-overlay card-img-top">
                        <a href="{{URL::asset('assets/demo/layout_1/images/demo/flat/4.png')}}" class="btn btn-outline-white border-width-2" data-popup="lightbox">
                            Preview
                        </a>
            ...
            <div class="card">
                ...
                <div class="card-img-actions">
                    ...
                    <div class="card-img-actions-overlay">
                        <a href="{{URL::asset('assets/demo/layout_1/images/demo/flat/7.png')}}" class="btn btn-outline-white border-width-2" data-popup="lightbox">
                            Preview
                        </a>
                        <a href="#" class="btn btn-outline-white border-width-2 ms-2">
                            Details
        ...
        <div class="col-lg-4">
            ...
            <div class="card">
                ...
                <div class="card-img-actions">
                    <img class="img-fluid" src="{{URL::asset('assets/demo/layout_1/images/demo/flat/5.png')}}" alt="">
                    <div class="card-img-actions-overlay">
                        <a href="{{URL::asset('assets/demo/layout_1/images/demo/flat/5.png')}}" class="btn btn-outline-white border-width-2" data-popup="lightbox">
                            Preview
                        </a>
                        <a href="#" class="btn btn-outline-white border-width-2 ms-2">
                            Details
            ...
            <div class="card">
                ...
                <div class="card-img-actions">
                    <img class="img-fluid" src="{{URL::asset('assets/demo/layout_1/images/demo/flat/8.png')}}" alt="">
                    <div class="card-img-actions-overlay">
                        <a href="{{URL::asset('assets/demo/layout_1/images/demo/flat/8.png')}}" class="btn btn-outline-white border-width-2" data-popup="lightbox">
                            Preview
                        </a>
                        <a href="#" class="btn btn-outline-white border-width-2 ms-2">
                            Details
        ...
        <div class="col-lg-4">
            ...
            <div class="card">
                ...
                <div class="card-img-actions">
                    <img class="img-fluid" src="{{URL::asset('assets/demo/layout_1/images/demo/flat/6.png')}}" alt="">
                    <div class="card-img-actions-overlay">
                        <a href="{{URL::asset('assets/demo/layout_1/images/demo/flat/6.png')}}" class="btn btn-outline-white border-width-2" data-popup="lightbox">
                            Preview
                        </a>
                        <a href="#" class="btn btn-outline-white border-width-2 ms-2">
                            Details
            ...
            <div class="card">
                <div class="card-img-actions">
                    <img class="img-fluid" src="{{URL::asset('assets/demo/layout_1/images/demo/flat/9.png')}}" alt="">
                    <div class="card-img-actions-overlay">
                        <a href="{{URL::asset('assets/demo/layout_1/images/demo/flat/9.png')}}" class="btn btn-outline-white border-width-2" data-popup="lightbox">
                            Preview
                        </a>
                        <a href="#" class="btn btn-outline-white border-width-2 ms-2">
                            Details
    ...
    <div class="row">
        ...
        <div class="col-lg-4">
            ...
            <div class="card">
                <div class="card-img-actions">
                    <a href="{{URL::asset('assets/demo/layout_1/images/demo/flat/2.png')}}" class="text-white" data-popup="lightbox">
        ...
        <div class="col-lg-4">
            ...
            <div class="card">
                <div class="card-img-actions">
                    ...
                    <div class="card-img-actions-overlay card-img-top">
                        <a href="{{URL::asset('assets/demo/layout_1/images/demo/flat/3.png')}}" class="btn btn-outline-white border-width-2" data-popup="lightbox">
                            Preview
                        </a>
                        <a href="#" class="btn btn-outline-white border-width-2 ms-2">
                            Details
...
@endsection
@section('scripts')
<script src="{{URL::asset('assets/demo/layout_1/demo/pages/content_cards_content.js')}}"></script>
@endsection
