...
@section('css')
<link href="{{URL::asset('assets/demo/layout_1/css/animate.min.css')}}" rel="stylesheet" type="text/css">
@endsection
@section('content')
...
@endsection
@section('scripts')
<script src="{{URL::asset('assets/demo/layout_1/demo/pages/colors_indigo.js')}}"></script>
@endsection
