...
@slot('subtitle') Direct Switch @endslot
@endcomponent
...
<div class="content">
    ...
    <div class="card">
        <div class="card-header">
            <h5 class="mb-0">Direct switching</h5>
        </div>

        <div class="card-body">
            <p class="mb-3">This example demonstrates <code>direct</code> language switching on button or link click. Every time the link is clicked, i18next loads <code>json</code> file with selected language and initialize translation again, so new language appears <span class="fw-semibold">without page reload</span>. By default, i18next automatically <span class="fw-semibold">detects</span> user navigator language and sets it on init, but if this language is missed in locales, user will see the language specified in <code>&lt;html lang="..."></code> or specified as a <code>fallback</code> language. Since i18next uses <code>cookies</code> and <code>localStorage</code> by default, after page reload you'll see the language that you've selected before reload.</p>
                    ...
                    <ul class="nav flex-row justify-content-end order-1 order-lg-2 ms-auto">
                        <li class="nav-item nav-item-dropdown-lg dropdown language-switch">
                            <a href="#" class="navbar-nav-link navbar-nav-link-icon rounded-pill" data-bs-toggle="dropdown">
                                <img src="{{URL::asset('assets/demo/layout_1/images/lang/gb.svg')}}" height="22" alt="">
                                <span class="d-none d-lg-inline-block ms-2 me-1">English</span>
                            </a>
                            <div class="dropdown-menu dropdown-menu-end">
                                <a href="#" class="dropdown-item en">
                                    <img src="{{URL::asset('assets/demo/layout_1/images/lang/gb.svg')}}" height="22" alt="">
                                    <span class="ms-2">English</span>
                                </a>
                                <a href="#" class="dropdown-item ua">
                                    <img src="{{URL::asset('assets/demo/layout_1/images/lang/ua.svg')}}" height="22" alt="">
                                    <span class="ms-2">Українська</span>
                                </a>
                            </div>
                        </li>
                        ...
                        <li class="nav-item nav-item-dropdown-lg dropdown ms-1">
                            <a href="#" class="navbar-nav-link align-items-center rounded-pill p-1" data-bs-toggle="dropdown">
                                <div class="status-indicator-container">
                                    <img src="{{URL::asset('assets/demo/layout_1/images/demo/users/face11.jpg')}}" class="w-32px h-32px rounded-pill" alt="">
                        ...
                        <div class="sidebar-content">
                            ...
                            <div class="sidebar-section">
                                <div class="sidebar-section-body d-flex">
                                    <a href="#" class="me-3">
                                        <img src="{{URL::asset('assets/demo/layout_1/images/demo/users/face11.jpg')}}" width="38" height="38" class="rounded-pill" alt="">
                                    </a>
                    ...
                    <pre class="mb-3" data-line="3,8,13">
										<code class="language-markup">
											...
											&lt;div class="dropdown-menu">
												...
												&lt;a href="#" class="dropdown-item ua">
													&lt;img src="[path to flag]/ua.svg" height="22" alt="">
													&lt;span class="ms-2">Ukrainian&lt;/span>
												&lt;/a>
                    ...
                    <pre class="mb-3">
										<code class="language-javascript">
											...
											i18next
												...
												.init({
													backend: {
														loadPath: 'assets/demo/locales/en.json'
													},
												    fallbackLng: false
												},
												function (err, t) {
...
<script src="{{URL::asset('assets/demo/layout_1/js/vendor/internationalization/i18next.min.js')}}"></script>
<script src="{{URL::asset('assets/demo/layout_1/js/vendor/internationalization/i18nextHttpBackend.min.js')}}"></script>
<script src="{{URL::asset('assets/demo/layout_1/js/vendor/internationalization/i18nextBrowserLanguageDetector.min.js')}}"></script>
<script src="{{URL::asset('assets/demo/layout_1/js/vendor/ui/prism.min.js')}}"></script>
@endsection
@section('scripts')
<script src="{{URL::asset('assets/demo/layout_1/demo/pages/internationalization_switch_direct.js')}}"></script>
@endsection
