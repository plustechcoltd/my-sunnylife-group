        ...
        <div class="col-lg-6">
            ...
            <div class="card card-body">
                ...
                <blockquote class="blockquote d-flex mb-0">
                    <div class="me-3">
                        <img src="{{URL::asset('assets/demo/layout_1/images/demo/users/face11.jpg')}}" width="46" height="46" class="rounded-pill" alt="">
                    </div>
            ...
            <div class="card card-body">
                <blockquote class="blockquote text-center py-2 mb-0">
                    <div class="mb-3">
                        <img class="rounded-pill" src="{{URL::asset('assets/demo/layout_1/images/demo/users/face1.jpg')}}" width="46" height="46" alt="">
                    </div>
        ...
        <div class="col-lg-6">
            ...
            <div class="card card-body">
                ...
                <blockquote class="blockquote d-flex mb-0">
                    ...
                    <div class="ms-3">
                        <img class="rounded-circle" src="{{URL::asset('assets/demo/layout_1/images/demo/users/face3.jpg')}}" width="46" height="46" alt="">
                    </div>
                </blockquote>
            </div>
