            ...
            <div id="carouselExampleSlidesOnly" class="carousel slide" data-bs-ride="carousel">
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img src="{{URL::asset('assets/demo/layout_1/images/demo/carousel/1.jpg')}}" class="d-block w-100" alt="">
                    </div>
                    <div class="carousel-item">
                        <img src="{{URL::asset('assets/demo/layout_1/images/demo/carousel/2.jpg')}}" class="d-block w-100" alt="">
                    </div>
                    <div class="carousel-item">
                        <img src="{{URL::asset('assets/demo/layout_1/images/demo/carousel/3.jpg')}}" class="d-block w-100" alt="">
                    </div>
                    <div class="carousel-item">
                        <img src="{{URL::asset('assets/demo/layout_1/images/demo/carousel/4.jpg')}}" class="d-block w-100" alt="">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div id="carouselExampleGrid" class="carousel slide" data-bs-ride="carousel">
                ...
                <div class="carousel-inner row">
                    <div class="carousel-item active">
                        <div class="row">
                            <div class="col-4">
                                <img src="{{URL::asset('assets/demo/layout_1/images/demo/carousel/5.jpg')}}" class="d-block w-100" alt="">
                            </div>
                            <div class="col-4">
                                <img src="{{URL::asset('assets/demo/layout_1/images/demo/carousel/6.jpg')}}" class="d-block w-100" alt="">
                            </div>
                            <div class="col-4">
                                <img src="{{URL::asset('assets/demo/layout_1/images/demo/carousel/7.jpg')}}" class="d-block w-100" alt="">
                            </div>
                        </div>
                    </div>
                    <div class="carousel-item">
                        <div class="row">
                            <div class="col-4">
                                <img src="{{URL::asset('assets/demo/layout_1/images/demo/carousel/8.jpg')}}" class="d-block w-100" alt="">
                            </div>
                            <div class="col-4">
                                <img src="{{URL::asset('assets/demo/layout_1/images/demo/carousel/7.jpg')}}" class="d-block w-100" alt="">
                            </div>
