...
<script src="{{URL::asset('assets/demo/layout_1/js/vendor/tables/datatables/extensions/scroller.min.js')}}"></script>
<script src="{{URL::asset('assets/demo/layout_1/js/vendor/tables/datatables/extensions/buttons.min.js')}}"></script>
@endsection
@section('scripts')
<script src="{{URL::asset('assets/demo/layout_1/demo/pages/datatables_extension_scroller.js')}}"></script>
@endsection
