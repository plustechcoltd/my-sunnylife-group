    ...
    <div class="row">
            ...
            <div class="card">
                ...
                <div class="card-footer d-sm-flex justify-content-sm-between align-items-sm-center py-2">
                    <div class="hstack gap-2">
                        <img src="{{URL::asset('assets/demo/layout_1/images/demo/users/face1.jpg')}}" class="rounded-pill" width="32" height="32" alt="">
                        <img src="{{URL::asset('assets/demo/layout_1/images/demo/users/face2.jpg')}}" class="rounded-pill" width="32" height="32" alt="">
                        <img src="{{URL::asset('assets/demo/layout_1/images/demo/users/face3.jpg')}}" class="rounded-pill" width="32" height="32" alt="">
                    </div>

                    <div class="hstack gap-2 mt-2 mt-sm-0">
                        <img src="{{URL::asset('assets/demo/layout_1/images/demo/users/face4.jpg')}}" class="rounded-pill" width="32" height="32" alt="">
                        <img src="{{URL::asset('assets/demo/layout_1/images/demo/users/face5.jpg')}}" class="rounded-pill mx-2" width="32" height="32" alt="">
            ...
            <div class="card">
                ...
                <div class="card-footer d-flex justify-content-between align-items-center py-2">
                    <div class="position-relative">
                        <img src="{{URL::asset('assets/demo/layout_1/images/demo/users/face7.jpg')}}" class="rounded-circle" width="32" height="32" alt="">
                        <span class="badge bg-success position-absolute top-0 left-100 translate-middle rounded-pill">9</span>
                    </div>

                    <div class="hstack gap-2">
                        <div class="position-relative">
                            <img src="{{URL::asset('assets/demo/layout_1/images/demo/users/face8.jpg')}}" class="rounded-circle" width="32" height="32" alt="">
                            <span class="badge bg-warning position-absolute top-0 left-100 translate-middle rounded-pill">2</span>
                        </div>
                        <div class="position-relative">
                            <img src="{{URL::asset('assets/demo/layout_1/images/demo/users/face9.jpg')}}" class="rounded-circle" width="32" height="32" alt="">
        ...
        <div class="col-lg-6">
            ...
            <div class="card">
                ...
                <div class="card-footer d-flex justify-content-between align-items-center py-2">
                    <a href="#">
                        <img src="{{URL::asset('assets/demo/layout_1/images/demo/users/face11.jpg')}}" class="rounded-pill" width="32" height="32" alt="">
                    </a>
            ...
            <div class="card">
                ...
                <div class="card-footer d-sm-flex justify-content-sm-between align-items-sm-center py-2">
                    <div class="hstack gap-2">
                        <a href="#">
                            <img src="{{URL::asset('assets/demo/layout_1/images/demo/users/face13.jpg')}}" class="rounded-pill" width="32" height="32" alt="">
                        </a>
                        <a href="#">
                            <img src="{{URL::asset('assets/demo/layout_1/images/demo/users/face14.jpg')}}" class="rounded-pill" width="32" height="32" alt="">
                        </a>
                        <a href="#">
                    ...
                    <div class="hstack gap-2 mt-2 mt-sm-0">
                        <a href="#">
                            <img src="{{URL::asset('assets/demo/layout_1/images/demo/users/face16.jpg')}}" class="rounded-pill" width="32" height="32" alt="">
                        </a>
                        <a href="#">
                            <img src="{{URL::asset('assets/demo/layout_1/images/demo/users/face17.jpg')}}" class="rounded-pill" width="32" height="32" alt="">
                        </a>
                        <a href="#">
            ...
            <div class="card">
                ...
                <div class="card-footer d-flex justify-content-between align-items-center py-2">
                    <div class="status-indicator-container">
                        <img src="{{URL::asset('assets/demo/layout_1/images/demo/users/face19.jpg')}}" class="rounded-circle" width="32" height="32" alt="">
                        <span class="status-indicator bg-success"></span>
                    </div>

                    <div class="hstack gap-2">
                        <div class="status-indicator-container">
                            <img src="{{URL::asset('assets/demo/layout_1/images/demo/users/face20.jpg')}}" class="rounded-circle" width="32" height="32" alt="">
                            <span class="status-indicator bg-warning"></span>
                        </div>
                        <div class="status-indicator-container">
                            <img src="{{URL::asset('assets/demo/layout_1/images/demo/users/face21.jpg')}}" class="rounded-circle" width="32" height="32" alt="">
...
<script src="{{URL::asset('assets/demo/layout_1/js/assets/js/vendor/ui/dragula.min.js')}}"></script>
@endsection
@section('scripts')
<script src="{{URL::asset('assets/demo/layout_1/demo/pages/content_cards_footer.js')}}"></script>
@endsection
