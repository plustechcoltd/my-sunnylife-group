                                ...
                                <li class="nav-item dropdown ms-lg-2">
                                    <a href="#" class="navbar-nav-link align-items-center rounded p-1" data-bs-toggle="dropdown">
                                        <div class="status-indicator-container">
                                            <img src="{{URL::asset('assets/demo/layout_1/images/demo/users/face11.jpg')}}" class="w-32px h-32px rounded-sm" alt="">
                                            <span class="status-indicator bg-success"></span>
                                        </div>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="navbar-collapse collapse" id="navbar-language">
                            ...
                            <ul class="navbar-nav ms-xl-auto">
                                ...
                                <li class="nav-item ms-xl-1">
                                    <a href="#" class="navbar-nav-link rounded">
                                        <img src="{{URL::asset('assets/demo/layout_1/images/lang/it.svg')}}" class="h-16px me-2" alt="">
                                        IT
                                    </a>
                                </li>
                            </ul>
...
<script src="{{URL::asset('assets/demo/layout_1/js/vendor/ui/moment/moment.min.js')}}"></script>
<script src="{{URL::asset('assets/demo/layout_1/js/vendor/pickers/daterangepicker.js')}}"></script>
@endsection
@section('scripts')
<script src="{{URL::asset('assets/demo/layout_1/demo/pages/navbar_components.js')}}"></script>
@endsection
