    ...
    <div class="row">
        <div class="col-12 col-lg-8">
            <div class="card card-body">
                ...
                <div class="d-sm-flex align-items-sm-start mb-4">
                    <a href="#" class="d-inline-block position-relative me-sm-3 mb-3 mb-sm-0">
                        <img src="{{URL::asset('assets/demo/layout_1/images/demo/flat/2.png')}}" class="flex-shrink-0 rounded" height="100" alt="">
                        <div class="d-inline-flex bg-dark bg-opacity-50 text-white position-absolute start-50 top-50 translate-middle rounded-pill p-2">
                            <i class="ph-play"></i>
                        </div>
                ...
                <div class="d-sm-flex align-items-sm-start mb-4">
                    <a href="#" class="d-inline-block position-relative me-sm-3 mb-3 mb-sm-0">
                        <img src="{{URL::asset('assets/demo/layout_1/images/demo/flat/3.png')}}" class="flex-shrink-0 rounded" height="100" alt="">
                        <div class="d-inline-flex bg-dark bg-opacity-50 text-white position-absolute start-50 top-50 translate-middle rounded-pill p-2">
                            <i class="ph-play"></i>
                        </div>
                ...
                <div class="d-sm-flex align-items-sm-start mb-4">
                    <a href="#" class="d-inline-block position-relative me-sm-3 mb-3 mb-sm-0">
                        <img src="{{URL::asset('assets/demo/layout_1/images/demo/flat/4.png')}}" class="flex-shrink-0 rounded" height="100" alt="">
                        <div class="d-inline-flex bg-dark bg-opacity-50 text-white position-absolute start-50 top-50 translate-middle rounded-pill p-2">
                            <i class="ph-play"></i>
                        </div>
                ...
                <div class="d-sm-flex align-items-sm-start mb-4">
                    <a href="#" class="d-inline-block position-relative me-sm-3 mb-3 mb-sm-0">
                        <img src="{{URL::asset('assets/demo/layout_1/images/demo/flat/5.png')}}" class="flex-shrink-0 rounded" height="100" alt="">
                        <div class="d-inline-flex bg-dark bg-opacity-50 text-white position-absolute start-50 top-50 translate-middle rounded-pill p-2">
                            <i class="ph-play"></i>
                        </div>
                ...
                <div class="d-sm-flex align-items-sm-start mb-4">
                    <a href="#" class="d-inline-block position-relative me-sm-3 mb-3 mb-sm-0">
                        <img src="{{URL::asset('assets/demo/layout_1/images/demo/flat/6.png')}}" class="flex-shrink-0 rounded" height="100" alt="">
                        <div class="d-inline-flex bg-dark bg-opacity-50 text-white position-absolute start-50 top-50 translate-middle rounded-pill p-2">
                            <i class="ph-play"></i>
                        </div>
                ...
                <div class="d-sm-flex align-items-sm-start mb-4">
                    <a href="#" class="d-inline-block position-relative me-sm-3 mb-3 mb-sm-0">
                        <img src="{{URL::asset('assets/demo/layout_1/images/demo/flat/7.png')}}" class="flex-shrink-0 rounded" height="100" alt="">
                        <div class="d-inline-flex bg-dark bg-opacity-50 text-white position-absolute start-50 top-50 translate-middle rounded-pill p-2">
                            <i class="ph-play"></i>
                        </div>
                ...
                <div class="d-sm-flex align-items-sm-start mb-4">
                    <a href="#" class="d-inline-block position-relative me-sm-3 mb-3 mb-sm-0">
                        <img src="{{URL::asset('assets/demo/layout_1/images/demo/flat/8.png')}}" class="flex-shrink-0 rounded" height="100" alt="">
                        <div class="d-inline-flex bg-dark bg-opacity-50 text-white position-absolute start-50 top-50 translate-middle rounded-pill p-2">
                            <i class="ph-play"></i>
                        </div>
                ...
                <div class="d-sm-flex align-items-sm-start mb-4">
                    <a href="#" class="d-inline-block position-relative me-sm-3 mb-3 mb-sm-0">
                        <img src="{{URL::asset('assets/demo/layout_1/images/demo/flat/9.png')}}" class="flex-shrink-0 rounded" height="100" alt="">
                        <div class="d-inline-flex bg-dark bg-opacity-50 text-white position-absolute start-50 top-50 translate-middle rounded-pill p-2">
                            <i class="ph-play"></i>
                        </div>
                ...
                <div class="d-sm-flex align-items-sm-start mb-4">
                    <a href="#" class="d-inline-block position-relative me-sm-3 mb-3 mb-sm-0">
                        <img src="{{URL::asset('assets/demo/layout_1/images/demo/flat/10.png')}}" class="flex-shrink-0 rounded" height="100" alt="">
                        <div class="d-inline-flex bg-dark bg-opacity-50 text-white position-absolute start-50 top-50 translate-middle rounded-pill p-2">
                            <i class="ph-play"></i>
                        </div>
                ...
                <div class="d-sm-flex align-items-sm-start mb-4">
                    <a href="#" class="d-inline-block position-relative me-sm-3 mb-3 mb-sm-0">
                        <img src="{{URL::asset('assets/demo/layout_1/images/demo/flat/11.png')}}" class="flex-shrink-0 rounded" height="100" alt="">
                        <div class="d-inline-flex bg-dark bg-opacity-50 text-white position-absolute start-50 top-50 translate-middle rounded-pill p-2">
                            <i class="ph-play"></i>
                        </div>
                ...
                <div class="d-sm-flex align-items-sm-start mb-4">
                    <a href="#" class="d-inline-block position-relative me-sm-3 mb-3 mb-sm-0">
                        <img src="{{URL::asset('assets/demo/layout_1/images/demo/flat/13.png')}}" class="flex-shrink-0 rounded" height="100" alt="">
                        <div class="d-inline-flex bg-dark bg-opacity-50 text-white position-absolute start-50 top-50 translate-middle rounded-pill p-2">
                            <i class="ph-play"></i>
                        </div>
                ...
                <div class="d-sm-flex align-items-sm-start mb-4">
                    <a href="#" class="d-inline-block position-relative me-sm-3 mb-3 mb-sm-0">
                        <img src="{{URL::asset('assets/demo/layout_1/images/demo/flat/14.png')}}" class="flex-shrink-0 rounded" height="100" alt="">
                        <div class="d-inline-flex bg-dark bg-opacity-50 text-white position-absolute start-50 top-50 translate-middle rounded-pill p-2">
                            <i class="ph-play"></i>
                        </div>
                ...
                <div class="d-sm-flex align-items-sm-start mb-4">
                    <a href="#" class="d-inline-block position-relative me-sm-3 mb-3 mb-sm-0">
                        <img src="{{URL::asset('assets/demo/layout_1/images/demo/flat/15.png')}}" class="flex-shrink-0 rounded" height="100" alt="">
                        <div class="d-inline-flex bg-dark bg-opacity-50 text-white position-absolute start-50 top-50 translate-middle rounded-pill p-2">
                            <i class="ph-play"></i>
                        </div>
                ...
                <div class="d-sm-flex align-items-sm-start mb-4">
                    <a href="#" class="d-inline-block position-relative me-sm-3 mb-3 mb-sm-0">
                        <img src="{{URL::asset('assets/demo/layout_1/images/demo/flat/16.png')}}" class="flex-shrink-0 rounded" height="100" alt="">
                        <div class="d-inline-flex bg-dark bg-opacity-50 text-white position-absolute start-50 top-50 translate-middle rounded-pill p-2">
                            <i class="ph-play"></i>
                        </div>
                ...
                <div class="d-sm-flex align-items-sm-start mb-4">
                    <a href="#" class="d-inline-block position-relative me-sm-3 mb-3 mb-sm-0">
                        <img src="{{URL::asset('assets/demo/layout_1/images/demo/flat/17.png')}}" class="flex-shrink-0 rounded" height="100" alt="">
                        <div class="d-inline-flex bg-dark bg-opacity-50 text-white position-absolute start-50 top-50 translate-middle rounded-pill p-2">
                            <i class="ph-play"></i>
                        </div>
                ...
                <div class="d-sm-flex align-items-sm-start mb-4">
                    <a href="#" class="d-inline-block position-relative me-sm-3 mb-3 mb-sm-0">
                        <img src="{{URL::asset('assets/demo/layout_1/images/demo/flat/19.png')}}" class="flex-shrink-0 rounded" height="100" alt="">
                        <div class="d-inline-flex bg-dark bg-opacity-50 text-white position-absolute start-50 top-50 translate-middle rounded-pill p-2">
                            <i class="ph-play"></i>
                        </div>
                ...
                <div class="d-sm-flex align-items-sm-start mb-4">
                    <a href="#" class="d-inline-block position-relative me-sm-3 mb-3 mb-sm-0">
                        <img src="{{URL::asset('assets/demo/layout_1/images/demo/flat/20.png')}}" class="flex-shrink-0 rounded" height="100" alt="">
                        <div class="d-inline-flex bg-dark bg-opacity-50 text-white position-absolute start-50 top-50 translate-middle rounded-pill p-2">
                            <i class="ph-play"></i>
                        </div>
        ...
        <div class="col-12 col-lg-4">
            <div class="card card-body">
                <div class="mb-3">
                    <a href="#"><img src="{{URL::asset('assets/demo/layout_1/images/demo/flat/1.png')}}" class="img-fluid rounded" alt=""></a>
                </div>
                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            <a href="#" class="d-inline-block position-relative mt-3">
                                <img src="{{URL::asset('assets/demo/layout_1/images/demo/flat/1.png')}}" class="img-fluid rounded" alt="">
                                <div class="d-inline-flex bg-dark bg-opacity-50 text-white position-absolute start-50 top-50 translate-middle rounded-pill p-2">
                                    <i class="ph-play"></i>
                                </div>
                                <span class="bg-dark bg-opacity-50 text-white fs-xs lh-1 rounded-1 position-absolute bottom-0 start-0 p-1 ms-2 mb-2">38:46</span>
                            ...
                            <a href="#" class="d-inline-block position-relative mt-3">
                                <img src="{{URL::asset('assets/demo/layout_1/images/demo/flat/2.png')}}" class="img-fluid rounded" alt="">
                                <div class="d-inline-flex bg-dark bg-opacity-50 text-white position-absolute start-50 top-50 translate-middle rounded-pill p-2">
                                    <i class="ph-play"></i>
                                </div>
                        ...
                        <div class="col-sm-4">
                            <a href="#" class="d-inline-block position-relative mt-3">
                                <img src="{{URL::asset('assets/demo/layout_1/images/demo/flat/3.png')}}" class="img-fluid rounded" alt="">
                                <div class="d-inline-flex bg-dark bg-opacity-50 text-white position-absolute start-50 top-50 translate-middle rounded-pill p-2">
                                    <i class="ph-play"></i>
                                </div>
                            ...
                            <a href="#" class="d-inline-block position-relative mt-3">
                                <img src="{{URL::asset('assets/demo/layout_1/images/demo/flat/4.png')}}" class="img-fluid rounded" alt="">
                                <div class="d-inline-flex bg-dark bg-opacity-50 text-white position-absolute start-50 top-50 translate-middle rounded-pill p-2">
                                    <i class="ph-play"></i>
                                </div>
                        ...
                        <div class="col-sm-4">
                            <a href="#" class="d-inline-block position-relative mt-3">
                                <img src="{{URL::asset('assets/demo/layout_1/images/demo/flat/5.png')}}" class="img-fluid rounded" alt="">
                                <div class="d-inline-flex bg-dark bg-opacity-50 text-white position-absolute start-50 top-50 translate-middle rounded-pill p-2">
                                    <i class="ph-play"></i>
                                </div>
                            ...
                            <a href="#" class="d-inline-block position-relative mt-3">
                                <img src="{{URL::asset('assets/demo/layout_1/images/demo/flat/6.png')}}" class="img-fluid rounded" alt="">
                                <div class="d-inline-flex bg-dark bg-opacity-50 text-white position-absolute start-50 top-50 translate-middle rounded-pill p-2">
                                    <i class="ph-play"></i>
                                </div>
