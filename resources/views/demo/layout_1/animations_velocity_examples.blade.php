...
<script src="{{URL::asset('assets/demo/layout_1/js/vendor/velocity/velocity.min.js')}}"></script>
<script src="{{URL::asset('assets/demo/layout_1/js/vendor/velocity/velocity.ui.min.js')}}"></script>
<script src="{{URL::asset('assets/demo/layout_1/js/vendor/ui/prism.min.js')}}"></script>
@endsection
@section('scripts')
<script src="{{URL::asset('assets/demo/layout_1/demo/pages/animations_velocity_examples.js')}}"></script>
@endsection
