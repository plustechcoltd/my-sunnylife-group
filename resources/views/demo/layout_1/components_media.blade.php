                    ...
                    <div class="mb-4">
                        ...
                        <div class="border rounded">
                            <div class="list-group list-group-borderless py-2">
                                ...
                                <div class="list-group-item d-flex">
                                    <a href="#" class="d-block me-3">
                                        <img src="{{URL::asset('assets/demo/layout_1/images/demo/users/face11.jpg')}}" class="rounded-circle" width="40" height="40" alt="">
                                    </a>
                                ...
                                <div class="list-group-item d-flex">
                                    <a href="#" class="d-block me-3">
                                        <img src="{{URL::asset('assets/demo/layout_1/images/demo/users/face16.jpg')}}" class="rounded-circle" width="40" height="40" alt="">
                                    </a>
                            ...
                            <div class="list-group list-group-borderless py-2">
                                <div class="list-group-item d-flex">
                                    ...
                                    <a href="#" class="d-block ms-3">
                                        <img src="{{URL::asset('assets/demo/layout_1/images/demo/users/face2.jpg')}}" class="rounded-circle" width="40" height="40" alt="">
                                    </a>
                                </div>
                                ...
                                <div class="list-group-item d-flex">
                                    ...
                                    <a href="#" class="d-block ms-3">
                                        <img src="{{URL::asset('assets/demo/layout_1/images/demo/users/face25.jpg')}}" class="rounded-circle" width="40" height="40" alt="">
                                    </a>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="list-group list-group-flush">
                                <div class="list-group-item">
                                    <div class="d-flex my-1">
                                        <a href="#" class="d-block me-3">
                                            <img src="{{URL::asset('assets/demo/layout_1/images/demo/users/face2.jpg')}}" class="rounded-circle" width="42" height="42" alt="">
                                        </a>
                                ...
                                <div class="list-group-item">
                                    <div class="d-flex my-1">
                                        <a href="#" class="d-block me-3">
                                            <img src="{{URL::asset('assets/demo/layout_1/images/demo/users/face3.jpg')}}" class="rounded-circle" width="42" height="42" alt="">
                                        </a>
                                ...
                                <div class="list-group-item">
                                    <div class="d-flex my-1">
                                        <a href="#" class="d-block me-3">
                                            <img src="{{URL::asset('assets/demo/layout_1/images/demo/users/face25.jpg')}}" class="rounded-circle" width="42" height="42" alt="">
                                        </a>
                            ...
                            <div class="list-group list-group-flush">
                                <div class="list-group-item">
                                    <div class="d-flex my-1">
                                        ...
                                        <a href="#" class="d-block ms-3">
                                            <img src="{{URL::asset('assets/demo/layout_1/images/demo/users/face1.jpg')}}" class="rounded-circle" width="42" height="42" alt="">
                                        </a>
                                    </div>
                                </div>
                                ...
                                <div class="list-group-item">
                                    <div class="d-flex my-1">
                                        ...
                                        <a href="#" class="d-block ms-3">
                                            <img src="{{URL::asset('assets/demo/layout_1/images/demo/users/face11.jpg')}}" class="rounded-circle" width="42" height="42" alt="">
                                        </a>
                                    </div>
                                </div>
                                ...
                                <div class="list-group-item">
                                    <div class="d-flex my-1">
                                        ...
                                        <a href="#" class="d-block ms-3">
                                            <img src="{{URL::asset('assets/demo/layout_1/images/demo/users/face16.jpg')}}" class="rounded-circle" width="42" height="42" alt="">
                                        </a>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="border rounded">
                            <div class="list-group list-group-borderless py-2">
                                ...
                                <div class="list-group-item d-flex">
                                    <a href="#" class="d-block me-3">
                                        <img src="{{URL::asset('assets/demo/layout_1/images/demo/users/face10.jpg')}}" class="rounded-circle" width="40" height="40" alt="">
                                    </a>
                        ...
                        <div class="border rounded">
                            <div class="list-group list-group-flush">
                                ...
                                <div class="list-group-item">
                                    <div class="d-flex my-1">
                                        <a href="#" class="d-block me-3">
                                            <img src="{{URL::asset('assets/demo/layout_1/images/demo/users/face24.jpg')}}" class="rounded-circle" width="42" height="42" alt="">
                                        </a>
                    ...
                    <div class="mb-4 mb-lg-0">
                        ...
                        <div class="border rounded">
                            <div class="list-group list-group-borderless py-2">
                                ...
                                <div class="list-group-item d-flex flex-column flex-lg-row">
                                    <a href="#" class="d-inline-block me-lg-3 mb-2 mb-lg-0">
                                        <img src="{{URL::asset('assets/demo/layout_1/images/demo/users/face24.jpg')}}" class="rounded-circle" width="40" height="40" alt="">
                                    </a>
                        ...
                        <div class="border rounded">
                            <div class="list-group list-group-borderless py-2">
                                <a href="#" class="list-group-item list-group-item-action d-flex">
                                    ...
                                    <div class="ms-3">
                                        <img src="{{URL::asset('assets/demo/layout_1/images/demo/users/face4.jpg')}}" class="rounded-circle" width="42" height="42" alt="">
                                    </div>
                                </a>
                                ...
                                <a href="#" class="list-group-item list-group-item-action d-flex">
                                    ...
                                    <div class="ms-3">
                                        <img src="{{URL::asset('assets/demo/layout_1/images/demo/users/face5.jpg')}}" class="rounded-circle" width="42" height="42" alt="">
                                    </div>
                                </a>
                                ...
                                <a href="#" class="list-group-item list-group-item-action d-flex">
                                    ...
                                    <div class="ms-3">
                                        <img src="{{URL::asset('assets/demo/layout_1/images/demo/users/face6.jpg')}}" class="rounded-circle" width="42" height="42" alt="">
                                    </div>
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="mb-4 mb-lg-0">
                        ...
                        <div class="border rounded">
                            <div class="list-group list-group-borderless py-2">
                                ...
                                <a href="#" class="list-group-item list-group-item-action d-flex">
                                    <div class="me-3">
                                        <img src="{{URL::asset('assets/demo/layout_1/images/demo/users/face4.jpg')}}" class="rounded-circle" width="40" height="40" alt="">
                                    </div>
                                ...
                                <a href="#" class="list-group-item list-group-item-action d-flex">
                                    <div class="me-3">
                                        <img src="{{URL::asset('assets/demo/layout_1/images/demo/users/face5.jpg')}}" class="rounded-circle" width="40" height="40" alt="">
                                    </div>
                        ...
                        <div class="border rounded">
                            <div class="list-group list-group-flush">
                                ...
                                <a href="#" class="list-group-item list-group-item-action">
                                    <div class="d-flex my-1">
                                        <div class="me-3">
                                            <img src="{{URL::asset('assets/demo/layout_1/images/demo/users/face7.jpg')}}" class="rounded-circle" width="42" height="42" alt="">
                                        </div>
                                ...
                                <a href="#" class="list-group-item list-group-item-action">
                                    <div class="d-flex my-1">
                                        <div class="me-3">
                                            <img src="{{URL::asset('assets/demo/layout_1/images/demo/users/face8.jpg')}}" class="rounded-circle" width="42" height="42" alt="">
                                        </div>
                                ...
                                <a href="#" class="list-group-item list-group-item-action">
                                    <div class="d-flex my-1">
                                        <div class="me-3">
                                            <img src="{{URL::asset('assets/demo/layout_1/images/demo/users/face9.jpg')}}" class="rounded-circle" width="42" height="42" alt="">
                                        </div>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="border rounded">
                            <div class="list-group list-group-borderless py-2">
                                ...
                                <div class="list-group-item d-flex">
                                    <a href="#" class="d-block me-3">
                                        <img src="{{URL::asset('assets/demo/layout_1/images/demo/users/face12.jpg')}}" class="rounded-circle" width="40" height="40" alt="">
                                    </a>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="border rounded">
                            <div class="list-group list-group-borderless py-2">
                                <div class="list-group-item d-flex">
                                    <a href="#" class="d-block me-3">
                                        <img src="{{URL::asset('assets/demo/layout_1/images/demo/users/face13.jpg')}}" class="rounded-circle" width="40" height="40" alt="">
                                    </a>
                                ...
                                <div class="list-group-item d-flex">
                                    <a href="#" class="d-block me-3">
                                        <img src="{{URL::asset('assets/demo/layout_1/images/demo/users/face14.jpg')}}" class="rounded-circle" width="40" height="40" alt="">
                                    </a>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="border rounded">
                            <div class="list-group list-group-borderless py-2">
                                ...
                                <div class="list-group-item d-flex">
                                    <a href="#" class="d-block me-3">
                                        <img src="{{URL::asset('assets/demo/layout_1/images/demo/users/face6.jpg')}}" class="rounded-circle" width="40" height="40" alt="">
                                    </a>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="border rounded">
                            <div class="list-group list-group-borderless py-2">
                                <div class="list-group-item d-flex">
                                    <a href="#" class="d-block me-3">
                                        <img src="{{URL::asset('assets/demo/layout_1/images/demo/users/face7.jpg')}}" class="rounded-circle" width="40" height="40" alt="">
                                    </a>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="border rounded">
                            <div class="list-group list-group-borderless py-2">
                                <div class="list-group-item d-flex">
                                    <a href="#" class="d-block me-3">
                                        <img src="{{URL::asset('assets/demo/layout_1/images/demo/users/face17.jpg')}}" class="rounded-circle" width="40" height="40" alt="">
                                    </a>
                                ...
                                <div class="list-group-item d-flex">
                                    <a href="#" class="d-block me-3">
                                        <img src="{{URL::asset('assets/demo/layout_1/images/demo/users/face18.jpg')}}" class="rounded-circle" width="40" height="40" alt="">
                                    </a>
                    ...
                    <div class="mb-4 mb-lg-0">
                        ...
                        <div class="border rounded">
                            <div class="list-group list-group-borderless py-2">
                                <div class="list-group-item d-flex">
                                    <a href="#" class="d-block me-3">
                                        <img src="{{URL::asset('assets/demo/layout_1/images/demo/users/face9.jpg')}}" class="rounded-circle" width="40" height="40" alt="">
                                    </a>
                    ...
                    <div>
                        ...
                        <div class="border rounded">
                            <div class="list-group list-group-borderless py-2">
                                <div class="list-group-item d-flex">
                                    <a href="#" class="d-block me-3">
                                        <img src="{{URL::asset('assets/demo/layout_1/images/demo/users/face19.jpg')}}" class="rounded-circle" width="40" height="40" alt="">
                                    </a>
                                ...
                                <div class="list-group-item d-flex">
                                    <a href="#" class="d-block me-3">
                                        <img src="{{URL::asset('assets/demo/layout_1/images/demo/users/face20.jpg')}}" class="rounded-circle" width="40" height="40" alt="">
                                    </a>
