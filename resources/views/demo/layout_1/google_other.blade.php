...
@endsection
@section('scripts')
<script src="{{URL::asset('assets/demo/layout_1/demo/charts/google/other/geo.js')}}"></script>
<script src="{{URL::asset('assets/demo/layout_1/demo/charts/google/other/trendline.js')}}"></script>
<script src="{{URL::asset('assets/demo/layout_1/demo/charts/google/other/diff.js')}}"></script>
<script src="{{URL::asset('assets/demo/layout_1/demo/charts/google/other/sankey.js')}}"></script>
<script src="{{URL::asset('assets/demo/layout_1/demo/charts/google/other/candlestick.js')}}"></script>
@endsection
