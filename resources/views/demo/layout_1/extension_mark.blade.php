...
<script src="{{URL::asset('assets/demo/layout_1/js/vendor/extensions/mark.min.js')}}"></script>
@endsection
@section('scripts')
<script src="{{URL::asset('assets/demo/layout_1/demo/pages/extension_mark.js')}}"></script>
@endsection
