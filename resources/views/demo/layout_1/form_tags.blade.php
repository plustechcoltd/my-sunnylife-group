...
<script src="{{URL::asset('assets/demo/layout_1/js/vendor/forms/tags/tokenfield.min.js')}}"></script>
@endsection
@section('scripts')
<script src="{{URL::asset('assets/demo/layout_1/demo/pages/form_tags.js')}}"></script>
@endsection
