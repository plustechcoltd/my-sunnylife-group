...
<script src="{{URL::asset('assets/demo/layout_1/js/vendor/uploaders/plupload/plupload.full.min.js')}}"></script>
<script src="{{URL::asset('assets/demo/layout_1/js/vendor/uploaders/plupload/plupload.queue.min.js')}}"></script>
@endsection
@section('scripts')
<script src="{{URL::asset('assets/demo/layout_1/demo/pages/uploader_plupload.js')}}"></script>
@endsection
