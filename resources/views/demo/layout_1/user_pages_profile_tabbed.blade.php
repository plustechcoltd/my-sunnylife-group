                ...
                <div class="card">
                    <div class="sidebar-section-body text-center">
                        <div class="card-img-actions d-inline-block mb-3">
                            <img class="img-fluid rounded-circle" src="{{URL::asset('assets/demo/layout_1/images/demo/users/face11.jpg')}}" width="150" height="150" alt="">
                            ...
                            <tbody>
                                <tr class="unread">
                                    ...
                                    <td class="table-inbox-image">
                                        <img src="{{URL::asset('assets/demo/layout_1/images/brands/spotify.svg')}}" class="rounded-circle" width="32" height="32" alt="">
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td class="table-inbox-image">
                                        <img src="{{URL::asset('assets/demo/layout_1/images/brands/dribbble.svg')}}" class="rounded-circle" width="32" height="32" alt="">
                                    </td>
                                    <td class="table-inbox-name">
                                        <a href="mail_read">
                                ...
                                <tr>
                                    ...
                                    <td class="table-inbox-image">
                                        <img src="{{URL::asset('assets/demo/layout_1/images/brands/twitter.svg')}}" class="rounded-circle" width="32" height="32" alt="">
                                    </td>
                                    <td class="table-inbox-name">
                                        <a href="mail_read">
                                ...
                                <tr>
                                    ...
                                    <td class="table-inbox-image">
                                        <img src="{{URL::asset('assets/demo/layout_1/images/brands/facebook.svg')}}" class="rounded-circle" width="32" height="32" alt="">
                                    </td>
                                    <td class="table-inbox-name">
                                        <a href="mail_read">
                                ...
                                <tr>
                                    ...
                                    <td class="table-inbox-image">
                                        <img src="{{URL::asset('assets/demo/layout_1/images/brands/youtube.svg')}}" class="rounded-circle" width="32" height="32" alt="">
                                    </td>
                                    <td class="table-inbox-name">
                                        <a href="mail_read">
                                ...
                                <tr>
                                    ...
                                    <td class="table-inbox-image">
                                        <img src="{{URL::asset('assets/demo/layout_1/images/brands/amazon.svg')}}" class="rounded-circle" width="32" height="32" alt="">
                                    </td>
                                    <td class="table-inbox-name">
                                        <a href="mail_read">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="pe-0" style="width: 45px;">
                                        <a href="#">
                                            <img src="{{URL::asset('assets/demo/layout_1/images/demo/products/1.jpeg')}}" height="60" alt="">
                                        </a>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td class="pe-0">
                                        <a href="#">
                                            <img src="{{URL::asset('assets/demo/layout_1/images/demo/products/2.jpeg')}}" height="60" alt="">
                                        </a>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td class="pe-0">
                                        <a href="#">
                                            <img src="{{URL::asset('assets/demo/layout_1/images/demo/products/3.jpeg')}}" height="60" alt="">
                                        </a>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td class="pe-0">
                                        <a href="#">
                                            <img src="{{URL::asset('assets/demo/layout_1/images/demo/products/4.jpeg')}}" height="60" alt="">
                                        </a>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td class="pe-0">
                                        <a href="#">
                                            <img src="{{URL::asset('assets/demo/layout_1/images/demo/products/5.jpeg')}}" height="60" alt="">
                                        </a>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td class="pe-0">
                                        <a href="#">
                                            <img src="{{URL::asset('assets/demo/layout_1/images/demo/products/6.jpeg')}}" height="60" alt="">
                                        </a>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td class="pe-0">
                                        <a href="#">
                                            <img src="{{URL::asset('assets/demo/layout_1/images/demo/products/7.jpeg')}}" height="60" alt="">
                                        </a>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td class="pe-0">
                                        <a href="#">
                                            <img src="{{URL::asset('assets/demo/layout_1/images/demo/products/8.jpeg')}}" height="60" alt="">
                                        </a>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td class="pe-0">
                                        <a href="#">
                                            <img src="{{URL::asset('assets/demo/layout_1/images/demo/products/9.jpeg')}}" height="60" alt="">
                                        </a>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td class="pe-0">
                                        <a href="#">
                                            <img src="{{URL::asset('assets/demo/layout_1/images/demo/products/10.jpeg')}}" height="60" alt="">
                                        </a>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td class="pe-0">
                                        <a href="#">
                                            <img src="{{URL::asset('assets/demo/layout_1/images/demo/products/11.jpeg')}}" height="60" alt="">
                                        </a>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td class="pe-0">
                                        <a href="#">
                                            <img src="{{URL::asset('assets/demo/layout_1/images/demo/products/12.jpeg')}}" height="60" alt="">
                                        </a>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td class="pe-0">
                                        <a href="#">
                                            <img src="{{URL::asset('assets/demo/layout_1/images/demo/products/13.jpeg')}}" height="60" alt="">
                                        </a>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td class="pe-0">
                                        <a href="#">
                                            <img src="{{URL::asset('assets/demo/layout_1/images/demo/products/14.jpeg')}}" height="60" alt="">
                                        </a>
                                    </td>
                                    <td>
...
@endsection
@section('scripts')
<script src="{{URL::asset('assets/demo/layout_1/demo/pages/user_pages_profile.js')}}"></script>
<script src="{{URL::asset('assets/demo/layout_1/demo/charts/echarts/bars/tornado_negative_stack.js')}}"></script>
<script src="{{URL::asset('assets/demo/layout_1/demo/charts/pages/profile/balance_stats.js')}}"></script>
<script src="{{URL::asset('assets/demo/layout_1/demo/charts/pages/profile/available_hours.js')}}"></script>
@endsection
