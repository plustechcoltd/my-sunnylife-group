            ...
            <div class="card blog-horizontal">
                ...
                <div class="card-body">
                    <div class="card-img-actions me-3">
                        <img class="card-img img-fluid" src="{{URL::asset('assets/demo/layout_1/images/demo/images/blog1.jpg')}}" alt="">
    ...
    <div class="row">
        <div class="col-lg-6">
            ...
            <div class="card blog-horizontal">
                <div class="card-body">
                    <div class="card-img-actions me-3">
                        <img class="card-img img-fluid" src="{{URL::asset('assets/demo/layout_1/images/demo/images/blog2.jpg')}}" alt="">
                        <div class="card-img-actions-overlay card-img">
                            <a href="#" class="btn btn-outline-white btn-icon rounded-pill">
                                <i class="ph-link"></i>
                            </a>
    ...
    <div class="row">
        <div class="col-lg-6">
            ...
            <div class="card blog-horizontal">
                <div class="card-body">
                    <div class="card-img-actions me-3">
                        <img class="card-img img-fluid" src="{{URL::asset('assets/demo/layout_1/images/demo/images/blog3.jpg')}}" alt="">
                        <div class="card-img-actions-overlay card-img">
                            <a href="#" class="btn btn-outline-white btn-icon rounded-pill">
                                <i class="ph-link"></i>
                            </a>
    ...
    <div class="row">
        <div class="col-lg-6">
            ...
            <div class="card blog-horizontal blog-horizontal-xs">
                <div class="card-body">
                    <div class="card-img-actions me-3">
                        <img class="card-img img-fluid" src="{{URL::asset('assets/demo/layout_1/images/demo/images/blog4.jpg')}}" alt="">
                        <div class="card-img-actions-overlay card-img">
                            <a href="#" class="btn btn-outline-white btn-icon rounded-pill">
                                <i class="ph-link"></i>
                            </a>
        ...
        <div class="col-lg-6">
            ...
            <div class="card blog-horizontal blog-horizontal-sm">
                <div class="card-body">
                    <div class="card-img-actions me-3">
                        <img class="card-img img-fluid" src="{{URL::asset('assets/demo/layout_1/images/demo/images/blog5.jpg')}}" alt="">
                        <div class="card-img-actions-overlay card-img">
                            <a href="#" class="btn btn-outline-white btn-icon rounded-pill">
                                <i class="ph-link"></i>
                            </a>
