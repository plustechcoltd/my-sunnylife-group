...
@endsection
@section('scripts')
<script src="{{URL::asset('assets/demo/layout_1/demo/charts/d3/tree/tree_basic.js')}}"></script>
<script src="{{URL::asset('assets/demo/layout_1/demo/charts/d3/tree/tree_collapsible.js')}}"></script>
<script src="{{URL::asset('assets/demo/layout_1/demo/charts/d3/tree/tree_bracket.js')}}"></script>
<script src="{{URL::asset('assets/demo/layout_1/demo/charts/d3/tree/tree_radial.js')}}"></script>
<script src="{{URL::asset('assets/demo/layout_1/demo/charts/d3/tree/tree_dendrogram.js')}}"></script>
<script src="{{URL::asset('assets/demo/layout_1/demo/charts/d3/tree/tree_dendrogram_radial.js')}}"></script>
@endsection
