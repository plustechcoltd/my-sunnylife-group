...
@slot('subtitle') Columns Reorder @endslot
@endcomponent
...
<div class="content">
    ...
    <div class="card">
        <div class="card-header">
            <h5 class="mb-0">Basic column reorder</h5>
        </div>
    ...
    <div class="card">
        <div class="card-header">
            <h5 class="mb-0">Realtime updating</h5>
        </div>
    ...
    <div class="card">
        <div class="card-header">
            <h5 class="mb-0">Predefined column ordering</h5>
        </div>
...
<script src="{{URL::asset('assets/demo/layout_1/js/vendor/tables/datatables/extensions/col_reorder.min.js')}}"></script>
@endsection
@section('scripts')
<script src="{{URL::asset('assets/demo/layout_1/demo/pages/datatables_extension_reorder.js')}}"></script>
@endsection
