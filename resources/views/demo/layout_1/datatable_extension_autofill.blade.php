...
<script src="{{URL::asset('assets/demo/layout_1/js/vendor/tables/datatables/extensions/autofill.min.js')}}"></script>
<script src="{{URL::asset('assets/demo/layout_1/js/vendor/tables/datatables/extensions/select.min.js')}}"></script>
@endsection
@section('scripts')
<script src="{{URL::asset('assets/demo/layout_1/demo/pages/datatables_extension_autofill.js')}}"></script>
@endsection
