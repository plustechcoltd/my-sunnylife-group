...
<script src="{{URL::asset('assets/demo/layout_1/js/vendor/maps/leaflet/leaflet.min.js')}}"></script>
<script src="{{URL::asset('assets/demo/layout_1/js/vendor/maps/leaflet/plugins/markercluster.min.js')}}"></script>
@endsection
@section('scripts')
<script src="{{URL::asset('assets/demo/layout_1/demo/maps/leaflet/basic.js')}}"></script>
<script src="{{URL::asset('assets/demo/layout_1/demo/data/leaflet/cluster.js')}}"></script>
<script src="{{URL::asset('assets/demo/layout_1/demo/data/leaflet/geojson.js')}}"></script>
@endsection
