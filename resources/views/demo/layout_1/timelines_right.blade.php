						...
						<div class="timeline-container">
							...
							<div class="timeline-row">
								<div class="timeline-icon">
									<a href="#"><img src="{{URL::asset('assets/demo/layout_1/images/demo/users/face24.jpg')}}" alt=""></a>
								</div>
							...
							<div class="timeline-row">
								<div class="timeline-icon">
									<img src="{{URL::asset('assets/demo/layout_1/images/demo/users/face12.jpg')}}" alt="">
								</div>
								...
								<div class="row">
										...
										<div class="card">
											...
											<div class="card-body">
												<div class="card-img-actions mb-3">
													<img class="card-img img-fluid" src="{{URL::asset('assets/demo/layout_1/images/demo/cover3.jpg')}}" alt="">
									...
									<div class="col-lg-6">
										<div class="card">
											<div class="card-header d-sm-flex">
												<h6 class="mb-0">Diving lesson in Dubai</h6>
												<div class="d-flex d-sm-block mt-1 mt-sm-0 ms-sm-auto">
													<span><i class="ph-check-circle text-success me-1"></i> 3 hours ago</span>
													<div class="d-inline-flex ms-auto ms-sm-3">
														<div class="dropdown">
															<a href="#" class="text-body" data-bs-toggle="dropdown">
																<i class="ph-gear"></i>
											...
											<div class="card-body">
												<div class="card-img-actions mb-3">
													<img class="card-img img-fluid" src="{{URL::asset('assets/demo/layout_1/images/demo/cover2.jpg')}}" alt="">
													<div class="card-img-actions-overlay card-img">
														<a href="blog_single" class="btn btn-outline-white btn-icon rounded-pill">
															<i class="ph-link"></i>
														</a>
												...
												<blockquote class="blockquote border-start border-width-5 py-2 ps-3 mb-0">
													<p class="mb-2 fs-base">Pernicious drooled tryingly over crud peaceful gosh yet much following brightly mallard hey gregariously far gosh until earthworm python some impala belched darn a sighed unicorn much changed and astride cat and burned grizzly when jeez wonderful the outside tedious.</p>
							...
							<div class="timeline-row">
								<div class="timeline-icon">
									<img src="{{URL::asset('assets/demo/layout_1/images/demo/users/face3.jpg')}}" alt="">
								</div>
							...
							<div class="timeline-row">
								<div class="timeline-icon">
									<img src="{{URL::asset('assets/demo/layout_1/images/demo/users/face25.jpg')}}" alt="">
								</div>
							...
							<div class="timeline-row">
								<div class="timeline-icon">
									<img src="{{URL::asset('assets/demo/layout_1/images/demo/users/face11.jpg')}}" alt="">
								</div>
...
@endsection
@section('scripts')
<script src="{{URL::asset('assets/demo/layout_1/demo/pages/timelines.js')}}"></script>
<script src="{{URL::asset('assets/demo/layout_1/demo/charts/echarts/bars/tornado_negative_stack.js')}}"></script>
<script src="{{URL::asset('assets/demo/layout_1/demo/charts/pages/timelines/daily_statistics.js')}}"></script>
@endsection
