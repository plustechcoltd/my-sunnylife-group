                            ...
                            <div class="d-sm-flex align-items-center mb-3 mb-lg-0 ms-lg-3">
                                <div class="dropdown w-100 w-sm-auto">
                                    <a href="#" class="d-flex align-items-center text-body lh-1 dropdown-toggle py-sm-2" data-bs-toggle="dropdown" data-bs-display="static">
                                        <img src="{{URL::asset('assets/demo/layout_1/images/brands/tesla.svg')}}" class="w-32px h-32px me-2" alt="">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-lg-end w-100 w-lg-auto wmin-300 wmin-sm-350 pt-0">
                                        ...
                                        <a href="#" class="dropdown-item py-2">
                                            <img src="{{URL::asset('assets/demo/layout_1/images/brands/debijenkorf.svg')}}" class="w-32px h-32px me-2" alt="">
                                            <div>
                                        ...
                                        <a href="#" class="dropdown-item py-2">
                                            <img src="{{URL::asset('assets/demo/layout_1/images/brands/klm.svg')}}" class="w-32px h-32px me-2" alt="">
                                            <div>
                                        ...
                                        <a href="#" class="dropdown-item py-2">
                                            <img src="{{URL::asset('assets/demo/layout_1/images/brands/shell.svg')}}" class="w-32px h-32px me-2" alt="">
                                            <div>
                                        ...
                                        <a href="#" class="dropdown-item py-2">
                                            <img src="{{URL::asset('assets/demo/layout_1/images/brands/bp.svg')}}" class="w-32px h-32px me-2" alt="">
                                            <div>
                                ...
                                <div class="d-inline-flex mt-3 mt-sm-0">
                                    ...
                                    <a href="#" class="status-indicator-container ms-1">
                                        <img src="{{URL::asset('assets/demo/layout_1/images/demo/users/face1.jpg')}}" class="w-32px h-32px rounded-pill" alt="">
                                                ...
                                                <li class="nav-item nav-item-dropdown-xl dropdown ms-xl-2">
                                                    <a href="#" class="navbar-nav-link align-items-center rounded p-1" data-bs-toggle="dropdown">
                                                        <div class="status-indicator-container">
                                                            <img src="{{URL::asset('assets/demo/layout_1/images/demo/users/face11.jpg')}}" class="w-32px h-32px rounded" alt="">
                                                            <span class="status-indicator bg-success"></span>
                                                        </div>
