...
<script src="{{URL::asset('assets/demo/layout_1/js/vendor/visualization/d3/d3v5.min.js')}}"></script>
<script src="{{URL::asset('assets/demo/layout_1/js/vendor/visualization/c3/c3.min.js')}}"></script>
@endsection
@section('scripts')
<script src="{{URL::asset('assets/demo/layout_1/demo/charts/c3/c3_lines_areas.js')}}"></script>
@endsection
