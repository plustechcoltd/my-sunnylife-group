...
<script src="{{URL::asset('assets/demo/layout_1/js/vendor/editors/ckeditor/ckeditor_document.js')}}"></script>
@endsection
@section('scripts')
<script src="{{URL::asset('assets/demo/layout_1/demo/pages/editor_ckeditor_document.js')}}"></script>
@endsection
