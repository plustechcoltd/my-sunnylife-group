...
@slot('subtitle') CKEditor Balloon @endslot
@endcomponent
...
<div class="content">
    ...
    <div class="card">
        <div class="card-header">
            <h5 class="mb-0">Balloon editor</h5>
        </div>

        <div class="card-body">
            <p class="mb-3">Balloon editor is an inline editor that lets you create your content directly in its target location with the help of a balloon toolbar that appears next to the selected editable document element, if the selection is not empty. Target element can be either <code>textarea</code> or a regular <code>div</code>. To see it in action, select some text in the editor below.</p>

            <form action="#">
                <div class="mb-3" id="ckeditor_balloon_basic">
                    <h1>Apollo 11</h1>
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <p class="mb-3">
                <button type="button" class="btn btn-dark" id="ckeditor_balloon_readonly_toggle">
            ...
            <form action="#">
                <div class="mb-3" id="ckeditor_balloon_readonly">
                    <h1>Apollo 11</h1>
                    <figure class="image image-style-side">
                        <img src="https://c.cksource.com/a/1/img/sample.jpg" alt="Saturn V carrying Apollo 11.">
                        <figcaption>Leaving your comfort zone might lead you to such beautiful sceneries like this one.</figcaption>
...
<script src="{{URL::asset('assets/demo/layout_1/js/vendor/editors/ckeditor/ckeditor_balloon.js')}}"></script>
@endsection
@section('scripts')
<script src="{{URL::asset('assets/demo/layout_1/demo/pages/editor_ckeditor_balloon.js')}}"></script>
@endsection
