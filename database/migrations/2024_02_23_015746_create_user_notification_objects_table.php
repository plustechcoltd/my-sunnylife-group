...
return new class() extends Migration {
    ...
    {
        Schema::create('user_notification_objects', function (Blueprint $table) {
            $table->bigInteger('id', true)->unsigned()->nullable(false)->comment('ID');
            $table->string('user_notification_id')->nullable(false);
    ...
    {
        Schema::dropIfExists('user_notification_objects');
    }
};
